...
export HAVE_CORBA=1
export ACE_ROOT=/opt/TAO/5.6.6/linux-x86_64-gcc/ACE_wrappers
export HOST_ROOT=/opt/TAO/5.6.6/linux-x86_64-gcc/ACE_wrappers
export LD_LIBRARY_PATH=/opt/local/TAO/5.6.6/linux-x86_64-gcc/ACE_wrappers/lib:$LD_LIBRARY_PATH
