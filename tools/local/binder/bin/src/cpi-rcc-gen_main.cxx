...
class CpiRccGenConfigurator
  : public CPI::Util::CommandLineConfiguration
{
public:
  CpiRccGenConfigurator ();
...
CpiRccGenConfigurator::g_options[] = {
  { CPI::Util::CommandLineConfiguration::OptionType::STRING,
    "name", "Worker implementation name",
    CPI_CLC_OPT(&CpiRccGenConfigurator::name) },
  { CPI::Util::CommandLineConfiguration::OptionType::STRING,
    "implementation", "Implementation UUID",
    CPI_CLC_OPT(&CpiRccGenConfigurator::implementation) },
  { CPI::Util::CommandLineConfiguration::OptionType::STRING,
    "gen-header-file", "Generate header file",
    CPI_CLC_OPT(&CpiRccGenConfigurator::headerFile) }, 
  { CPI::Util::CommandLineConfiguration::OptionType::STRING,
    "gen-skeleton-file", "Generate skeleton file",
    CPI_CLC_OPT(&CpiRccGenConfigurator::skeletonFile) },
  { CPI::Util::CommandLineConfiguration::OptionType::BOOLEAN,
    "verbose", "Be verbose",
    CPI_CLC_OPT(&CpiRccGenConfigurator::verbose) },
#if !defined (NDEBUG)
  { CPI::Util::CommandLineConfiguration::OptionType::BOOLEAN,
    "break", "Whether to break on startup",
    CPI_CLC_OPT(&CpiRccGenConfigurator::debugBreak) },
#endif
  { CPI::Util::CommandLineConfiguration::OptionType::NONE,
    "help", "This message",
    CPI_CLC_OPT(&CpiRccGenConfigurator::help) },
...
protected:
  static unsigned int structAlign (CPI::SCA::DataType type)
    throw ();
...
unsigned int
CpiRccGenerator::
structAlign (CPI::SCA::DataType type)
  throw ()
{
  unsigned int align;
...
static
bool
cpiRccGeneratorInt (int argc, char * argv[])
{
  CpiRccGenConfigurator config;
...
extern "C" {
  int
  cpiRccGenerator (int argc, char * argv[])
  {
    return cpiRccGeneratorInt (argc, argv) ? 0 : -1;
  }
}
