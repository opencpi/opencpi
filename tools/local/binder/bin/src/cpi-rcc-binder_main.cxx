 ...
 *                  Refactored code to match the CPI RPL Binder.
 *
...
CpiRccBinderConfigurator ()
  : CPI::Util::CommandLineConfiguration (g_options),
    ...
    verbose (false),
    updateSPD (false),
    cpiDeviceId (static_cast<unsigned long> (-1)),
...
CpiRccBinderConfigurator::g_options[] = {
  ...
  { CPI::Util::CommandLineConfiguration::OptionType::BOOLEAN,
    ...
    CPI_CLC_OPT(&CpiRccBinderConfigurator::debugBreak) },
#endif
...
struct WorkerInfo {
  ...
  mutable CPI::Util::EzXml::Doc * doc;
};

WorkerInfo::WorkerInfo ()
  : doc (0)
{
  doc = new CPI::Util::EzXml::Doc;
}
...
protected:
  ...
  static ezxml_t createCPIContainerDependencyElement ()
    throw ();

  static ezxml_t createCPIDeviceIdDependencyElement (unsigned int deviceId)
    throw ();

protected:
  static const char * s_cpiRuntimePropertyId;
  static const char * s_cpiRuntimeRccName;
  static const char * s_cpiDeviceIdPropertyId;
...
const char *
CpiRccSpdUpdater::
s_cpiRuntimePropertyId = "DCE:c4b738d8-fbe6-4893-81cd-1bb7a77bfb43";

const char *
CpiRccSpdUpdater::
s_cpiRuntimeRccName = "RCC";

const char *
CpiRccSpdUpdater::
s_cpiDeviceIdPropertyId = "DCE:b59fa5e6-5eb4-44f6-90f6-0548508f2ba2";
  ...
  throw (std::string)
{
  ...
  if (oldImplNode) {
    ...
    if (implId.length()) {
      ...
      dceUUID += CPI::Util::UUID::binaryToHex (uuid);
  ...
  bool haveCpiDeviceIdDependency;
  ...
  throw ()
{
  ...
  if (implId.length()) {
    ...
    CPI::Util::UUID::BinaryUUID implUuid = CPI::Util::UUID::produceRandomUUID ();
    std::string dceImplUUID = "DCE:";
    dceImplUUID += CPI::Util::UUID::binaryToHex (implUuid);
  ...
  throw ()
{
   ...
   * least have a matching requirement for CPIContainerType.  If CPIDeviceId,
  ...
  throw ()
{
  ...
  ezxml_set_attr (ctdNode, "type", "CPI Runtime");
  ezxml_set_txt (ctdNode, "\n            \n        ");
  ezxml_t ctdPrefNode = ezxml_add_child (ctdNode, "propertyref", 13);
  ezxml_set_attr (ctdPrefNode, "refid", s_cpiRuntimePropertyId);
  ezxml_set_attr (ctdPrefNode, "value", s_cpiRuntimeRccName);
...
ezxml_t
CpiRccSpdUpdater::
createCPIDeviceIdDependencyElement (unsigned int deviceId)
  throw ()
{
  ezxml_t didNode = ezxml_new ("dependency");

  ezxml_set_attr (didNode, "type", "CPI Device Id");
  ezxml_set_txt (didNode, "\n            \n        ");
  ezxml_t didPrefNode = ezxml_add_child (didNode, "propertyref", 13);
  ezxml_set_attr (didPrefNode, "refid", s_cpiDeviceIdPropertyId);

  std::string tmp = CPI::Util::Misc::unsignedToString (deviceId);
...
static
bool
cpiRccBinderInt (int argc, char * argv[])
{
  CpiRccBinderConfigurator config;
  ...
  CPI::Util::CommandLineConfiguration::MultiNameValue::iterator wit;
  ...
  try {
    ...
    executableTail = CPI::Util::Vfs::relativeName (executableFileName);
  ...
  CPI::Util::CommandLineConfiguration::MultiString::iterator dit;
  ...
  CPI::Util::ZipFs::ZipFs outputFile;
  ...
  try {
    ...
    std::ostream * meta = outputFile.openWriteonly ("/cpi-meta.inf");
...
extern "C" {
  int
  cpiRccBinder (int argc, char * argv[])
  {
    return cpiRccBinderInt (argc, argv) ? 0 : -1;
  }
}
