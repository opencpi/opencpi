...
DoAltera=(set -o pipefail && export LM_LICENSE_FILE=$(OCPI_ALTERA_LICENSE_FILE); $(TIME) $(OCPI_ALTERA_TOOLS_DIR)/quartus/bin/$1 --64bit $2 2>&1 | sed 's/^.\[0m.\[0;32m//') > $3-$4.out &&\
  $(ECHO) -n $1:' ' && tail -1 $3-$4.out | tr -d '\n' && $(ECHO) -n ' at ' && date +%T
