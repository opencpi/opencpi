...
DoAltera=(set -o pipefail && export LM_LICENSE_FILE=$(OCPI_ALTERA_LICENSE_FILE); $(TIME) $(OCPI_ALTERA_TOOLS_DIR)/quartus/bin/$1 $2 2>&1 | sed 's/^.\[0m.\[0;32m//') > $3-$1.out && $(ECHO) -n $1: && tail -1 $3-$1.out
#; echo HELLO X=\$$?Y)
ifneq (,)
