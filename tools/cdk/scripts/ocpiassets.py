...
class Asset(metaclass=ABCMeta):
    ...
    def check_dirtype(dirtype, directory):
        ...
        if not os.path.isdir(directory):
            # driver code relies on the fact that this error massage starts with "Tried creating a"
            # in order to transform it into a useful message for whatever function is being 
            # done on this object
