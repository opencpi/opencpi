...
namespace {
  ...
  CPI::OS::ThreadManager g_reaperManager;
  ...
  throw ()
{
  ...
  cpiAssert (sizeof (m_osOpaque) >= sizeof (ProcessData *));
  o2pd (m_osOpaque) = 0;
}
