...
std::string
CPI::OS::FileSystem::toNativeName (const std::string & name)
  throw (std::string)
{
  return name;
}
...
std::string
CPI::OS::FileSystem::fromNativeName (const std::string & nativeName)
  throw (std::string)
{
  std::string name;
...
std::string
CPI::OS::FileSystem::absoluteName (const std::string & name)
  throw (std::string)
{
...
std::string
CPI::OS::FileSystem::directoryName (const std::string & name)
  throw (std::string)
{
...
std::string
CPI::OS::FileSystem::relativeName (const std::string & name)
  throw (std::string)
{
  std::string::size_type slashPos = name.rfind ('/');
...
void
CPI::OS::FileSystem::cd (const std::string & name)
  throw (std::string)
{
...
void
CPI::OS::FileSystem::mkdir (const std::string & name)
  throw (std::string)
{
  std::string nativeName = toNativeName (name);
...
void
CPI::OS::FileSystem::rmdir (const std::string & name)
  throw (std::string)
{
  std::string nativeName = toNativeName (name);
...
bool
CPI::OS::FileSystem::exists (const std::string & name, bool * isDir, uint64_t *size, std::time_t *mtime)
  throw ()
{
  std::string nativeName = toNativeName (name);
...
unsigned long long
CPI::OS::FileSystem::size (const std::string & name)
  throw (std::string)
{
  std::string nativeName = toNativeName (name);
...
std::time_t
CPI::OS::FileSystem::lastModified (const std::string & name)
  throw (std::string)
{
  std::string nativeName = toNativeName (name);
...
void
CPI::OS::FileSystem::remove (const std::string & name)
  throw (std::string)
{
  std::string nativeName = toNativeName (name);
