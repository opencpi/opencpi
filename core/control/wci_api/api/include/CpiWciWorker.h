...
/**
  ...
  @brief
    The CPI::WCI::Worker abstract base class for WCI RPL and RCC workers.

  This file contains the declaration of the CPI::WCI::Worker abstract base
...
#ifndef INCLUDED_CPI_WCI_WORKER_H
#define INCLUDED_CPI_WCI_WORKER_H
  ...
  namespace WCI
  {
    /**
      ...
      @brief
        ...
        The abstract base class CPI::WCI::Worker provides an interface
        for the WCI control, property access, and status operations on
        a single Worker.

      @sa CPI::WCI::WorkerRpl
...
#endif // End: #ifndef INCLUDED_CPI_WCI_WORKER_H
