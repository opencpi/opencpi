...
#ifndef CPI_CFUTIL_DEVICE_BASE_H__
#define CPI_CFUTIL_DEVICE_BASE_H__
...
namespace CPI {
  namespace CFUtil {
    ...
    public:
       ...
       * other ports via CPI::CFUtil::ReceptacleHelper, this method should
    ...
    protected:
      ...
      CPI::CFUtil::ReceptacleHelper<CosEventComm::PushConsumer> m_eventPort;
