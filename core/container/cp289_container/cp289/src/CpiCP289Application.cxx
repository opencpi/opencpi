...
#ifdef WAS
  : CPI::Container::Application(c), m_mutex(m),m_rccContainer(c.m_controller)
#endif
...
CPI::CP289::Application::
createArtifact(const char *url, CPI::Util::PValue *params)
{
  static CPI::Container::Artifact * a;
  // Not yet implemented
  return *a;
}
	     ...
	     const void *entryPoint, const char *inst, CPI::Util::PValue *wparams )
{
  CPI::Util::AutoMutex guard ( m_mutex, true ); 
#ifdef WAS
  return *(new CPI::CP289::Worker( *this, entryPoint, wparams, m_rccContainer ));
#endif
  return *(new CPI::CP289::Worker( *this, entryPoint, wparams, MyParent ));
}
