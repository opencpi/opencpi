...
#ifndef OCPI_NM_CP289_COMP__CONTROLLER_H
#define OCPI_NM_CP289_COMP__CONTROLLER_H

#define WORKER_INTERNAL
#include <OcpiCP289Worker.h>
...
namespace OCPI {
    ...
    namespace CP289 {
      ...
      /**********************************
       * This class is used to support the CP289 component model in the OCPI
       * environment.
       *********************************/
      class Container;
      ...
      public:
        ...
        Controller( OCPI::CP289::Container* c,
      ...
      protected:
        ...
        OCPI::CP289::Container * m_container;
