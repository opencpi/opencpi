    ...
    class Port : public OC::PortBase<Worker,Port,ExternalPort>
    {
      ...
      private:
            ...
            myPortOrdinal ( mPort.ordinal )
        {
          ...
          connectionData.data.options = ( 1 << OCPI::RDT::ActiveFlowControl ) |
      ...
      private:
          ...
          : OC::ExternalPortBase<Port,ExternalPort> ( port, name, props, port.metaPort(), isProvider )
        {
          ...
          /*
             ...
             must match
          */
          myDesc.nBuffers = parent().connectionData.data.desc.nBuffers;
          unsigned int nFar = parent().connectionData.data.desc.nBuffers;
          unsigned int nLocal = myDesc.nBuffers;

          // Reuse the parent's buffer to avoid a copy
          myDesc.dataBufferBaseAddr = parent().connectionData.data.desc.dataBufferBaseAddr;
          myDesc.dataBufferSize = parent().connectionData.data.desc.dataBufferSize;
          myDesc.dataBufferPitch = parent().connectionData.data.desc.dataBufferPitch;
          myDesc.metaDataBaseAddr =  parent().connectionData.data.desc.metaDataBaseAddr;
          myDesc.metaDataPitch = parent().connectionData.data.desc.metaDataPitch;
          myDesc.fullFlagBaseAddr = 0;
          myDesc.fullFlagPitch = parent().connectionData.data.desc.fullFlagPitch;
          myDesc.fullFlagSize = parent().connectionData.data.desc.fullFlagSize;
          myDesc.fullFlagValue = parent().connectionData.data.desc.fullFlagValue;
          myDesc.emptyFlagBaseAddr = 0;
          myDesc.emptyFlagSize = parent().connectionData.data.desc.emptyFlagSize;
          myDesc.emptyFlagPitch = parent().connectionData.data.desc.emptyFlagPitch;
          myDesc.emptyFlagValue = parent().connectionData.data.desc.emptyFlagValue;
          ...
          uint32_t* otherRemote = reinterpret_cast<uint32_t*> ( parent().connectionData.data.desc.fullFlagBaseAddr );
