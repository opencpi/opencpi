...
#ifndef CPIUTILHTTPCLIENT_H__
#define CPIUTILHTTPCLIENT_H__
...
namespace CPI {
  namespace Util {
    namespace Http {
       ...
       *
       * The CPI::Util::Http::ClientStream class throws this class as
       ...
       *
       * The CPI::Util::Http::ClientStream class throws an exception of this
       ...
       * CPI::Util::Http::ClientStream is a transport-agnostic abstract
       * base class.  A derived class must implement the openConnection(),
       * shutdownConnection() and closeConnection() operations.
       *
       * The CPI::Util::Http::ClientStream base class exists primarily so
       * that the CPI::Util::Http::Client template class can be as small
       * as possible, so that as little code as necessary needs to be
       * generated for each template instantiation.
       *
       * See CPI::Util::Http::Client for an implementation of this class.
       */
      ...
      public:
        ...
        private:
          ...
          void sendAnyRequest (const CPI::Util::Uri & uri,
      ...
      public:
         ...
         *
         * An exception of type CPI::Util::Http::Redirection is raised if
         * the server replies with a 3xx status code.
         *
         * An exception of type CPI::Util::Http::ClientError is raised if
         * the server replies with a 4xx status code.
         *
         * An exception of type CPI::Util::Http::ServerError is raised if
        ...
        void head (const CPI::Util::Uri & uri)
        ...
        void get (const CPI::Util::Uri & uri)
          throw (std::string, Redirection, ClientError, ServerError);
        ...
        void put (const CPI::Util::Uri & uri, std::ios_base::openmode mode = std::ios_base::out)
          throw (std::string, Redirection, ClientError, ServerError);
        ...
        void put (const CPI::Util::Uri & uri, const std::string & contentType, unsigned long long size, std::ios_base::openmode mode)
          throw (std::string, Redirection, ClientError, ServerError);
        ...
        void post (const CPI::Util::Uri & uri, std::ios_base::openmode mode = std::ios_base::in | std::ios_base::out)
          throw (std::string, Redirection, ClientError, ServerError);
        ...
        void post (const CPI::Util::Uri & uri, const std::string & contentType, unsigned long long size, std::ios_base::openmode mode)
          throw (std::string, Redirection, ClientError, ServerError);
        ...
        void remove (const CPI::Util::Uri & uri, std::ios_base::openmode mode = (std::ios_base::openmode) 0)
          throw (std::string, Redirection, ClientError, ServerError);
      ...
      protected:
        ...
        virtual void openConnection (const CPI::Util::Uri & uri,
      ...
      protected:
        void connect (const CPI::Util::Uri &)
          throw (std::string);
      ...
      protected:
        void headOrDelete (int, const CPI::Util::Uri &, std::ios_base::openmode)
          throw (std::string, Redirection, ClientError, ServerError);

        void putOrPost (int, const CPI::Util::Uri &, const std::string &, unsigned long long, std::ios_base::openmode)
          throw (std::string, Redirection, ClientError, ServerError);
       ...
       * \brief HTTP client.
       *
       * This class extends the abstract CPI::Util::Http::ClientStream class,
       * delegating connections to a transport provider ("Connector")
       * template parameter.  See CPI::Util::Tcp::Connector for a suitable
       * TCP-based transport provider class.
       *
       * See the CPI::Util::Http::ClientStream for more information about
       ...
       *
       * \code
       *   CPI::Util::Http::Client<CPI::Util::Tcp::Connector> mc;
      ...
      public:
         ...
         * Constructor.
         *
         * Calls CPI::Util::Http::ClientStream::get (uri).
         *
        ...
        inline Client (const CPI::Util::Uri & uri)
          throw (std::string, Redirection, ClientError, ServerError);
      ...
      protected:
        ...
        void openConnection (const CPI::Util::Uri & uri,
                             std::istream * & inConn,
                             std::ostream * & outConn)
          throw (std::string);
...
/*
 * ----------------------------------------------------------------------
 * CPI::Util::Http::Client<Connector>
 * ----------------------------------------------------------------------
 */
...
template<class Connector>
inline
CPI::Util::Http::Client<Connector>::Client ()
  throw ()
{
}
...
template<class Connector>
inline
CPI::Util::Http::Client<Connector>::Client (const CPI::Util::Uri & uri)
  throw (std::string, Redirection, ClientError, ServerError)
{
  get (uri);
}
...
void
CPI::Util::Http::Client<Connector>::
openConnection (const CPI::Util::Uri & uri,
                std::istream * & inConn,
                std::ostream * & outConn)
  throw (std::string)
{
  std::string authority = CPI::Util::Uri::decode (uri.getHostport());
