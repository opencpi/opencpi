...
bool
CPI::Util::Http::isToken (const std::string & str)
  throw ()
{
...
std::time_t
CPI::Util::Http::parseHttpDate (const std::string & httpDate)
  throw (std::string)
{
  struct tm timeStr;
...
std::string
CPI::Util::Http::makeHttpDate (std::time_t curTime)
  throw (std::string)
{
  std::string res;
  ...
  res += CPI::Util::Misc::integerToString (tmStr->tm_mday);
  res += " ";
  res += shortMonthNames[tmStr->tm_mon];
  res += " ";
  res += CPI::Util::Misc::integerToString (tmStr->tm_year + 1900);
  ...
  res += CPI::Util::Misc::integerToString (tmStr->tm_hour);
  res += ":";
  if (tmStr->tm_min < 10) {
    res += "0";
  }
  res += CPI::Util::Misc::integerToString (tmStr->tm_min);
  res += ":";
  if (tmStr->tm_sec < 10) {
    res += "0";
  }
  res += CPI::Util::Misc::integerToString (tmStr->tm_sec);
  res += " GMT";
...
std::string
CPI::Util::Http::getHttpTimestamp ()
  throw ()
{
