...
#ifndef CPIUTILIOP_H__
#define CPIUTILIOP_H__
...
namespace CPI {
  namespace Util {
    ...
    namespace IOP {
      ...
      typedef CPI::OS::uint32_t ProfileId;
       ...
       * is an encapsulated CPI::Util::IIOP::ProfileBody.
       *
       * If <tt>tag == TAG_MULTIPLE_COMPONENTS</tt>, then <tt>profile_data</tt>
       * is an encapsulated CPI::Util::IOP::MultipleComponentProfile.
       */
	...
	std::string profile_data;
       ...
       * Use CPI::Util::IOP::MultipleComponentProfile.
       */
	...
	throw ();
      ...
      typedef CPI::OS::uint32_t ComponentId;
	...
	std::string component_data;
       ...
       * component.  Use CPI::Util::IOP::ORBTypeComponent.
       */
       ...
       * component.  Use CPI::Util::IOP::AlternateIIOPAddressComponent.
       */
	...
	TaggedComponentSeq m_components;
      ...
      /**
       * \brief ORB Type Component
       *
       * The ORB Type Component is encapsulated in a tagged component
       * tagged CPI::Util::IOP::TAG_ORB_TYPE.
       *
       ...
       *
       * See also http://doc.omg.org/vendor-tags for a list of ORB type
	...
	CPI::OS::uint32_t orb_type;
       ...
       * CPI::Util::IOP::TAG_ALTERNATE_IIOP_ADDRESS.
       *
       ...
       * alternative addresses may be used by the client ORB, in addition
