...
std::string
CPI::Util::Uri::decode (const char * uri)
  throw (std::string)
{
  if (!uri) {
...
std::string
CPI::Util::Uri::decode (const std::string & uri)
  throw (std::string)
{
...
std::string
CPI::Util::Uri::encode (const char * uri, const char * allowedChars)
  throw (std::string)
{
  if (!uri) {
    throw std::string ("null uri");
...
std::string
CPI::Util::Uri::encode (const std::string & uri, const char * allowedChars)
  throw (std::string)
{
...
std::string
CPI::Util::Uri::encode (const std::string & uri, const std::string & allowedChars)
  throw (std::string)
{
...
CPI::Util::Uri::Uri (const char * theuri)
  throw (std::string)
{
  parse (std::string (theuri));
}

CPI::Util::Uri::Uri (const std::string & theuri)
  throw (std::string)
{
  parse (theuri);
}

CPI::Util::Uri::Uri (const CPI::Util::Uri & theuri)
  throw ()
{
  parse (theuri.get());
}
...
CPI::Util::Uri &
CPI::Util::Uri::operator= (const char * theuri)
  throw (std::string)
{
  parse (std::string (theuri));
  return *this;
...
CPI::Util::Uri &
CPI::Util::Uri::operator= (const std::string & theuri)
  throw (std::string)
{
  parse (theuri);
  return *this;
...
CPI::Util::Uri &
CPI::Util::Uri::operator= (const CPI::Util::Uri & theuri)
  throw ()
{
  parse (theuri.get());
  return *this;
...
const std::string &
CPI::Util::Uri::getFileName () const
  throw ()
{
  return filename;
}
...
const std::string &
CPI::Util::Uri::getAuthority () const
  throw ()
{
  return authority;
}
...
const std::string &
CPI::Util::Uri::getUserinfo () const
  throw ()
{
  return userinfo;
}
...
const std::string &
CPI::Util::Uri::getHostport () const
  throw ()
{
  return hostport;
}
...
const std::string &
CPI::Util::Uri::getFragment () const
  throw ()
{
  return fragment;
}
...
unsigned int
CPI::Util::Uri::getNumPathSegments () const
  throw ()
{
...
std::string
CPI::Util::Uri::getPathSegment (unsigned int num) const
  throw ()
{
  std::string::size_type segBegin, segEnd;
  unsigned int count = 0;
...
void
CPI::Util::Uri::parse (const std::string & data)
  throw (std::string)
{
...
void
CPI::Util::Uri::resolve (const CPI::Util::Uri & other)
  throw (std::string)
{
  if (other.isAbsolute()) {
    operator= (other);
...
std::string
CPI::Util::Uri::normalizePath (const std::string & path)
  throw ()
{
