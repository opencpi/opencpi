...
#ifndef CPIUTILCOMMANDLINECONFIGURATION_H__
#define CPIUTILCOMMANDLINECONFIGURATION_H__
...
#define CPI_CLC_OPT(x) reinterpret_cast<char ::CPI::Util::CommandLineConfiguration::*> (x)
#define CPI_CLC_SENT(x) static_cast<bool ::CPI::Util::CommandLineConfiguration::*> (x)
...
namespace CPI {
  namespace Util {
     ...
     *     CPI_CLC_OPT(&Configurable::fooOpt) },
     *   { OptionType::END }
     * };
     * \endcode
     */
    ...
    public:
       ...
       *               to CPI::Util::CommandLineConfiguration::OptionType::END.
       */
