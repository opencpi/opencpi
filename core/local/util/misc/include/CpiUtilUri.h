...
#ifndef CPIUTILURI_H__
#define CPIUTILURI_H__
...
namespace CPI {
  namespace Util {
     ...
     * CPI::Util::Uri::decode() before being processed.
     * CPI::Util::Uri::encode() can be used to escape components
...
inline bool
CPI::Util::Uri::isalphanum (char c)
  throw ()
{
...
inline bool
CPI::Util::Uri::isreserved (char c)
  throw ()
{
  switch (c) {
  case ';':
...
inline bool
CPI::Util::Uri::isunreserved (char c)
  throw ()
{
