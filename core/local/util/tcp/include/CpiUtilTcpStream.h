...
#ifndef CPIUTILTCPSTREAM_H__
#define CPIUTILTCPSTREAM_H__
...
namespace CPI {
  namespace Util {
    namespace Tcp {
       ...
       * socket (see CPI::Util::Tcp::Client, which derives from this
       * class), or when a server socket accepts a new connection (see
       * CPI::Util::Tcp::Server and its CPI::Util::Tcp::Server::accept()
       * operation).
       *
      ...
      public:
        ...
        public:
          StreamBuf ();
          StreamBuf (CPI::OS::Socket &, std::ios_base::openmode);
          ~StreamBuf ();

          void setSocket (CPI::OS::Socket &, std::ios_base::openmode);
          CPI::OS::Socket & getSocket ();
      ...
      public:
        ...
        Stream (CPI::OS::Socket & sock, std::ios_base::openmode mode = std::ios_base::in | std::ios_base::out)
          throw (std::string);
        ...
        void setSocket (CPI::OS::Socket & sock, std::ios_base::openmode mode = std::ios_base::in | std::ios_base::out)
          throw (std::string);
