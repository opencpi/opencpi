...
namespace DataTransfer {
  ...
  // HostSmem specializes by adding CpiFileMappingServices (for host-only)
  ...
  public:
    ...
    void create (EndPoint* loc )
    {
      ...
      SMB_handle handle = 0;
      HostSmem* pSmem = 0;
      CpiFileMappingServices* pMapper = 0;
      m_location = loc;
    ...
    CPI::OS::int32_t attach (EndPoint* loc)
    {
      // Begin exception handler
      CPI::OS::int32_t rc = 0;
      SMB_handle handle = 0;
