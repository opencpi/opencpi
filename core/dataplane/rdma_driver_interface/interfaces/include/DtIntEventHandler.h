...
/**
   ...
   @brief
   This file contains the Interface for the CPI event handler.
...
#ifndef CPI_DataTransport_Event_Manager_H_
#define CPI_DataTransport_Event_Manager_H_
...
namespace DataTransfer {
  ...
  {
  public:
    virtual ReturnStatus waitForEvent( int timeout_us, int &id, CPI::OS::uint64_t &value )=0;
    virtual ReturnStatus getPendingEvent(int &id, CPI::OS::uint64_t &value )=0;
    ...
    // activity.
    virtual void setMinTimeout( CPI::OS::uint32_t id, CPI::OS::uint32_t uSec )=0;
    virtual void removeMinTimeout(  CPI::OS::uint32_t id )=0;
  ...
  public:
    ...
    bool getNextEvent( int& id, CPI::OS::uint64_t &value );
