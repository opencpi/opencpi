...
#ifndef DEVICEPKGREF_H
#define DEVICEPKGREF_H
...
class OSSIEPARSER_API DevicePkgRef
{
public:
    DevicePkgRef(TiXmlElement *elem);
    ~DevicePkgRef();
...
private:
    ...
    DevicePkgRef(const DevicePkgRef& aDevicePkgRef); // no copying
