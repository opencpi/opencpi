...
#ifndef PRFSIMPLESEQEUNCEPROPERTY_H
#define PRFSIMPLESEQUENCEPROPERTY_H
...
class OSSIEPARSER_API PRFSimpleSequenceProperty : public PRFProperty
{
public:
    PRFSimpleSequenceProperty(TiXmlElement *elem);
    virtual ~PRFSimpleSequenceProperty();

private:
    PRFSimpleSequenceProperty();
    PRFSimpleSequenceProperty(const PRFSimpleSequenceProperty &);
