...
* "mig_37.ucf" file is the constraint file for the design. This is used
...
* "icon5_cg.xco", "ila384_8_cg.xco", "vio_async_in256_cg.xco" and
  ...
  i.e. ila, vio and icon and set DEBUG_PORT parameter to "ON" in mig_37
...
* "mig_37.prj" file has commands to add all rtl files to the XST project
  for synthesis.

* "mig_37.lso" file is a custom library search order file for XST synthesis.
