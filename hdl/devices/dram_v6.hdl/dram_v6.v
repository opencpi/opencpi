...
//
// On Mon Apr 11 17:10:02 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18937, v__h3636, v__h3810, v__h3954;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h14725,
	       x__h5934,
	       x__h6155;
  reg CASE_x404_NOT_x404_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495;
  wire [127 : 0] x1_data__h15964, x1_data__h16965;
  wire [31 : 0] dramStatus__h13367,
		g_data__h18481,
		myBE__h5971,
		myBE__h6004,
		rdat___1__h18544,
		...
		rdat___1__h18702,
		x1_addr__h16963;
  wire [15 : 0] x1_be__h16964, x__h18521;
  wire [2 : 0] x__h6404;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       ...
       lrespF_RDY_deq__05_AND_NOT_wmemi_respF_c_r_41__ETC___d407,
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12211 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14725 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18481 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12211 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5934 : ~x__h6155 ;
  ...
  // submodule memc_respF
  always@(x__h6404 or memc_memc$app_rd_data)
  begin
    case (x__h6404)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6404 == 3'b0 || x__h6404 == 3'b101 || x__h6404 == 3'b110 ||
	      x__h6404 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227 =
	     CASE_x404_NOT_x404_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16963, x1_be__h16964, x1_data__h16965 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15964 } ;
  ...
  assign dbg_wr_calib_clk_delay_RDY_write__16_AND_dbg_w_ETC___d346 =
	     ...
	     dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343 ;
  assign dramStatus__h13367 = { 16'd0, x__h18521 } ;
  assign g_data__h18481 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_deq__05_AND_NOT_wmemi_respF_c_r_41__ETC___d407 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5971 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h6004 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18544 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18553 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18580 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18589 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18625 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18634 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18643 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18685 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18694 = { 16'd0, pReg } ;
  assign rdat___1__h18702 = { 16'd0, mReg } ;
  ...
  assign x1__h12211 = !memc_memc$app_rdy ;
  assign x1_addr__h16963 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16964 =
  ...
  assign x1_data__h15964 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16965 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18521 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6404 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14725 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14725 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14725 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14725 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13367 or
	  dramCtrl or
	  rdat___1__h18544 or
	  rdat___1__h18553 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5971 or myBE__h6004)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5934 = myBE__h5971;
      2'b01: x__h5934 = myBE__h6004;
      default: x__h5934 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5971 or myBE__h6004)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6155 = myBE__h5971;
      2'b11: x__h6155 = myBE__h6004;
      default: x__h6155 = 32'd0;
    endcase
  end
  always@(x__h6404 or memc_respF$FULL_N)
  begin
    case (x__h6404)
      3'b0, 3'b101, 3'b110:
	  CASE_x404_NOT_x404_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x404_NOT_x404_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h6404 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
