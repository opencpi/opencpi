...
//
// On Fri Apr  1 11:19:08 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18934, v__h3636, v__h3810, v__h3954;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h14722,
	       x__h5935,
	       x__h6157;
  reg CASE_x407_NOT_x407_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495;
  wire [127 : 0] x1_data__h15961, x1_data__h16962;
  wire [31 : 0] dramStatus__h13364,
		g_data__h18478,
		myBE__h5972,
		myBE__h6005,
		rdat___1__h18541,
		...
		rdat___1__h18699,
		x1_addr__h16960;
  wire [15 : 0] x1_be__h16961, x__h18518;
  wire [2 : 0] x__h6407;
  wire IF_memc_memc_app_rd_data_end__12_CONCAT_memc_r_ETC___d228,
       IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_lreqF_ETC___d520,
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d456,
       ...
       lrespF_RDY_deq__05_AND_NOT_splitReadInFlight_1_ETC___d423,
       lrespF_RDY_deq__05_AND_NOT_wmemi_respF_c_r_42__ETC___d407,
       wmemi_operateD_77_AND_wmemi_peerIsReady_78_79__ETC___d383;
  ...
  assign WILL_FIRE_RL_memc_advance_readData =
	     memc_rdpF$EMPTY_N &&
	     IF_memc_memc_app_rd_data_end__12_CONCAT_memc_r_ETC___d228 &&
	     memc_memc$phy_init_done &&
	     memc_memc$app_rd_data_valid ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14722 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18478 } ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5935 : ~x__h6157 ;
  ...
  // submodule memc_respF
  always@(x__h6407 or memc_memc$app_rd_data)
  begin
    case (x__h6407)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6407 == 3'b0 || x__h6407 == 3'b101 || x__h6407 == 3'b110 ||
	      x__h6407 == 3'b011) ;
  ...
  // remaining internal signals
  assign IF_memc_memc_app_rd_data_end__12_CONCAT_memc_r_ETC___d228 =
	     CASE_x407_NOT_x407_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16960, x1_be__h16961, x1_data__h16962 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15961 } ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d456 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dbg_wr_calib_clk_delay_RDY_write__16_AND_dbg_w_ETC___d346 =
	     ...
	     dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343 ;
  assign dramStatus__h13364 = { 16'd0, x__h18518 } ;
  assign g_data__h18478 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_deq__05_AND_NOT_splitReadInFlight_1_ETC___d423 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_deq__05_AND_NOT_wmemi_respF_c_r_42__ETC___d407 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5972 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h6005 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18541 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18550 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18577 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18586 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18622 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18631 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18640 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18682 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18691 = { 16'd0, pReg } ;
  assign rdat___1__h18699 = { 16'd0, mReg } ;
  assign wmemi_operateD_77_AND_wmemi_peerIsReady_78_79__ETC___d383 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h16960 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16961 =
  ...
  assign x1_data__h15961 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16962 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18518 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6407 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14722 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14722 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14722 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14722 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13364 or
	  dramCtrl or
	  rdat___1__h18541 or
	  rdat___1__h18550 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5972 or myBE__h6005)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5935 = myBE__h5972;
      2'b01: x__h5935 = myBE__h6005;
      default: x__h5935 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5972 or myBE__h6005)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6157 = myBE__h5972;
      2'b11: x__h6157 = myBE__h6005;
      default: x__h6157 = 32'd0;
    endcase
  end
  always@(x__h6407 or memc_respF$FULL_N)
  begin
    case (x__h6407)
      3'b0, 3'b101, 3'b110:
	  CASE_x407_NOT_x407_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x407_NOT_x407_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h6407 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
