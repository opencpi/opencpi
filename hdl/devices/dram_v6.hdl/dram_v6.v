...
//
// On Fri Aug 19 11:37:46 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18935, v__h3636, v__h3810, v__h3954;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h14723,
	       x__h5933,
	       x__h6154;
  reg CASE_x403_NOT_x403_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495;
  wire [127 : 0] x1_data__h15962, x1_data__h16963;
  wire [31 : 0] dramStatus__h13365,
		g_data__h18479,
		myBE__h5970,
		myBE__h6003,
		rdat___1__h18542,
		...
		rdat___1__h18700,
		x1_addr__h16961;
  wire [15 : 0] x1_be__h16962, x__h18519;
  wire [2 : 0] x__h6403;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_lreqF_ETC___d520,
       dbg_rd_clkdly_cnt_RDY_write__25_AND_dbg_rd_act_ETC___d337,
       dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343,
       dbg_wr_calib_clk_delay_RDY_write__16_AND_dbg_w_ETC___d346,
       lrespF_RDY_first__05_AND_NOT_splitReadInFlight_ETC___d423,
       lrespF_RDY_first__05_AND_NOT_wmemi_respF_c_r_4_ETC___d407,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d456,
       wmemi_operateD_76_AND_wmemi_peerIsReady_77_78__ETC___d383,
       x1__h12209;
  ...
  // submodule memc_memc
  v6_mig37 memc_memc(.sys_rst(memc_mem_rst_p$OUT_RST_N),
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12209 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14723 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18479 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12209 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5933 : ~x__h6154 ;
  ...
  // submodule memc_respF
  always@(x__h6403 or memc_memc$app_rd_data)
  begin
    case (x__h6403)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6403 == 3'b0 || x__h6403 == 3'b101 || x__h6403 == 3'b110 ||
	      x__h6403 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227 =
	     CASE_x403_NOT_x403_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
	     (!memc_memc$app_rd_data_end || memc_rdpF$EMPTY_N) ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_lreqF_ETC___d520 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16961, x1_be__h16962, x1_data__h16963 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15962 } ;
  assign dbg_rd_clkdly_cnt_RDY_write__25_AND_dbg_rd_act_ETC___d337 =
	     ...
	     dbg_rddata$sRDY &&
	     requestCount$sRDY ;
  assign dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__25_AND_dbg_rd_act_ETC___d337 ;
  assign dbg_wr_calib_clk_delay_RDY_write__16_AND_dbg_w_ETC___d346 =
	     dbg_wr_calib_clk_delay$sRDY && dbg_wl_odelay_dqs_tap_cnt$sRDY &&
	     dbg_wl_odelay_dq_tap_cnt$sRDY &&
	     dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343 ;
  assign dramStatus__h13365 = { 16'd0, x__h18519 } ;
  assign g_data__h18479 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_first__05_AND_NOT_splitReadInFlight_ETC___d423 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_first__05_AND_NOT_wmemi_respF_c_r_4_ETC___d407 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5970 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h6003 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18542 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18551 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18578 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18587 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18623 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18632 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18641 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18683 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18692 = { 16'd0, pReg } ;
  assign rdat___1__h18700 = { 16'd0, mReg } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d456 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign wmemi_operateD_76_AND_wmemi_peerIsReady_77_78__ETC___d383 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1__h12209 = !memc_memc$app_rdy ;
  assign x1_addr__h16961 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16962 =
  ...
  assign x1_data__h15962 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16963 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18519 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6403 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14723 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14723 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14723 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14723 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13365 or
	  dramCtrl or
	  rdat___1__h18542 or
	  rdat___1__h18551 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5970 or myBE__h6003)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5933 = myBE__h5970;
      2'b01: x__h5933 = myBE__h6003;
      default: x__h5933 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5970 or myBE__h6003)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6154 = myBE__h5970;
      2'b11: x__h6154 = myBE__h6003;
      default: x__h6154 = 32'd0;
    endcase
  end
  always@(x__h6403 or memc_respF$FULL_N)
  begin
    case (x__h6403)
      3'b0, 3'b101, 3'b110:
	  CASE_x403_NOT_x403_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x403_NOT_x403_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h6403 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 173, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 173, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 173, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 173, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
