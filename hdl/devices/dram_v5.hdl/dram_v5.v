...
//
// On Tue Jan 11 12:14:55 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h17859, v__h3575, v__h3749, v__h3893;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h13652;
  wire [175 : 0] IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_pReg__ETC___d438;
  wire [127 : 0] x1_data__h14885, x1_data__h15878;
  wire [31 : 0] dramStatus__h12786,
		g_data__h17378,
		rdat___1__h17439,
		rdat___1__h17448,
		rdat___1__h17457,
		...
		rdat___1__h17623,
		x1_addr__h15876;
  wire [15 : 0] x1_be__h15877;
  wire IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_lreqF_ETC___d463,
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d399,
       dbg_calib_dq_tap_cnt_RDY_write__84_AND_dbg_cal_ETC___d296,
       lrespF_RDY_deq__48_AND_NOT_splitReadInFlight_5_ETC___d366,
       lrespF_RDY_deq__48_AND_NOT_wmemi_respF_c_r_09__ETC___d350,
       wmemi_operateD_43_AND_wmemi_peerIsReady_44_45__ETC___d326;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_lreqF_ETC___d463 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_pReg__ETC___d438 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13652 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17378 } ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_lreqF_ETC___d463 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__4_BIT_51_87_THEN_pReg__ETC___d438 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h15876, x1_be__h15877, x1_data__h15878 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h14885 } ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d399 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dbg_calib_dq_tap_cnt_RDY_write__84_AND_dbg_cal_ETC___d296 =
  ...
  assign dramStatus__h12786 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign g_data__h17378 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_deq__48_AND_NOT_splitReadInFlight_5_ETC___d366 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_deq__48_AND_NOT_wmemi_respF_c_r_09__ETC___d350 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h17439 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h17448 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h17457 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h17466 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h17475 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h17484 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h17493 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h17502 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h17530 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h17583 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h17601 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17615 = { 16'd0, pReg } ;
  assign rdat___1__h17623 = { 16'd0, mReg } ;
  assign wmemi_operateD_43_AND_wmemi_peerIsReady_44_45__ETC___d326 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h15876 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15877 =
  ...
  assign x1_data__h14885 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15878 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13652 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13652 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13652 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13652 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12786 or
	  dramCtrl or
	  rdat___1__h17439 or
	  rdat___1__h17448 or
	  rdat___1__h17457 or
