...
//
// On Wed Feb 29 08:59:56 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18298, v__h3639, v__h3813, v__h3957;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594,
	       g_data__h13987;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_pReg__ETC___d448;
  wire [127 : 0] x1_data__h15228, x1_data__h16229;
  wire [31 : 0] dramStatus__h13121,
		g_data__h17745,
		rdat___1__h17806,
		rdat___1__h17817,
		rdat___1__h17828,
		...
		rdat___1__h18142,
		x1_addr__h16227;
  wire [15 : 0] x1_be__h16228;
  wire IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_lreqF_ETC___d473,
       IF_wmemi_reqF_first__23_BITS_51_TO_49_24_EQ_1__ETC___d332,
       dbg_calib_dq_tap_cnt_RDY_write__87_AND_dbg_cal_ETC___d299,
       lrespF_RDY_first__58_AND_NOT_splitReadInFlight_ETC___d376,
       lrespF_RDY_first__58_AND_NOT_wmemi_respF_c_r_1_ETC___d360,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d409,
       wmemiReadInFlight_value_76_SLT_16___d673;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_lreqF_ETC___d473 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_2 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_pReg__ETC___d448 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13987 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17745 } ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_lreqF_ETC___d473 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_97_THEN_pReg__ETC___d448 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16227, x1_be__h16228, x1_data__h16229 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15228 } ;
  assign IF_wmemi_reqF_first__23_BITS_51_TO_49_24_EQ_1__ETC___d332 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_76_SLT_16___d673 || lreqF$sFULL_N ;
  assign dbg_calib_dq_tap_cnt_RDY_write__87_AND_dbg_cal_ETC___d299 =
  ...
  assign dramStatus__h13121 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign g_data__h17745 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 ;
  assign lrespF_RDY_first__58_AND_NOT_splitReadInFlight_ETC___d376 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_first__58_AND_NOT_wmemi_respF_c_r_1_ETC___d360 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h17806 =
	     hasDebugLogic ? { 28'd0, dbg_calib_done$dD_OUT } : 32'd0 ;
  assign rdat___1__h17817 =
	     hasDebugLogic ? { 28'd0, dbg_calib_err$dD_OUT } : 32'd0 ;
  assign rdat___1__h17828 =
	     hasDebugLogic ? { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h17839 =
	     hasDebugLogic ? { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h17850 =
	     hasDebugLogic ? { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h17861 =
	     hasDebugLogic ? { 28'd0, dbg_calib_rd_data_sel$dD_OUT } : 32'd0 ;
  assign rdat___1__h17872 =
	     hasDebugLogic ? { 12'd0, dbg_calib_rden_delay$dD_OUT } : 32'd0 ;
  assign rdat___1__h17883 =
	     hasDebugLogic ? { 12'd0, dbg_calib_gate_delay$dD_OUT } : 32'd0 ;
  assign rdat___1__h17894 = hasDebugLogic ? 32'hC0DEBABE : 32'd0 ;
  assign rdat___1__h17900 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h17906 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h17912 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat___1__h17918 = hasDebugLogic ? { 24'd0, wmemi_statusR } : 32'd0 ;
  assign rdat___1__h17973 =
	     hasDebugLogic ? { 24'd0, wmemiReadInFlight_value } : 32'd0 ;
  assign rdat___1__h18001 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18021 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h18031 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h18041 = hasDebugLogic ? wdReg : 32'd0 ;
  assign rdat___1__h18055 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h18069 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h18083 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h18097 = hasDebugLogic ? rdReg : 32'd0 ;
  assign rdat___1__h18112 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h18127 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h18142 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d409 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign wmemiReadInFlight_value_76_SLT_16___d673 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1_addr__h16227 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16228 =
  ...
  assign x1_data__h15228 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16229 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13987 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13987 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13987 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13987 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13121 or
	  dramCtrl or
	  rdat___1__h17806 or
	  rdat___1__h17817 or
	  rdat___1__h17828 or
	  ...
	  rdat___1__h18083 or
	  rdat___1__h18097 or
	  rdat___1__h18112 or rdat___1__h18127 or rdat___1__h18142)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 =
	      rdat___1__h17973;
      8'h40, 8'h44, 8'h4C:
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 = 32'd0;
      8'h48:
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 =
	      rdat___1__h18001;
      8'h50:
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 =
	      rdat___1__h18142;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d594 =
		   32'd0;
    endcase
  end
  ...
  always@(posedge memc_memc$tb_clk or negedge memc_memc$tb_rst_n)
  if (!memc_memc$tb_rst_n)
    begin
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_v5.bsv\", line 165, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v5.bsv\", line 165, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v5.bsv\", line 165, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v5.bsv\", line 165, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
