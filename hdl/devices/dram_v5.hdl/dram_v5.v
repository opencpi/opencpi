...
//
// On Sun Apr  3 10:08:31 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18094, v__h3638, v__h3812, v__h3956;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h13855;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_pReg__ETC___d439;
  wire [127 : 0] x1_data__h15096, x1_data__h16097;
  wire [31 : 0] dramStatus__h12989,
		g_data__h17613,
		rdat___1__h17674,
		rdat___1__h17683,
		rdat___1__h17692,
		...
		rdat___1__h17858,
		x1_addr__h16095;
  wire [15 : 0] x1_be__h16096;
  wire IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_lreqF_ETC___d464,
       dbg_calib_dq_tap_cnt_RDY_write__85_AND_dbg_cal_ETC___d297,
       lrespF_RDY_deq__49_AND_NOT_splitReadInFlight_6_ETC___d367,
       lrespF_RDY_deq__49_AND_NOT_wmemi_respF_c_r_10__ETC___d351,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d400,
       wmemi_operateD_45_AND_wmemi_peerIsReady_46_47__ETC___d327;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_lreqF_ETC___d464 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_pReg__ETC___d439 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13855 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17613 } ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_lreqF_ETC___d464 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_88_THEN_pReg__ETC___d439 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16095, x1_be__h16096, x1_data__h16097 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15096 } ;
  assign dbg_calib_dq_tap_cnt_RDY_write__85_AND_dbg_cal_ETC___d297 =
  ...
  assign dramStatus__h12989 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign g_data__h17613 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_deq__49_AND_NOT_splitReadInFlight_6_ETC___d367 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_deq__49_AND_NOT_wmemi_respF_c_r_10__ETC___d351 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h17674 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h17683 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h17692 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h17701 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h17710 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h17719 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h17728 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h17737 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h17765 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h17818 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h17836 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17850 = { 16'd0, pReg } ;
  assign rdat___1__h17858 = { 16'd0, mReg } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d400 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign wmemi_operateD_45_AND_wmemi_peerIsReady_46_47__ETC___d327 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h16095 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16096 =
  ...
  assign x1_data__h15096 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16097 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13855 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13855 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13855 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13855 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12989 or
	  dramCtrl or
	  rdat___1__h17674 or
	  rdat___1__h17683 or
	  rdat___1__h17692 or
  ...
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 =
	      32'hC0DEBABE;
      8'h2C:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 = wmemiWrReq;
      8'h30:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 = wmemiRdReq;
      8'h34:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 = wmemiRdResp;
      8'h38:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 =
	      rdat___1__h17765;
      8'h3C:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 =
	      rdat___1__h17818;
      8'h40, 8'h44, 8'h4C:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 = 32'd0;
      8'h48:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 =
	      rdat___1__h17836;
      8'h50:
