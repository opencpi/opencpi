...
//
// On Fri Aug 19 11:37:51 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [14 : 0] flashC_wseqFsm_jj_delay_count;
  wire [14 : 0] flashC_wseqFsm_jj_delay_count$D_IN;
  ...
  wire WILL_FIRE_RL_advance_response,
       ...
       WILL_FIRE_RL_flashC_rseqFsm_idle_l56c15,
       ...
       WILL_FIRE_RL_flashC_wseqFsm_idle_l66c15,
  ...
  reg [63 : 0] v__h3617, v__h3791, v__h3935, v__h46966;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1;
  wire [31 : 0] flashStatus__h45950, g_data__h46827;
  wire [23 : 0] x_addr__h46727;
  wire IF_flashC_reqF_first__04_BIT_40_05_THEN_flashC_ETC___d310,
       flashC_rseqFsm_abort_whas__60_AND_flashC_rseqF_ETC___d227,
       flashC_wseqFsm_abort_whas__33_AND_flashC_wseqF_ETC___d300,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d365,
       wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d343;
  ...
  assign WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 =
	     !flashC_isRead && flashC_wseqFsm_state_mkFSMstate == 4'd6 ;

  // rule RL_flashC_wseqFsm_action_l73c12
  assign WILL_FIRE_RL_flashC_wseqFsm_action_l73c12 =
	     !flashC_isRead && flashC_wseqFsm_state_mkFSMstate == 4'd7 ;
  ...
  assign WILL_FIRE_RL_flashC_wseqFsm_action_l67c12 =
	     ...
	     (flashC_wseqFsm_state_mkFSMstate == 4'd0 ||
	      flashC_wseqFsm_state_mkFSMstate == 4'd8) ;

  // rule RL_flashC_nextRequest
  assign WILL_FIRE_RL_flashC_nextRequest =
	     flashC_reqF$EMPTY_N &&
	     IF_flashC_reqF_first__04_BIT_40_05_THEN_flashC_ETC___d310 &&
	     flashC_rseqFsm_abort_whas__60_AND_flashC_rseqF_ETC___d227 &&
	     !flashC_rseqFsm_start_reg &&
	     flashC_wseqFsm_abort_whas__33_AND_flashC_wseqF_ETC___d300 &&
	     !flashC_wseqFsm_start_reg ;

  // rule RL_flashC_wseqFsm_idle_l66c15
  assign WILL_FIRE_RL_flashC_wseqFsm_idle_l66c15 =
	     !flashC_wseqFsm_start_wire$whas &&
	     flashC_wseqFsm_state_mkFSMstate == 4'd8 ;
  ...
  assign MUX_flashC_reqF$enq_1__VAL_1 =
	     { wci_wslv_reqF$D_OUT[39:32] != 8'h14,
	       aReg[23:0],
	       wdReg[15:0] } ;
  assign MUX_flashC_reqF$enq_1__VAL_2 = { 1'd1, x_addr__h46727, 16'hAAAA } ;
  ...
  assign MUX_flashC_wseqFsm_jj_delay_count$write_1__VAL_1 =
	     { flashC_wseqFsm_jj_delay_count[13:0], 1'd0 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h46827 } ;
  ...
  // register flashC_oeReg
  assign flashC_oeReg$D_IN = !WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ;
  ...
  // register flashC_rseqFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_flashC_rseqFsm_idle_l56c15 or
	  WILL_FIRE_RL_flashC_rseqFsm_action_l57c12 or
	  WILL_FIRE_RL_flashC_rseqFsm_action_l58c12 or
	  WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np or
	  WILL_FIRE_RL_flashC_rseqFsm_action_np or
	  WILL_FIRE_RL_flashC_rseqFsm_action_l60c10 or
  ...
  // register flashC_tsOE
  assign flashC_tsOE$D_IN = !WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ;
  ...
  // register flashC_weReg
  assign flashC_weReg$D_IN = !WILL_FIRE_RL_flashC_wseqFsm_action_l71c12 ;
  ...
  // register flashC_wseqFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_flashC_wseqFsm_idle_l66c15 or
	  WILL_FIRE_RL_flashC_wseqFsm_action_l67c12 or
	  WILL_FIRE_RL_flashC_wseqFsm_action_l68c12 or
	  WILL_FIRE_RL_flashC_wseqFsm_action_l69c12 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_flashC_wseqFsm_idle_l66c15:
	  flashC_wseqFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_flashC_wseqFsm_action_l67c12:
  ...
  assign flashC_respF$ENQ = WILL_FIRE_RL_flashC_rseqFsm_action_l60c10 ;
  ...
  // remaining internal signals
  assign IF_flashC_reqF_first__04_BIT_40_05_THEN_flashC_ETC___d310 =
  ...
  assign flashC_rseqFsm_abort_whas__60_AND_flashC_rseqF_ETC___d227 =
	     (flashC_rseqFsm_state_mkFSMstate == 4'd0 ||
	      flashC_rseqFsm_state_mkFSMstate == 4'd7) &&
	     (!flashC_rseqFsm_start_reg_1 || flashC_rseqFsm_state_fired) ;
  assign flashC_wseqFsm_abort_whas__33_AND_flashC_wseqF_ETC___d300 =
	     (flashC_wseqFsm_state_mkFSMstate == 4'd0 ||
	      flashC_wseqFsm_state_mkFSMstate == 4'd8) &&
	     (!flashC_wseqFsm_start_reg_1 || flashC_wseqFsm_state_fired) ;
  assign flashStatus__h45950 = { 31'd1, flashC_waitReg } ;
  assign g_data__h46827 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d365 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		flashC_reqF$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d343 =
	     wci_wslv_reqF$EMPTY_N &&
	     ((wci_wslv_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
		wci_wslv_reqF$D_OUT[39:32] != 8'h18 || flashC_reqF$FULL_N) ;
  assign x_addr__h46727 = { 5'h0, wci_wslv_reqF$D_OUT[50:34], 2'b0 } ;
  always@(wci_wslv_reqF$D_OUT or
	  flashStatus__h45950 or flashCtrl or aReg or wdReg or rdReg)
  begin
  ...
  begin
	...
	flashC_wseqFsm_jj_delay_count <= `BSV_ASSIGNMENT_DELAY 15'd1;
	...
	flashC_wseqFsm_state_mkFSMstate <= `BSV_ASSIGNMENT_DELAY 4'd0;
  ...
  begin
    ...
    flashC_weReg = 1'h0;
    flashC_wseqFsm_jj_delay_count = 15'h2AAA;
  ...
  begin
	...
	$display("[%0d]: %m: WCI ControlOp: Completed-transition edge:%x from:%x to:%x",
		 ...
		 wci_wslv_nState);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_rseqFsm_action_l58c12 &&
	  (WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_np ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l60c10 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l62c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 58, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_rseqFsm_action_l58c12]\n  and [RL_flashC_rseqFsm_action_d_init_np, RL_flashC_rseqFsm_action_np,\n  RL_flashC_rseqFsm_action_l60c10, RL_flashC_rseqFsm_action_l61c12,\n  RL_flashC_rseqFsm_action_l62c12] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_rseqFsm_action_l60c10 &&
	  (WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l62c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 60, column 10: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_rseqFsm_action_l60c10]\n  and [RL_flashC_rseqFsm_action_l61c12, RL_flashC_rseqFsm_action_l62c12] )\n  fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 &&
	  WILL_FIRE_RL_flashC_rseqFsm_action_l62c12)
	$display("Error: \"bsv/dev/Flash.bsv\", line 61, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_rseqFsm_action_l61c12]\n  and [RL_flashC_rseqFsm_action_l62c12] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_rseqFsm_action_l57c12 &&
	  (WILL_FIRE_RL_flashC_rseqFsm_action_l58c12 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_np ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l60c10 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ||
	   WILL_FIRE_RL_flashC_rseqFsm_action_l62c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 57, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_rseqFsm_action_l57c12]\n  and [RL_flashC_rseqFsm_action_l58c12, RL_flashC_rseqFsm_action_d_init_np,\n  RL_flashC_rseqFsm_action_np, RL_flashC_rseqFsm_action_l60c10,\n  RL_flashC_rseqFsm_action_l61c12, RL_flashC_rseqFsm_action_l62c12] ) fired in\n  the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_wseqFsm_action_l68c12 &&
	  (WILL_FIRE_RL_flashC_wseqFsm_action_l69c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_np ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l71c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l73c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 68, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_wseqFsm_action_l68c12]\n  and [RL_flashC_wseqFsm_action_l69c12, RL_flashC_wseqFsm_action_d_init_np,\n  RL_flashC_wseqFsm_action_np, RL_flashC_wseqFsm_action_l71c12,\n  RL_flashC_wseqFsm_action_l72c12, RL_flashC_wseqFsm_action_l73c12] ) fired in\n  the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_flashC_wseqFsm_action_l69c12 &&
	  (WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_np ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l71c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l73c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 69, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_wseqFsm_action_l69c12]\n  and [RL_flashC_wseqFsm_action_d_init_np, RL_flashC_wseqFsm_action_np,\n  RL_flashC_wseqFsm_action_l71c12, RL_flashC_wseqFsm_action_l72c12,\n  RL_flashC_wseqFsm_action_l73c12] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
    ...
    if (wciS0_MReset_n)
	  ...
	  (WILL_FIRE_RL_flashC_wseqFsm_action_l68c12 ||
	   ...
	   WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ||
	   WILL_FIRE_RL_flashC_wseqFsm_action_l73c12))
	$display("Error: \"bsv/dev/Flash.bsv\", line 67, column 12: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_flashC_wseqFsm_action_l67c12]\n  and [RL_flashC_wseqFsm_action_l68c12, RL_flashC_wseqFsm_action_l69c12,\n  RL_flashC_wseqFsm_action_d_init_np, RL_flashC_wseqFsm_action_np,\n  RL_flashC_wseqFsm_action_l71c12, RL_flashC_wseqFsm_action_l72c12,\n  RL_flashC_wseqFsm_action_l73c12] ) fired in the same clock cycle.\n");
  end
  // synopsys translate_on
