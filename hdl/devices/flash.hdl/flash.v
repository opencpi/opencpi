...
//
// On Tue Jan 11 11:58:55 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire flashC_reqF_i_notEmpty__28_AND_IF_flashC_reqF__ETC___d348,
       flashC_rseqFsm_state_mkFSMstate_64_EQ_4_72_AND_ETC___d218,
       flashC_wseqFsm_state_mkFSMstate_48_EQ_5_58_AND_ETC___d306,
       wci_wslv_reqF_i_notEmpty__3_AND_IF_wci_wslv_re_ETC___d404,
       wci_wslv_reqF_i_notEmpty__3_AND_wci_wslv_reqF__ETC___d382;
  ...
  assign flashC_rseqFsm_state_run_pw$whas =
	     ...
	     WILL_FIRE_RL_flashC_rseqFsm_actionof_l58c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_actionof_l57c12 ;
  assign flashC_rseqFsm_state_start_pw$whas = flashC_rseqFsm_start_wire$whas ;
  ...
  assign flashC_wseqFsm_state_run_pw$whas =
	     ...
	     WILL_FIRE_RL_flashC_wseqFsm_actionof_l68c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_actionof_l67c12 ;
  assign flashC_wseqFsm_state_start_pw$whas = flashC_wseqFsm_start_wire$whas ;
  ...
  assign flashC_reqF_i_notEmpty__28_AND_IF_flashC_reqF__ETC___d348 =
		...
		(flashC_wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !flashC_wseqFsm_state_standby) &&
		!flashC_wseqFsm_start_reg) ;
  assign flashC_rseqFsm_state_mkFSMstate_64_EQ_4_72_AND_ETC___d218 =
	     flashC_rseqFsm_state_mkFSMstate == 4'd4 &&
	     flashC_rseqFsm_repeat_count == 4'd0 ;
  assign flashC_wseqFsm_state_mkFSMstate_48_EQ_5_58_AND_ETC___d306 =
	     flashC_wseqFsm_state_mkFSMstate == 4'd5 &&
	     flashC_wseqFsm_repeat_count == 4'd0 ;
  ...
  assign wci_wslv_reqF_i_notEmpty__3_AND_IF_wci_wslv_re_ETC___d404 =
		...
		flashC_reqF$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign wci_wslv_reqF_i_notEmpty__3_AND_wci_wslv_reqF__ETC___d382 =
	     wci_wslv_reqF$EMPTY_N &&
	     ((wci_wslv_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
  ...
  begin
	...
	$write("");
    if (wciS0_MReset_n)
      if (flashC_wseqFsm_state_mkFSMstate_48_EQ_5_58_AND_ETC___d306 &&
	  !flashC_isRead)
	$write("");
    if (wciS0_MReset_n)
