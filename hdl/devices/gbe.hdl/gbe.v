...
//
// On Tue Jan 11 11:59:08 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire [59 : 0] wciRx_wslv_wciReq$wget, wciTx_wslv_wciReq$wget;
  wire [33 : 0] wciRx_wslv_respF_x_wire$wget, wciTx_wslv_respF_x_wire$wget;
  wire [31 : 0] wciRx_wci_Es_mData_w$wget,
		wciTx_wci_Es_mData_w$wget,
		wsi_Es_mData_w$wget;
  wire [19 : 0] wciRx_wci_Es_mAddr_w$wget, wciTx_wci_Es_mAddr_w$wget;
  ...
  // ports of submodule wciRx_wslv_isReset
  wire wciRx_wslv_isReset$VAL;

  // ports of submodule wciRx_wslv_reqF
  wire [59 : 0] wciRx_wslv_reqF$D_IN, wciRx_wslv_reqF$D_OUT;
  wire wciRx_wslv_reqF$CLR,
       wciRx_wslv_reqF$DEQ,
       wciRx_wslv_reqF$EMPTY_N,
       wciRx_wslv_reqF$ENQ;

  // ports of submodule wciTx_wslv_isReset
  wire wciTx_wslv_isReset$VAL;

  // ports of submodule wciTx_wslv_reqF
  wire [59 : 0] wciTx_wslv_reqF$D_IN, wciTx_wslv_reqF$D_OUT;
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1556,
		IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1557,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1327,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1551,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1569,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1570,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1562,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1563,
		status__h38645,
		x_data__h38067;
  wire [15 : 0] x__h38791;
  wire [11 : 0] x_burstLength__h38066;
  wire [7 : 0] x__h16603,
	       x__h23178,
	       x__h27342,
	       x__h34071,
  ...
  wire [1 : 0] ab__h21324, ab__h32015;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1337,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1559,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1560,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1494,
       emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1493,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1496,
       emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1495,
       wsiS_reqFifo_notFull__17_AND_wsiS_burstKind_32_ETC___d439,
       z__h16623,
       z__h16630,
       z__h16637,
       z__h16644,
  ...
  assign wciS0_SThreadBusy =
	     wciRx_wslv_reqF_countReg > 2'd1 || wciRx_wslv_isReset$VAL ;
  ...
  assign wciS1_SThreadBusy =
	     wciTx_wslv_reqF_countReg > 2'd1 || wciTx_wslv_isReset$VAL ;
  ...
  BypassCrossingWire #(.width(32'd8)) emac_rx_buffer_rRdPackets_wdCounterCrossing(.WVAL(emac_rx_buffer_rRdPackets_wdCounterCrossing$WVAL),
										  .WGET(emac_rx_buffer_rRdPackets_wdCounterCrossing$WGET));

  // submodule emac_rx_buffer_rWrPackets_wdCounterCrossing
  BypassCrossingWire #(.width(32'd8)) emac_rx_buffer_rWrPackets_wdCounterCrossing(.WVAL(emac_rx_buffer_rWrPackets_wdCounterCrossing$WVAL),
  ...
  BypassCrossingWire #(.width(32'd8)) emac_tx_buffer_rRdPackets_wdCounterCrossing(.WVAL(emac_tx_buffer_rRdPackets_wdCounterCrossing$WVAL),
										  .WGET(emac_tx_buffer_rRdPackets_wdCounterCrossing$WGET));

  // submodule emac_tx_buffer_rWrPackets_wdCounterCrossing
  BypassCrossingWire #(.width(32'd8)) emac_tx_buffer_rWrPackets_wdCounterCrossing(.WVAL(emac_tx_buffer_rWrPackets_wdCounterCrossing$WVAL),
  ...
  // submodule wciRx_wslv_isReset
  ResetToBool wciRx_wslv_isReset(.RST(wciS0_MReset_n),
				 .VAL(wciRx_wslv_isReset$VAL));
  ...
  // submodule wciTx_wslv_isReset
  ResetToBool wciTx_wslv_isReset(.RST(wciS0_MReset_n),
				 .VAL(wciTx_wslv_isReset$VAL));
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1557[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h23178 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h23841 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1551[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h16603 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h17266 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1570[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h34071 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h34734 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1563[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h27342 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h28005 ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1337,
	       1'd0,
	       x_burstLength__h38066,
	       x_data__h38067,
	       12'd3840 } ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h21324[1] || ab__h21324[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h32015[1] || ab__h32015[0] } ;
  ...
  assign wciRx_wslv_reqF_r_enq$whas = wciRx_wslv_wciReq$wget[59:57] != 3'd0 ;
  ...
  assign wciRx_wslv_wci_cfwr_pw$whas =
	     wciRx_wslv_reqF$EMPTY_N && wciRx_wslv_reqF$D_OUT[56] &&
	     wciRx_wslv_reqF$D_OUT[59:57] == 3'd1 ;
  assign wciRx_wslv_wci_cfrd_pw$whas =
	     wciRx_wslv_reqF$EMPTY_N && wciRx_wslv_reqF$D_OUT[56] &&
	     wciRx_wslv_reqF$D_OUT[59:57] == 3'd2 ;
  assign wciRx_wslv_wci_ctrl_pw$whas =
	     wciRx_wslv_reqF$EMPTY_N && !wciRx_wslv_reqF$D_OUT[56] &&
	     wciRx_wslv_reqF$D_OUT[59:57] == 3'd2 ;
  assign wciTx_wslv_reqF_r_enq$whas = wciTx_wslv_wciReq$wget[59:57] != 3'd0 ;
  ...
  assign wciTx_wslv_wci_cfwr_pw$whas =
	     wciTx_wslv_reqF$EMPTY_N && wciTx_wslv_reqF$D_OUT[56] &&
	     wciTx_wslv_reqF$D_OUT[59:57] == 3'd1 ;
  assign wciTx_wslv_wci_cfrd_pw$whas =
	     wciTx_wslv_reqF$EMPTY_N && wciTx_wslv_reqF$D_OUT[56] &&
	     wciTx_wslv_reqF$D_OUT[59:57] == 3'd2 ;
  ...
  assign wciRx_wslv_reqF_countReg$D_IN =
	     (wciRx_wslv_wciReq$wget[59:57] != 3'd0) ?
  ...
  assign wciTx_wslv_reqF_countReg$D_IN =
	     (wciTx_wslv_wciReq$wget[59:57] != 3'd0) ?
  ...
  assign wciRx_wslv_reqF$ENQ = wciRx_wslv_wciReq$wget[59:57] != 3'd0 ;
  ...
  assign wciTx_wslv_reqF$ENQ = wciTx_wslv_wciReq$wget[59:57] != 3'd0 ;
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1337 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1556 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1557 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1494 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1556 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1327 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1551 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1493 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1327 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1559 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1560 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1569 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1570 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1496 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1569 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1562 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1563 =
	     emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1495 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1562 :
	       32'd0 ;
  assign ab__h21324 = 2'd0 ;
  assign ab__h32015 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d831 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_45_ETC___d807) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1494 =
	     z__h23233 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1493 =
	     z__h16658 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1192 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1159) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1496 =
	     z__h34126 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1495 =
	     z__h27397 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h38645 = { 16'd0, x__h38791 } ;
  assign wsiS_reqFifo_notFull__17_AND_wsiS_burstKind_32_ETC___d439 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  assign x__h38791 = { wsiM_statusR, wsiS_statusR } ;
  assign x_burstLength__h38066 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1337 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h38067 = { 24'd0, x__h38131 } ;
  assign y__h17266 = ~x__h16603 ;
  assign y__h23841 = ~x__h23178 ;
  assign y__h28005 = ~x__h27342 ;
  assign y__h34734 = ~x__h34071 ;
  assign z__h16623 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h16630 = z__h16623 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h16637 = z__h16630 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h16644 = z__h16637 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h16651 = z__h16644 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h16658 = z__h16651 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h23198 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h23205 = z__h23198 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h23212 = z__h23205 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h23219 = z__h23212 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h23226 = z__h23219 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h23233 = z__h23226 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h27362 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h27369 = z__h27362 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h27376 = z__h27369 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h27383 = z__h27376 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h27390 = z__h27383 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h27397 = z__h27390 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h34091 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h34098 = z__h34091 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h34105 = z__h34098 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h34112 = z__h34105 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h34119 = z__h34112 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h34126 = z__h34119 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h38710 = status__h38645;
      8'h04: _theResult____h38710 = gbeControl;
      8'h10: _theResult____h38710 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h38710 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h38710 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h38710 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h38710 = 32'd0;
    endcase
  end
  ...
  begin
	...
	$display("[%0d]: %m: WCI CONFIG WRITE Addr:%0x BE:%0x Data:%0x",
		 v__h38572,
		 wciRx_wslv_reqF$D_OUT[51:32],
		 wciRx_wslv_reqF$D_OUT[55:52],
