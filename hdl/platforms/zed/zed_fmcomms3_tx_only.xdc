...
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA02_P}]; # FMCOMMS3 RX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA02_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA03_P}]; # FMCOMMS3 RX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA03_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA04_P}]; # FMCOMMS3 RX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA04_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA05_P}]; # FMCOMMS3 RX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA05_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA06_P}]; # FMCOMMS3 RX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA06_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA07_P}]; # FMCOMMS3 RX_D
...
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA11_P}]; # FMCOMMS3 TX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA11_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA12_P}]; # FMCOMMS3 TX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA12_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA13_P}]; # FMCOMMS3 TX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA13_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA10_P}]; # FMCOMMS3 TX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA10_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA14_P}]; # FMCOMMS3 TX_D
set_property DIFF_TERM 1 [get_ports {FMC_LA14_P}]
set_property IOSTANDARD LVDS_25 [get_ports {FMC_LA15_P}]; # FMCOMMS3 TX_D
...
# FMCOMMS3 DATA_CLK_P
create_clock -period 4.069 -name FMC_LA00_CC_P -waveform {0.000 2.0345} [get_ports {FMC_LA00_CC_P}] # AD9361 datasheet-specified max clock period
...
# FMCOMMS3 TX_FRAME_P, tx_fb_clock_delay=1, tx_data_delay=0
...
#
# ----- assumed no-OS init_param settings (values chosen specifically to meet static timing):
# tx_fb_clock_delay=1
# tx_data_delay=0
#
# ----- calculations
# tsu_r = t_STx_max + (tx_fb_clock_delay-tx_data_delay)*0.3 =  1.3 (AD9361 datasheet only specifies falling edge requirement, but rising is implied since DDR is used)
# thd_r = t_HTx_max - (tx_fb_clock_delay-tx_data_delay)*0.3 = -0.3 (AD9361 datasheet only specifies falling edge requirement, but rising is implied since DDR is used)
# tsu_f = t_STx_max + (tx_fb_clock_delay-tx_data_delay)*0.3 =  1.3
# thd_f = t_HTx_max - (tx_fb_clock_delay-tx_data_delay)*0.3 = -0.3
