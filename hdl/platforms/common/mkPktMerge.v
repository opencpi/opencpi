...
module mkPktMerge(CLK,
  ...
  reg [63 : 0] v__h891;
  wire fo_RDY_enq_AND_IF_fi0HasPrio_2_THEN_fi0_RDY_fi_ETC___d26;
  ...
  assign WILL_FIRE_RL_arbitrate =
	     fo_RDY_enq_AND_IF_fi0HasPrio_2_THEN_fi0_RDY_fi_ETC___d26 &&
	     fi0$EMPTY_N &&
	     fi1$EMPTY_N &&
	     !fi0Active &&
	     !fi1Active ;
  ...
  assign WILL_FIRE_RL_fi1_advance =
	     fi1$EMPTY_N && fo$FULL_N && !fi0Active &&
	     !WILL_FIRE_RL_fi0_advance &&
	     !WILL_FIRE_RL_arbitrate ;
  ...
  // remaining internal signals
  assign fo_RDY_enq_AND_IF_fi0HasPrio_2_THEN_fi0_RDY_fi_ETC___d26 =
