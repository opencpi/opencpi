...
//
// On Tue Aug 23 15:36:45 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  reg [63 : 0] v__h15553,
	       ...
	       v__h75902,
	       v__h76056;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319,
	       IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320,
	       IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321,
	       IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322,
	       IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d2253,
	       _theResult____h76040,
	       rdata__h69245;
  reg [15 : 0] CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2;
  reg [1 : 0] lowAddr10__h51368, x__h51490, x__h51513;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5,
      ...
      IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2284,
      IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d1176,
      IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2285,
      IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d1186,
      IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2286,
      IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d1196,
      IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2287,
      IF_bml_dpControl_wget__915_BITS_1_TO_0_921_EQ__ETC___d1992,
      IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d1398,
      IF_wmi_addr_744_BITS_3_TO_2_745_EQ_0_746_THEN__ETC___d2270,
      IF_wmi_p4B_801_EQ_1_804_THEN_bram_serverAdapte_ETC___d1810;
  wire [127 : 0] IF_tlp_readNxtDWAddr_335_BIT_0_512_THEN_bram_s_ETC___d1517,
		 ...
		 w_data__h36638,
		 w_data__h37954;
  wire [31 : 0] bml_fabFlowAddr_954_PLUS_bml_fabFlowSize_955___d2514,
		mesgMeta_opcode__h67526,
		nowLS__h21924,
		nowLS__h33122,
		nowMS__h21923,
		nowMS__h33121,
  ...
  wire [15 : 0] w_be__h26128,
		...
		y__h25345,
		y__h36964;
  wire [12 : 0] spanToNextPage__h25162,
		spanToNextPage__h36356,
		thisRequestLength__h25163,
		thisRequestLength__h36357,
  ...
  wire [11 : 0] byteCount__h51370, x__h51481, x__h51483, y__h51482, y__h51484;
  wire [9 : 0] x__h25723, x__h36967, x__h37646;
  wire [7 : 0] rreq_tag__h25392, tag__h36632, tagm__h36757;
  wire [6 : 0] lowAddr__h51369;
  wire [3 : 0] lastBE__h25592, lastBE__h36659;
  ...
  wire IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d1199,
       ...
       IF_wmi_p4B_801_EQ_0_802_THEN_bram_serverAdapte_ETC___d1815,
       NOT_bml_lclBufDone_939_006_AND_IF_bml_dpContro_ETC___d2019,
       NOT_tlp_mReqF_first__117_BITS_28_TO_19_294_EQ__ETC___d1308,
       NOT_wmi_wrActive_716_717_OR_NOT_wmi_rdActive_7_ETC___d1726,
       _dfoo5,
       bml_crdBuf_value_897_EQ_bml_crdBuf_modulus_bw__ETC___d2606,
       bml_fabBuf_value_882_EQ_bml_fabBuf_modulus_bw__ETC___d2607,
       bml_lclBufDone_939_AND_IF_bml_dpControl_wget___ETC___d2292,
       bml_lclBuf_value_852_EQ_bml_lclBuf_modulus_bw__ETC___d2622,
       bml_remBuf_value_867_EQ_bml_remBuf_modulus_bw__ETC___d2623,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2518,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2519,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d1477,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2520,
       bram_serverAdapterA_cnt_6_SLT_3___d2517,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d1479,
       bram_serverAdapterA_outData_outData_whas__387__ETC___d1475,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1666,
       bram_serverAdapterB_1_outData_outData_whas__68_ETC___d1694,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1667,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1668,
       bram_serverAdapterB_cnt_5_SLT_3___d1665,
       ...
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d913,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d961,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d994,
       hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d654,
       tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2515,
       tlp_dmaPullRemainDWSub_017_ULE_4___d2516,
       tlp_inF_first__98_BITS_63_TO_56_01_EQ_pciDevic_ETC___d911,
       tlp_inF_first__98_BIT_152_052_AND_NOT_tlp_inF__ETC___d1077,
       tlp_mReqF_RDY_first__116_AND_IF_tlp_mReqF_firs_ETC___d1132,
       tlp_mRespF_first__67_BITS_71_TO_62_57_ULE_1___d2229,
       tlp_outDwRemain_82_ULE_4___d2248,
       tlp_rdRespDwRemain_467_ULE_4___d1468,
       tlp_readRemainDWLen_323_ULE_4___d1324,
       tlp_writeRemainDWLen_153_ULE_1___d2224,
       tlp_writeRemainDWLen_153_ULE_2___d2227,
       tlp_writeRemainDWLen_153_ULE_3___d2223,
       wmi_dpControl_whas__652_AND_bram_serverAdapter_ETC___d1698,
       wmi_wmi_operateD_605_AND_wmi_wmi_peerIsReady_6_ETC___d1780;
  ...
  // submodule tlp_inF
  arSRLFIFO #(.width(32'd153), .l2depth(32'd4)) tlp_inF(.CLK(CLK),
							.RST_N(RST_N),
							.D_IN(tlp_inF$D_IN),
							.ENQ(tlp_inF$ENQ),
							.DEQ(tlp_inF$DEQ),
  ...
  // submodule tlp_mReqF
  arSRLFIFO #(.width(32'd130), .l2depth(32'd4)) tlp_mReqF(.CLK(CLK),
							  .RST_N(RST_N),
							  .D_IN(tlp_mReqF$D_IN),
							  .ENQ(tlp_mReqF$ENQ),
							  .DEQ(tlp_mReqF$DEQ),
  ...
  // submodule tlp_outF
  arSRLFIFO #(.width(32'd153), .l2depth(32'd4)) tlp_outF(.CLK(CLK),
							 .RST_N(RST_N),
							 .D_IN(tlp_outF$D_IN),
							 .ENQ(tlp_outF$ENQ),
							 .DEQ(tlp_outF$DEQ),
  ...
  arSRLFIFO #(.width(32'd60), .l2depth(32'd4)) tlp_readReq(.CLK(CLK),
							   .RST_N(RST_N),
  ...
  assign WILL_FIRE_RL_tlp_read_FirstReq =
	     tlp_readReq$FULL_N && tlp_mReqF$EMPTY_N &&
	     NOT_tlp_mReqF_first__117_BITS_28_TO_19_294_EQ__ETC___d1308 &&
	     !tlp_readStarted &&
	     tlp_mReqF$D_OUT[129:128] != 2'd0 &&
	     tlp_mReqF$D_OUT[129:128] != 2'd1 ;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h74512 : x__h74517 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h73269 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_882_EQ_bml_fabBuf_modulus_bw__ETC___d2607 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_954_PLUS_bml_fabFlowSize_955___d2514 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h74550 : x__h74555 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h44390 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320[31:24] } ;
  always@(idx__h45694 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321[31:24] } ;
  always@(idx__h46998 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h25720 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h36453 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h25163[11:2],
	       8'd255,
	       rreq_tag__h25392,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     tlp_mesgLengthRemainPush - y__h25203 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h25568 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h26555 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h27625 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h30825 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h36638 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h37954 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h25345 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h36964 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_017_ULE_4___d2516 ||
	     !tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2515 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h25297 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h76040 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h69245 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h69081 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h69101 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h69121 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h69141 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h36757 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__98_BITS_63_TO_56_01_EQ_pciDevic_ETC___d911 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h36357[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_017_ULE_4___d2516 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_017_ULE_4___d2516;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h69101[7:0], y_avValue__h69081[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h67486;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h67526;
  ...
  assign IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d1406 =
		...
		bram_serverAdapterA_outData_enqData$whas) &&
	       ...
	       IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d1398 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q14 ;
  assign IF_wmi_p4B_801_EQ_0_802_THEN_bram_serverAdapte_ETC___d1815 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_801_EQ_1_804_THEN_bram_serverAdapte_ETC___d1810 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q15 ;
  assign NOT_bml_lclBufDone_939_006_AND_IF_bml_dpContro_ETC___d2019 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q1 ;
  assign NOT_tlp_mReqF_first__117_BITS_28_TO_19_294_EQ__ETC___d1308 =
	     (tlp_mReqF$D_OUT[28:19] != 10'd1 || tlp_mReqF$EMPTY_N) &&
	     CASE_tlp_mReqFD_OUT_BITS_30_TO_29_NOT_tlp_mRe_ETC__q4 ;
  assign NOT_wmi_wrActive_716_717_OR_NOT_wmi_rdActive_7_ETC___d1726 =
  ...
  assign ab__h8863 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_897_EQ_bml_crdBuf_modulus_bw__ETC___d2606 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_882_EQ_bml_fabBuf_modulus_bw__ETC___d2607 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_954_PLUS_bml_fabFlowSize_955___d2514 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_939_AND_IF_bml_dpControl_wget___ETC___d2292 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5 ;
  assign bml_lclBuf_value_852_EQ_bml_lclBuf_modulus_bw__ETC___d2622 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_867_EQ_bml_remBuf_modulus_bw__ETC___d2623 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2518 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2519 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2520 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2517 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1666 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__68_ETC___d1694 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1667 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1668 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1665 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h51370 = x__h51481 - y__h51482 ;
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d877 =
	     ...
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d913 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h36757 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__98_BITS_63_TO_56_01_EQ_pciDevic_ETC___d911 ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d961 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_fabMeta[127:96] != 32'd0 &&
	     !tlp_tlpXmtBusy &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d654 =
	     ...
	     tlp_nearBufReady &&
	     tlp_farBufReady ;
  assign idx__h42159 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h44390 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h45694 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h46998 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h49254 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h49722 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50095 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50468 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h25592 =
	     tlp_mRespF_first__67_BITS_71_TO_62_57_ULE_1___d2229 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h36659 =
	     (thisRequestLength__h36357[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h51369 = { tlp_readReq$D_OUT[33:29], lowAddr10__h51368 } ;
  assign mesgMeta_opcode__h67526 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h21924 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h33122 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h21923 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h33121 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h21922 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h33120 =
  ...
  assign rdat__h76119 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h76127 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h76135 = { 16'd0, bml_mesgBase } ;
  assign rdat__h76143 = { 16'd0, bml_metaBase } ;
  assign rdat__h76151 = { 16'd0, bml_mesgSize } ;
  assign rdat__h76159 = { 16'd0, bml_metaSize } ;
  assign rdat__h76167 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h76188 = { bml_lclBufsAR, bml_fabBufsAvail } ;
  assign rdat__h76193 = { bml_remBuf_value, bml_lclBuf_value } ;
  assign rdat__h76204 = { bml_lclStarts, bml_lclDones } ;
  assign rdat__h76209 = { bml_remStarts, bml_remDones } ;
  assign rdat__h76526 = { wmi_reqCount, wmi_wrtCount } ;
  assign rdat__h76680 = { 28'd0, dpControl } ;
  assign rdata__h56786 =
	     tlp_readNxtDWAddr[1] ?
	       IF_tlp_readNxtDWAddr_335_BIT_0_512_THEN_bram_s_ETC___d1517 :
	       IF_tlp_readNxtDWAddr_335_BIT_0_512_THEN_bram_s_ETC___d1522 ;
  assign rreq_tag__h25392 =
	     (y__h25203 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h51412 =
	     { IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d2253[7:0],
	       IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d2253[15:8],
	       IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d2253[23:16],
	       IF_tlp_readReq_first__383_BITS_30_TO_29_384_EQ_ETC___d2253[31:24] } ;
  assign spanToNextPage__h25162 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h36356 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h36632 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h36757 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h25163 =
	     (x__h25216[12:0] <= spanToNextPage__h25162) ?
	       x__h25216[12:0] :
	       spanToNextPage__h25162 ;
  assign thisRequestLength__h36357 =
	     (x__h36390[12:0] <= spanToNextPage__h36356) ?
	       x__h36390[12:0] :
	       spanToNextPage__h36356 ;
  assign tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2515 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_017_ULE_4___d2516 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__98_BITS_63_TO_56_01_EQ_pciDevic_ETC___d911 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__98_BIT_152_052_AND_NOT_tlp_inF__ETC___d1077 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_RDY_first__116_AND_IF_tlp_mReqF_firs_ETC___d1132 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q3 ;
  assign tlp_mRespF_first__67_BITS_71_TO_62_57_ULE_1___d2229 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign tlp_outDwRemain_82_ULE_4___d2248 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_writeRemainDWLen_153_ULE_1___d2224 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_153_ULE_2___d2227 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_153_ULE_3___d2223 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h26128 =
	     tlp_outDwRemain_82_ULE_4___d2248 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2 :
	       16'd65535 ;
  assign w_data__h25568 =
	     { 22'd1048580,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h30825 =
	     { 32'd4100,
	       ...
	       34'd0 } ;
  assign w_data__h36638 =
	     { 22'd4,
	       thisRequestLength__h36357[11:2],
	       pciDevice,
	       tag__h36632,
	       lastBE__h36659,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h37954 =
	     { 32'd1073745921,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_dpControl_whas__652_AND_bram_serverAdapter_ETC___d1698 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__68_ETC___d1694 ;
  assign wmi_wmi_operateD_605_AND_wmi_wmi_peerIsReady_6_ETC___d1780 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1665 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1666 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1667 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1668 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h67486 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21985 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h25216 =
	     (tlp_mesgLengthRemainPush <= y__h25218) ?
	       tlp_mesgLengthRemainPush :
	       y__h25218 ;
  assign x__h25723 = { tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h33152 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h36390 =
	     (tlp_mesgLengthRemainPull <= y__h36392) ?
	       tlp_mesgLengthRemainPull :
	       y__h36392 ;
  assign x__h36967 = { tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h37646 = { tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h51481 = x__h51483 - y__h51484 ;
  assign x__h51483 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h73269 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h74393 = bml_lclBufsAR + 16'd1 ;
  assign x__h74398 = bml_lclBufsAR - 16'd1 ;
  assign x__h74470 = bml_lclBufsCF + 16'd1 ;
  assign x__h74475 = bml_lclBufsCF - 16'd1 ;
  assign x__h74512 = bml_fabBufsAvail + 16'd1 ;
  assign x__h74517 = bml_fabBufsAvail - 16'd1 ;
  assign x__h74550 = bml_lclCredit + 16'd1 ;
  assign x__h74555 = bml_lclCredit - 16'd1 ;
  assign y__h25203 = { 4'd0, thisRequestLength__h25163 } ;
  assign y__h25218 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h25297 = { 19'd0, thisRequestLength__h25163 } ;
  assign y__h25345 = { 3'd0, thisRequestLength__h25163 } ;
  assign y__h25720 = { 22'd0, x__h25723 } ;
  assign y__h36382 = { 4'd0, thisRequestLength__h36357 } ;
  assign y__h36392 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h36453 = { 19'd0, thisRequestLength__h36357 } ;
  assign y__h36964 = { 6'd0, x__h36967 } ;
  assign y__h37643 =
	     tlp_dmaPullRemainDWSub_017_ULE_4___d2516 ?
	       { 7'd0, x__h37646 } :
	       17'd16 ;
  assign y__h51482 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h51513 } ;
  assign y__h51484 = { 10'd0, x__h51490 } ;
  assign y_avValue__h69081 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h69101 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h69121 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h69141 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h51490 = 2'b10;
      4'b1110: x__h51490 = 2'b01;
      4'b1111: x__h51490 = 2'b0;
      default: x__h51490 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h51513 = 2'b10;
      4'b1110: x__h51513 = 2'b01;
      4'b1111: x__h51513 = 2'b0;
      default: x__h51513 = 2'b11;
    endcase
  end
  always@(wmi_p4B or
	  y_avValue__h69141 or
	  y_avValue__h69081 or y_avValue__h69101 or y_avValue__h69121)
  begin
    case (wmi_p4B)
      2'd0: rdata__h69245 = y_avValue__h69081;
      2'd1: rdata__h69245 = y_avValue__h69101;
      2'd2: rdata__h69245 = y_avValue__h69121;
      2'd3: rdata__h69245 = y_avValue__h69141;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h51368 = 2'b11;
      4'b1100: lowAddr10__h51368 = 2'b10;
      4'b1110: lowAddr10__h51368 = 2'b01;
      default: lowAddr10__h51368 = 2'b0;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  bml_fabMesgSize or
	  bml_fabMetaSize or
	  bml_fabFlowBase or bml_fabFlowSize or rdat__h76680)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h76040 = rdat__h76119;
      8'h04: _theResult____h76040 = rdat__h76127;
      8'h08: _theResult____h76040 = rdat__h76135;
      8'h0C: _theResult____h76040 = rdat__h76143;
      8'h10: _theResult____h76040 = rdat__h76151;
      8'h14: _theResult____h76040 = rdat__h76159;
      8'h20: _theResult____h76040 = rdat__h76167;
      8'h24: _theResult____h76040 = 32'hF00DFACE;
      8'h28: _theResult____h76040 = rdat__h76188;
      8'h2C: _theResult____h76040 = rdat__h76193;
      8'h30: _theResult____h76040 = rdat__h76204;
      8'h34: _theResult____h76040 = rdat__h76209;
      8'h38: _theResult____h76040 = wmi_thisMesg;
      8'h3C: _theResult____h76040 = wmi_lastMesg;
      8'h40: _theResult____h76040 = rdat__h76526;
      8'h44: _theResult____h76040 = 32'h0;
      8'h48: _theResult____h76040 = 32'hDADEBABE;
      8'h4C: _theResult____h76040 = 32'h00008000;
      8'h50: _theResult____h76040 = bml_fabMesgBase;
      8'h54: _theResult____h76040 = bml_fabMetaBase;
      8'h58: _theResult____h76040 = bml_fabMesgSize;
      8'h5C: _theResult____h76040 = bml_fabMetaSize;
      8'h60: _theResult____h76040 = bml_fabFlowBase;
      8'h64: _theResult____h76040 = bml_fabFlowSize;
      8'h68: _theResult____h76040 = rdat__h76680;
      default: _theResult____h76040 = 32'd0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__915_BITS_1_TO_0_921_EQ__ETC___d1992 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__915_BITS_1_TO_0_921_EQ__ETC___d1992 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h42159 or
	  tlp_writeRemainDWLen_153_ULE_3___d2223 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_153_ULE_1___d2224 or
	  tlp_writeRemainDWLen_153_ULE_2___d2227)
  begin
    case (idx__h42159)
      2'd0:
  ...
  always@(tlp_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2520 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2517 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2518 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2519)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1668 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1665 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1666 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1667)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h45694 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45694)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2321 =
  ...
  always@(idx__h42159 or tlp_mReqF$D_OUT)
  begin
    case (idx__h42159)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319 =
	      tlp_mReqF$D_OUT[127:96];
      2'd1:
	  IF_0_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2319 =
	      tlp_mReqF$D_OUT[95:64];
  ...
  always@(idx__h46998 or tlp_mReqF$D_OUT)
  begin
    case (idx__h46998)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2322 =
  ...
  always@(idx__h44390 or tlp_mReqF$D_OUT)
  begin
    case (idx__h44390)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_149_BITS_1_TO_0_150_ETC___d2320 =
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_801_EQ_1_804_THEN_bram_serverAdapte_ETC___d1810 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_801_EQ_1_804_THEN_bram_serverAdapte_ETC___d1810 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    ...
    if (RST_N)
      if (MUX_tlp_outF$enq_1__SEL_2)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h27456);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h30215);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h30401);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h30567);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h38829);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h30906);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h37867);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h75528);
    if (RST_N)
