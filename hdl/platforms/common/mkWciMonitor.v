...
//
// On Sun Apr  3 10:45:24 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  wire [60 : 0] MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1,
		...
		MUX_pmsender_wsiM_reqFifo_q_1$write_1__VAL_2;
  ...
  wire MUX_observer_evF$enq_1__SEL_1,
       ...
       MUX_pmsender_wsiM_reqFifo_q_0$write_1__SEL_1,
  ...
  reg [2 : 0] CASE_observer_evFD_OUT_BITS_98_TO_96_5_0_obse_ETC__q6,
	      len__h4652;
  wire [31 : 0] monId_CONCAT_IF_IF_pmsender_evF_first__30_BITS_ETC___d357;
  wire [11 : 0] x_burstLength__h4721;
  wire pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d562;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_pmsender_wsiM_reqFifo_incCtr &&
	     pmsender_wsiM_reqFifo_c_r == 2'd0 ;
  assign MUX_pmsender_wsiM_reqFifo_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_pmsender_wsiM_reqFifo_incCtr &&
	     pmsender_wsiM_reqFifo_c_r == 2'd1 ;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d562,
	       1'd0,
	       x_burstLength__h4721,
	       x_data__h4722,
	       12'd3840 } ;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_1$write_1__VAL_2 =
	     (pmsender_wsiM_reqFifo_c_r == 2'd2) ?
	       MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1 :
  ...
  // register pmsender_wsiM_reqFifo_q_0
  always@(MUX_pmsender_wsiM_reqFifo_q_0$write_1__SEL_1 or
	  MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_pmsender_wsiM_reqFifo_both or
  ...
  // register pmsender_wsiM_reqFifo_q_1
  always@(MUX_pmsender_wsiM_reqFifo_q_1$write_1__SEL_1 or
	  MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_pmsender_wsiM_reqFifo_both or
  ...
  // remaining internal signals
  assign monId_CONCAT_IF_IF_pmsender_evF_first__30_BITS_ETC___d357 =
	     { monId,
	       CASE_CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_ETC__q5,
	       pmsender_srcTag,
	       x__h5658 } ;
  assign pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d562 =
	     pmsender_idx == len__h4652 ;
  assign x_burstLength__h4721 = { 9'd0, len__h4652 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4652 = 3'd1;
      3'd1: len__h4652 = 3'd2;
      3'd2: len__h4652 = 3'd3;
      default: len__h4652 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
  ...
  always@(pmsender_idx or
	  ...
	  monId_CONCAT_IF_IF_pmsender_evF_first__30_BITS_ETC___d357)
  begin
    case (pmsender_idx)
      3'd1:
	  x_data__h4722 =
      ...
      default: x_data__h4722 = pmsender_evF$D_OUT[31:0];
    endcase
  end
