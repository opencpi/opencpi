...
//
// On Tue Mar 22 13:31:57 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h23549, v__h3661, v__h3835, v__h3979;
  reg [31 : 0] g_data__h22885, v__h20542;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1;
  wire [127 : 0] IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d567,
		 IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_metaWF_f_ETC___d538,
		 x__h18803,
		 x__h18830,
		 x__h19453,
		 x__h19477;
  wire [35 : 0] addr__h19877, addr__h20227;
  wire [31 : 0] data__h19168,
		delayStatus__h22507,
		rdat__h22912,
		rdat__h22918,
		rdat__h22924,
		...
		rdat__h23264,
		x__h15563;
  wire [26 : 0] x__h19935, x__h20272;
  wire [23 : 0] btm__h18052, x__h22934;
  wire [13 : 0] mesgLengthSoFar_83_PLUS_1___d983;
  wire [12 : 0] x__h15664;
  wire [11 : 0] x_burstLength__h22414;
  wire [3 : 0] x_byteEn__h22415;
  wire [1 : 0] wrtSerPos_00_PLUS_1___d982;
  wire IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553,
       NOT_mesgWF_rRdPtr_14_EQ_mesgWF_rWrPtr_05_41___d542,
       NOT_mesgWF_rRdPtr_14_PLUS_2048_70_EQ_mesgWF_rW_ETC___d472,
       NOT_wmemi_dhF_c_r_41_EQ_2_60_61_AND_wmemi_oper_ETC___d572,
       NOT_wrtSerPos_00_EQ_3_01_02_AND_NOT_metaWF_fir_ETC___d516,
       bytesWritten_96_ULT_dlyHoldoffBytes_75___d910,
       cyclesPassed_66_ULT_dlyHoldoffCycles_78___d908,
       dlyWordsStored_value_27_SLE_0_74_OR_bytesWritt_ETC___d582,
       dlyWordsStored_value_27_SLE_0___d909,
       dlyWordsStored_value_27_SLT_8388608___d584,
       mesgRF_i_notFull__81_AND_NOT_rdSerEmpty_31_32__ETC___d682,
       metaRF_i_notFull__30_AND_NOT_rdSerEmpty_31_32__ETC___d641,
       wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d585,
       wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d602,
  ...
  assign WILL_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_14_EQ_mesgWF_rWrPtr_05_41___d542 &&
	     IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553 &&
	     wci_wslv_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign WILL_FIRE_RL_wmemi_respAdvance =
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h20542[23:0] == 24'd0 ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22885 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_metaWF_f_ETC___d538 or
	  x__h18803 or x__h18830)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18803;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18830;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_metaWF_f_ETC___d538;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d567 or
	  x__h19453 or x__h19477)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h19453;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h19477;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d567;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_1 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_2 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19877, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h20227, 12'd1 } ;
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_00_PLUS_1___d982 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_00_PLUS_1___d982 ;
  ...
  assign mesgWF_wDataOut$wget = data__h19168 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h18052 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20542[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_83_PLUS_1___d983 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15563 } ;
  assign mesgWF_rCache$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15664 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h20542 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19168 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19168 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19168 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19168 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     WILL_FIRE_RL_wrtSer_body ?
	       x__h15664[11:0] :
	       mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h15563 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d567 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19168,
	       (wrtSerPos == 2'd2) ? data__h19168 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_metaWF_f_ETC___d538 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgWF_rRdPtr_14_EQ_mesgWF_rWrPtr_05_41___d542 =
	     mesgWF_rRdPtr != mesgWF_rWrPtr ;
  assign NOT_mesgWF_rRdPtr_14_PLUS_2048_70_EQ_mesgWF_rW_ETC___d472 =
	     mesgWF_rRdPtr + 13'd2048 != mesgWF_rWrPtr ;
  assign NOT_wmemi_dhF_c_r_41_EQ_2_60_61_AND_wmemi_oper_ETC___d572 =
	     wmemi_dhF_c_r != 2'd2 && wmemi_operateD && wmemi_peerIsReady &&
	     wide16Fa$EMPTY_N ;
  assign NOT_wrtSerPos_00_EQ_3_01_02_AND_NOT_metaWF_fir_ETC___d516 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19877 = { 9'd0, x__h19935 } ;
  assign addr__h20227 = { 9'd0, x__h20272 } ;
  assign btm__h18052 =
	     { wsiS_reqFifo$D_OUT[56] ?
		 { 10'd0, wsiS_reqFifo$D_OUT[55:44] } :
		 { 8'd0, mesgLengthSoFar_83_PLUS_1___d983 },
	       2'd0 } ;
  assign bytesWritten_96_ULT_dlyHoldoffBytes_75___d910 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_66_ULT_dlyHoldoffCycles_78___d908 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h19168 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h22507 =
	     { 14'h0,
	       !dlyWordsStored_value_27_SLE_0___d909 &&
	       !bytesWritten_96_ULT_dlyHoldoffBytes_75___d910 &&
	       !cyclesPassed_66_ULT_dlyHoldoffCycles_78___d908,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_27_SLE_0_74_OR_bytesWritt_ETC___d582 =
	     dlyWordsStored_value_27_SLE_0___d909 ||
	     bytesWritten_96_ULT_dlyHoldoffBytes_75___d910 ||
	     cyclesPassed_66_ULT_dlyHoldoffCycles_78___d908 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_27_SLE_0___d909 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_27_SLT_8388608___d584 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_83_PLUS_1___d983 = mesgLengthSoFar + 14'd1 ;
  assign mesgRF_i_notFull__81_AND_NOT_rdSerEmpty_31_32__ETC___d682 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_i_notFull__30_AND_NOT_rdSerEmpty_31_32__ETC___d641 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22912 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22918 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22924 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22930 = hasDebugLogic ? { 8'd0, x__h22934 } : 32'd0 ;
  assign rdat__h23054 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23068 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23076 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23082 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23096 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23104 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23110 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h23116 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h23122 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h23128 =
	     hasDebugLogic ?
  ...
  assign rdat__h23139 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h23150 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h23161 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h23182 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h23237 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h23246 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h23255 = { 8'd0, bytesThisMessage } ;
  assign rdat__h23264 = { 18'd0, mesgLengthSoFar } ;
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d585 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     dlyWordsStored_value_27_SLE_0_74_OR_bytesWritt_ETC___d582 &&
	     dlyWordsStored_value_27_SLT_8388608___d584 ;
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d602 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d909 &&
	     !bytesWritten_96_ULT_dlyHoldoffBytes_75___d910 &&
	     !cyclesPassed_66_ULT_dlyHoldoffCycles_78___d908 ;
  assign wrtSerPos_00_PLUS_1___d982 = wrtSerPos + 2'd1 ;
  ...
  assign x__h15563 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       ...
	       32'd0 ;
  assign x__h15664 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18803 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18830 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h19453 = { 96'd0, data__h19168 } ;
  assign x__h19477 = { 64'd0, data__h19168, wrtSerStage } ;
  assign x__h19935 = { dlyWAG, 4'h0 } ;
  assign x__h20272 = { dlyRAG, 4'h0 } ;
  assign x__h22934 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22414 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22415 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h20542 = wide16Fc$D_OUT[31:0];
      2'd1: v__h20542 = rdSerStage_1;
      2'd2: v__h20542 = rdSerStage_2;
      2'd3: v__h20542 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h23182 or
	  delayStatus__h22507 or
	  rdat__h23237 or rdat__h23246 or rdat__h23255 or rdat__h23264)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h22885 = dlyCtrl;
      32'h00000004: g_data__h22885 = dlyHoldoffBytes;
      32'h00000008: g_data__h22885 = dlyHoldoffCycles;
      32'h0000000C: g_data__h22885 = rdat__h22912;
      32'h00000010: g_data__h22885 = rdat__h22918;
      32'h00000014: g_data__h22885 = rdat__h22924;
      32'h00000018: g_data__h22885 = rdat__h22930;
      32'h0000001C: g_data__h22885 = 32'd0;
      32'h00000020: g_data__h22885 = rdat__h23054;
      32'h00000024: g_data__h22885 = rdat__h23068;
      32'h00000028: g_data__h22885 = rdat__h23076;
      32'h0000002C: g_data__h22885 = rdat__h23082;
      32'h00000030: g_data__h22885 = rdat__h23096;
      32'h00000034: g_data__h22885 = rdat__h23104;
      32'h00000038: g_data__h22885 = rdat__h23110;
      32'h0000003C: g_data__h22885 = rdat__h23116;
      32'h00000040: g_data__h22885 = rdat__h23122;
      32'h00000044: g_data__h22885 = rdat__h23128;
      32'h00000048: g_data__h22885 = rdat__h23139;
      32'h0000004C: g_data__h22885 = rdat__h23150;
      32'h00000050: g_data__h22885 = rdat__h23161;
      32'h00000058: g_data__h22885 = dlyRdOpZero;
      32'h0000005C: g_data__h22885 = dlyRdOpOther;
      32'h00000060: g_data__h22885 = rdat__h23182;
      32'h00000064: g_data__h22885 = delayStatus__h22507;
      32'h00000068: g_data__h22885 = rdat__h23237;
      32'h0000006C: g_data__h22885 = rdat__h23246;
      32'h00000070: g_data__h22885 = rdat__h23255;
      32'h00000074: g_data__h22885 = rdat__h23264;
      default: g_data__h22885 = 32'd0;
    endcase
  end
