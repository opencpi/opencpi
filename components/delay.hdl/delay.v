...
//
// On Sat Jan 15 19:03:18 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h23299, v__h3598, v__h3772, v__h3916;
  reg [31 : 0] g_data__h22635, v__h20292;
  ...
  wire [127 : 0] IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566,
		 ...
		 x__h19203,
		 x__h19227;
  wire [35 : 0] addr__h19627, addr__h19977;
  wire [31 : 0] data__h18918,
		delayStatus__h22257,
		rdat__h22662,
		rdat__h22668,
		rdat__h22674,
		...
		rdat__h23014,
		x__h15317;
  wire [26 : 0] x__h19685, x__h20022;
  wire [23 : 0] btm__h17806, x__h22684;
  wire [13 : 0] mesgLengthSoFar_82_PLUS_1___d966;
  wire [12 : 0] x__h15418;
  wire [11 : 0] x_burstLength__h22164;
  wire [3 : 0] x_byteEn__h22165;
  wire [1 : 0] wrtSerPos_99_PLUS_1___d965;
  ...
  // value method wmemiM0_mReset_n
  assign wmemiM0_MReset_n = !wmemi_isReset$VAL && wmemi_operateD ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h20292[23:0] == 24'd0 ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22635 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_metaWF_f_ETC___d537 or
	  x__h18553 or x__h18580)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18553;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18580;
  ...
  always@(wrtSerPos or
	  ...
	  x__h19203 or x__h19227)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h19203;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h19227;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19627, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h19977, 12'd1 } ;
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_99_PLUS_1___d965 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_99_PLUS_1___d965 ;
  ...
  assign mesgWF_wDataOut$wget = data__h18918 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h17806 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20292[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_82_PLUS_1___d966 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15317 } ;
  assign mesgWF_rCache$EN = WILL_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15418 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h20292 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18918 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18918 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18918 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h18918 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     WILL_FIRE_RL_wrtSer_body ?
	       x__h15418[11:0] :
	       mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h15317 ;
  ...
  assign IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h18918,
	       (wrtSerPos == 2'd2) ? data__h18918 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wrtSerPos_99_EQ_3_00_01_AND_NOT_metaWF_fir_ETC___d515 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19627 = { 9'd0, x__h19685 } ;
  assign addr__h19977 = { 9'd0, x__h20022 } ;
  assign btm__h17806 =
	     { wsiS_reqFifo$D_OUT[56] ?
		 { 10'd0, wsiS_reqFifo$D_OUT[55:44] } :
		 { 8'd0, mesgLengthSoFar_82_PLUS_1___d966 },
	       2'd0 } ;
  ...
  assign mesgLengthSoFar_82_PLUS_1___d966 = mesgLengthSoFar + 14'd1 ;
  ...
  assign metaRF_i_notFull__29_AND_NOT_rdSerEmpty_30_31__ETC___d640 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22662 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22668 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22674 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22680 = hasDebugLogic ? { 8'd0, x__h22684 } : 32'd0 ;
  assign rdat__h22804 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22818 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22826 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22832 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22846 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22854 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22860 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22866 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22872 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h22878 =
	     hasDebugLogic ?
  ...
  assign rdat__h22889 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22900 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22911 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22932 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22987 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h22996 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h23005 = { 8'd0, bytesThisMessage } ;
  assign rdat__h23014 = { 18'd0, mesgLengthSoFar } ;
  assign wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d601 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d1009 &&
	     !bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010 &&
	     !cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008 ;
  assign wrtSerPos_99_PLUS_1___d965 = wrtSerPos + 2'd1 ;
  ...
  assign x__h15317 =
	     WILL_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       32'd0 ;
  assign x__h15418 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18553 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18580 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h19203 = { 96'd0, data__h18918 } ;
  assign x__h19227 = { 64'd0, data__h18918, wrtSerStage } ;
  assign x__h19685 = { dlyWAG, 4'h0 } ;
  assign x__h20022 = { dlyRAG, 4'h0 } ;
  assign x__h22684 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22164 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22165 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h20292 = wide16Fc$D_OUT[31:0];
      2'd1: v__h20292 = rdSerStage_1;
      2'd2: v__h20292 = rdSerStage_2;
      2'd3: v__h20292 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h22932 or
	  delayStatus__h22257 or
	  rdat__h22987 or rdat__h22996 or rdat__h23005 or rdat__h23014)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h22635 = dlyCtrl;
      32'h00000004: g_data__h22635 = dlyHoldoffBytes;
      32'h00000008: g_data__h22635 = dlyHoldoffCycles;
      32'h0000000C: g_data__h22635 = rdat__h22662;
      32'h00000010: g_data__h22635 = rdat__h22668;
      32'h00000014: g_data__h22635 = rdat__h22674;
      32'h00000018: g_data__h22635 = rdat__h22680;
      32'h0000001C: g_data__h22635 = 32'd0;
      32'h00000020: g_data__h22635 = rdat__h22804;
      32'h00000024: g_data__h22635 = rdat__h22818;
      32'h00000028: g_data__h22635 = rdat__h22826;
      32'h0000002C: g_data__h22635 = rdat__h22832;
      32'h00000030: g_data__h22635 = rdat__h22846;
      32'h00000034: g_data__h22635 = rdat__h22854;
      32'h00000038: g_data__h22635 = rdat__h22860;
      32'h0000003C: g_data__h22635 = rdat__h22866;
      32'h00000040: g_data__h22635 = rdat__h22872;
      32'h00000044: g_data__h22635 = rdat__h22878;
      32'h00000048: g_data__h22635 = rdat__h22889;
      32'h0000004C: g_data__h22635 = rdat__h22900;
      32'h00000050: g_data__h22635 = rdat__h22911;
      32'h00000058: g_data__h22635 = dlyRdOpZero;
      32'h0000005C: g_data__h22635 = dlyRdOpOther;
      32'h00000060: g_data__h22635 = rdat__h22932;
      32'h00000064: g_data__h22635 = delayStatus__h22257;
      32'h00000068: g_data__h22635 = rdat__h22987;
      32'h0000006C: g_data__h22635 = rdat__h22996;
      32'h00000070: g_data__h22635 = rdat__h23005;
      32'h00000074: g_data__h22635 = rdat__h23014;
      default: g_data__h22635 = 32'd0;
    endcase
  end
