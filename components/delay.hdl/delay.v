...
//
// On Mon Feb 27 09:42:32 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h23527, v__h3661, v__h3835, v__h3979;
  reg [31 : 0] g_data__h22863, v__h20520;
  ...
  wire [127 : 0] IF_wrtSerPos_90_EQ_2_00_THEN_0x0_ELSE_mesgWF_w_ETC___d557,
		 ...
		 x__h19431,
		 x__h19455;
  wire [35 : 0] addr__h19855, addr__h20205;
  wire [31 : 0] data__h19146,
		delayStatus__h22485,
		rdat__h22890,
		rdat__h22896,
		rdat__h22902,
		...
		rdat__h23242,
		x__h15541;
  wire [26 : 0] x__h19913, x__h20250;
  wire [23 : 0] btm__h18030, x__h22912;
  wire [13 : 0] mesgLengthSoFar_73_PLUS_1___d909;
  wire [12 : 0] x__h15642;
  wire [11 : 0] x_burstLength__h22392;
  wire [3 : 0] x_byteEn__h22393;
  ...
  FIFO2 #(.width(32'd131),
	  .guarded(32'd1)) wmemi_respF(.RST(wciS0_MReset_n),
				       .CLK(wciS0_Clk),
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h20520[23:0] == 24'd0 ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22863 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_90_EQ_2_00_THEN_0x0_ELSE_metaWF_f_ETC___d528 or
	  x__h18781 or x__h18808)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18781;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18808;
  ...
  always@(wrtSerPos or
	  ...
	  x__h19431 or x__h19455)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h19431;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h19455;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19855, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h20205, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19146 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h18030 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20520[31:24] != 8'd0 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15541 } ;
  assign mesgWF_rCache$EN = WILL_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15642 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h20520 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19146 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19146 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19146 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19146 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     WILL_FIRE_RL_wrtSer_body ?
	       x__h15642[11:0] :
	       mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h15541 ;
  ...
  assign IF_wrtSerPos_90_EQ_2_00_THEN_0x0_ELSE_mesgWF_w_ETC___d557 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19146,
	       (wrtSerPos == 2'd2) ? data__h19146 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wrtSerPos_90_EQ_3_91_92_AND_NOT_metaWF_fir_ETC___d506 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19855 = { 9'd0, x__h19913 } ;
  assign addr__h20205 = { 9'd0, x__h20250 } ;
  assign btm__h18030 =
  ...
  assign metaRF_i_notFull__20_AND_NOT_rdSerEmpty_21_22__ETC___d631 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22890 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22896 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22902 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22908 = hasDebugLogic ? { 8'd0, x__h22912 } : 32'd0 ;
  assign rdat__h23032 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23046 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23054 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23060 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23074 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23082 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23088 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h23094 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h23100 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h23106 =
	     hasDebugLogic ?
  ...
  assign rdat__h23117 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h23128 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h23139 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h23160 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h23215 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h23224 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h23233 = { 8'd0, bytesThisMessage } ;
  assign rdat__h23242 = { 18'd0, mesgLengthSoFar } ;
  ...
  assign x__h15541 =
	     WILL_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       32'd0 ;
  assign x__h15642 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18781 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18808 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h19431 = { 96'd0, data__h19146 } ;
  assign x__h19455 = { 64'd0, data__h19146, wrtSerStage } ;
  assign x__h19913 = { dlyWAG, 4'h0 } ;
  assign x__h20250 = { dlyRAG, 4'h0 } ;
  assign x__h22912 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22392 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22393 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h20520 = wide16Fc$D_OUT[31:0];
      2'd1: v__h20520 = rdSerStage_1;
      2'd2: v__h20520 = rdSerStage_2;
      2'd3: v__h20520 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h23160 or
	  delayStatus__h22485 or
	  rdat__h23215 or rdat__h23224 or rdat__h23233 or rdat__h23242)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h22863 = dlyCtrl;
      32'h00000004: g_data__h22863 = dlyHoldoffBytes;
      32'h00000008: g_data__h22863 = dlyHoldoffCycles;
      32'h0000000C: g_data__h22863 = rdat__h22890;
      32'h00000010: g_data__h22863 = rdat__h22896;
      32'h00000014: g_data__h22863 = rdat__h22902;
      32'h00000018: g_data__h22863 = rdat__h22908;
      32'h0000001C: g_data__h22863 = 32'd0;
      32'h00000020: g_data__h22863 = rdat__h23032;
      32'h00000024: g_data__h22863 = rdat__h23046;
      32'h00000028: g_data__h22863 = rdat__h23054;
      32'h0000002C: g_data__h22863 = rdat__h23060;
      32'h00000030: g_data__h22863 = rdat__h23074;
      32'h00000034: g_data__h22863 = rdat__h23082;
      32'h00000038: g_data__h22863 = rdat__h23088;
      32'h0000003C: g_data__h22863 = rdat__h23094;
      32'h00000040: g_data__h22863 = rdat__h23100;
      32'h00000044: g_data__h22863 = rdat__h23106;
      32'h00000048: g_data__h22863 = rdat__h23117;
      32'h0000004C: g_data__h22863 = rdat__h23128;
      32'h00000050: g_data__h22863 = rdat__h23139;
      32'h00000058: g_data__h22863 = dlyRdOpZero;
      32'h0000005C: g_data__h22863 = dlyRdOpOther;
      32'h00000060: g_data__h22863 = rdat__h23160;
      32'h00000064: g_data__h22863 = delayStatus__h22485;
      32'h00000068: g_data__h22863 = rdat__h23215;
      32'h0000006C: g_data__h22863 = rdat__h23224;
      32'h00000070: g_data__h22863 = rdat__h23233;
      32'h00000074: g_data__h22863 = rdat__h23242;
      default: g_data__h22863 = 32'd0;
    endcase
  end
