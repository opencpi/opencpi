...
//
// On Fri Jul 30 15:10:04 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [31 : 0] x__h20948, x_data__h22228;
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22228 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x__h20948[23:0] == 24'd0 ;
  ...
  assign mesgWF_pwEnqueue$whas = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign mesgWF_wDataIn$wget = wsiS_reqFifo$D_OUT[43:12] ;
  assign mesgWF_wDataOut$wget = data__h17711 ;
  assign mesgWF_wDataIn$whas = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x__h20948[31:24] != 8'd0 ;
  ...
  assign mesgWF_rCache$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign mesgWF_rWrPtr$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x__h20948 ;
  ...
  assign tog50$EN = CAN_FIRE_RL_operating_actions ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h17711 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h17711 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h17711 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h17711 : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_79_EQ_2_82_THEN_0x0_ELSE_mesgWF_w_ETC___d421 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h17711,
	       (wrtSerPos == 2'd2) ? data__h17711 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h17027 =
		 ...
		 { 8'd0, mesgLengthSoFar_05_PLUS_1___d984 },
	       2'd0 } ;
  assign bytesWritten_6_ULT_dlyHoldoffBytes_6___d902 =
  ...
  assign dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d164 =
	     ...
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_26_SLE_0___d901 =
  ...
  assign x__h15073 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       32'd0 ;
  assign x__h18132 = { 96'd0, data__h17711 } ;
  assign x__h18163 = { 64'd0, data__h17711, wrtSerStage } ;
  ...
  assign x_byteEn__h19977 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x__h20948 = wide16Fc$D_OUT[31:0];
      2'd1: x__h20948 = rdSerStage_1;
      2'd2: x__h20948 = rdSerStage_2;
      2'd3: x__h20948 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
