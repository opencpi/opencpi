...
//
// On Mon Jan 10 17:13:38 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [11 : 0] wmemiM_MBurstLength, wsiM0_MBurstLength;
  wire [7 : 0] wsiM0_MReqInfo;
  wire [3 : 0] wsiM0_MByteEn;
  wire [2 : 0] wmemiM_MCmd, wsiM0_MCmd;
...
`endif
  ...
  reg [63 : 0] v__h23302, v__h3599, v__h3773, v__h3917;
  reg [31 : 0] g_data__h22638, v__h20293;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1;
  wire [127 : 0] IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566,
		 IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_metaWF_f_ETC___d537,
		 x__h18554,
		 x__h18581,
		 x__h19204,
		 x__h19228;
  wire [35 : 0] addr__h19628, addr__h19978;
  wire [31 : 0] data__h18919,
		delayStatus__h22258,
		rdat__h22665,
		rdat__h22671,
		rdat__h22677,
		...
		rdat__h23017,
		x__h15318;
  wire [26 : 0] x__h19686, x__h20023;
  wire [23 : 0] btm__h17807, x__h22687;
  wire [13 : 0] mesgLengthSoFar_82_PLUS_1___d965;
  wire [12 : 0] x__h15419;
  wire [11 : 0] x_burstLength__h22165;
  wire [3 : 0] x_byteEn__h22166;
  wire [1 : 0] wrtSerPos_99_PLUS_1___d964;
  wire IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552,
       NOT_mesgWF_rRdPtr_13_EQ_mesgWF_rWrPtr_04_40___d541,
       NOT_mesgWF_rRdPtr_13_PLUS_2048_69_EQ_mesgWF_rW_ETC___d471,
       NOT_wrtSerPos_99_EQ_3_00_01_AND_NOT_metaWF_fir_ETC___d515,
       bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010,
       cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008,
       dlyWordsStored_value_26_SLE_0_73_OR_bytesWritt_ETC___d581,
       dlyWordsStored_value_26_SLE_0___d1009,
       dlyWordsStored_value_26_SLT_8388608___d583,
       mesgRF_i_notFull__80_AND_NOT_rdSerEmpty_30_31__ETC___d681,
       metaRF_i_notFull__29_AND_NOT_rdSerEmpty_30_31__ETC___d640,
       wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d601,
  ...
  assign WILL_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_13_EQ_mesgWF_rWrPtr_04_40___d541 &&
	     IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552 &&
	     wci_wslv_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h20293[23:0] == 24'd0 ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22638 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_metaWF_f_ETC___d537 or
	  x__h18554 or x__h18581)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18554;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18581;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_metaWF_f_ETC___d537;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566 or
	  x__h19204 or x__h19228)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h19204;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h19228;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19628, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h19978, 12'd1 } ;
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_99_PLUS_1___d964 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_99_PLUS_1___d964 ;
  ...
  assign mesgWF_wDataOut$wget = data__h18919 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h17807 ;
  ...
  assign dlyCtrl$EN =
	     WILL_FIRE_RL_wci_cfwr && wci_wslv_reqF$D_OUT[51:32] == 20'h0 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20293[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_82_PLUS_1___d965 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15318 } ;
  assign mesgWF_rCache$EN = WILL_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15419 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h20293 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18919 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18919 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18919 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h18919 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     WILL_FIRE_RL_wrtSer_body ?
	       x__h15419[11:0] :
	       mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h15318 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d566 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h18919,
	       (wrtSerPos == 2'd2) ? data__h18919 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_metaWF_f_ETC___d537 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgWF_rRdPtr_13_EQ_mesgWF_rWrPtr_04_40___d541 =
	     mesgWF_rRdPtr != mesgWF_rWrPtr ;
  assign NOT_mesgWF_rRdPtr_13_PLUS_2048_69_EQ_mesgWF_rW_ETC___d471 =
	     mesgWF_rRdPtr + 13'd2048 != mesgWF_rWrPtr ;
  assign NOT_wrtSerPos_99_EQ_3_00_01_AND_NOT_metaWF_fir_ETC___d515 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19628 = { 9'd0, x__h19686 } ;
  assign addr__h19978 = { 9'd0, x__h20023 } ;
  assign btm__h17807 =
	     { wsiS_reqFifo$D_OUT[56] ?
		 { 10'd0, wsiS_reqFifo$D_OUT[55:44] } :
		 { 8'd0, mesgLengthSoFar_82_PLUS_1___d965 },
	       2'd0 } ;
  assign bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h18919 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h22258 =
	     { 14'h0,
	       !dlyWordsStored_value_26_SLE_0___d1009 &&
	       !bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010 &&
	       !cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_26_SLE_0_73_OR_bytesWritt_ETC___d581 =
	     dlyWordsStored_value_26_SLE_0___d1009 ||
	     bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010 ||
	     cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_26_SLE_0___d1009 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_26_SLT_8388608___d583 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_82_PLUS_1___d965 = mesgLengthSoFar + 14'd1 ;
  assign mesgRF_i_notFull__80_AND_NOT_rdSerEmpty_30_31__ETC___d681 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_i_notFull__29_AND_NOT_rdSerEmpty_30_31__ETC___d640 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22665 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22671 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22677 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22683 = hasDebugLogic ? { 8'd0, x__h22687 } : 32'd0 ;
  assign rdat__h22807 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22821 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22829 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22835 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22849 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22857 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22863 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22869 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22875 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h22881 =
	     hasDebugLogic ?
  ...
  assign rdat__h22892 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22903 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22914 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22935 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22990 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h22999 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h23008 = { 8'd0, bytesThisMessage } ;
  assign rdat__h23017 = { 18'd0, mesgLengthSoFar } ;
  assign wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d601 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d1009 &&
	     !bytesWritten_95_ULT_dlyHoldoffBytes_74___d1010 &&
	     !cyclesPassed_65_ULT_dlyHoldoffCycles_77___d1008 ;
  assign wrtSerPos_99_PLUS_1___d964 = wrtSerPos + 2'd1 ;
  ...
  assign x__h15318 =
	     WILL_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       32'd0 ;
  assign x__h15419 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18554 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18581 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h19204 = { 96'd0, data__h18919 } ;
  assign x__h19228 = { 64'd0, data__h18919, wrtSerStage } ;
  assign x__h19686 = { dlyWAG, 4'h0 } ;
  assign x__h20023 = { dlyRAG, 4'h0 } ;
  assign x__h22687 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22165 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22166 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h20293 = wide16Fc$D_OUT[31:0];
      2'd1: v__h20293 = rdSerStage_1;
      2'd2: v__h20293 = rdSerStage_2;
      2'd3: v__h20293 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h22935 or
	  delayStatus__h22258 or
	  rdat__h22990 or rdat__h22999 or rdat__h23008 or rdat__h23017)
  begin
    case (wci_wslv_reqF$D_OUT[51:32])
      20'h0: g_data__h22638 = dlyCtrl;
      20'h00004: g_data__h22638 = dlyHoldoffBytes;
      20'h00008: g_data__h22638 = dlyHoldoffCycles;
      20'h0000C: g_data__h22638 = rdat__h22665;
      20'h00010: g_data__h22638 = rdat__h22671;
      20'h00014: g_data__h22638 = rdat__h22677;
      20'h00018: g_data__h22638 = rdat__h22683;
      20'h0001C: g_data__h22638 = 32'd0;
      20'h00020: g_data__h22638 = rdat__h22807;
      20'h00024: g_data__h22638 = rdat__h22821;
      20'h00028: g_data__h22638 = rdat__h22829;
      20'h0002C: g_data__h22638 = rdat__h22835;
      20'h00030: g_data__h22638 = rdat__h22849;
      20'h00034: g_data__h22638 = rdat__h22857;
      20'h00038: g_data__h22638 = rdat__h22863;
      20'h0003C: g_data__h22638 = rdat__h22869;
      20'h00040: g_data__h22638 = rdat__h22875;
      20'h00044: g_data__h22638 = rdat__h22881;
      20'h00048: g_data__h22638 = rdat__h22892;
      20'h0004C: g_data__h22638 = rdat__h22903;
      20'h00050: g_data__h22638 = rdat__h22914;
      20'h00058: g_data__h22638 = dlyRdOpZero;
      20'h0005C: g_data__h22638 = dlyRdOpOther;
      20'h00060: g_data__h22638 = rdat__h22935;
      20'h00064: g_data__h22638 = delayStatus__h22258;
      20'h00068: g_data__h22638 = rdat__h22990;
      20'h0006C: g_data__h22638 = rdat__h22999;
      20'h00070: g_data__h22638 = rdat__h23008;
      20'h00074: g_data__h22638 = rdat__h23017;
      default: g_data__h22638 = 32'd0;
    endcase
  end
