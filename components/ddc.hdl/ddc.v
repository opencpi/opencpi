...
//
// On Thu Jan 19 16:31:52 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h14452, v__h3621, v__h3795, v__h3939;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_63_TO_32_42_EQ__ETC___d509;
  wire [31 : 0] ddcStatus__h13281,
		g_data__h14173,
		rdat___1__h14210,
		rdat___1__h14289,
		rdat___1__h14303,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14173 } ;
  ...
  // remaining internal signals
  assign ddcStatus__h13281 = { 24'd0, x__h14187 } ;
  assign g_data__h14173 =
	     wci_wslv_reqF$D_OUT[44] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_63_TO_32_42_EQ__ETC___d509 ;
  assign rdat___1__h14210 = hasDebugLogic ? { 16'd0, x__h14214 } : 32'd0 ;
  assign rdat___1__h14289 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h14303 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h14311 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h14317 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h14331 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h14339 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h14345 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h14351 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h14357 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign rdat___1__h14363 = hasDebugLogic ? ambaErrCnt : 32'd0 ;
  assign rdat___1__h14369 = hasDebugLogic ? outMesgCnt : 32'd0 ;
  ...
  assign x__h14187 =
	     { ddc_ddc$int_missinput,
	       ...
	       3'b0,
	       hasDebugLogic } ;
  assign x__h14214 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h13153 = { ddc_xkF$D_OUT[15:0], ddc_xkF$D_OUT[31:16] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ddcStatus__h13281 or
	  ddcCtrl or
	  rdat___1__h14210 or
	  rdat___1__h14289 or
	  rdat___1__h14303 or
	  ...
	  rdat___1__h14345 or
	  rdat___1__h14351 or
	  rdat___1__h14357 or rdat___1__h14363 or rdat___1__h14369)
  begin
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting DDC ddcCtrl:%0x", v__h14452, ddcCtrl);
    if (wciS0_MReset_n)
