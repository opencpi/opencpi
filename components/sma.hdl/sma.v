...
//
// On Fri Aug 19 11:38:20 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18191,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h23853;
  wire [55 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d877;
  wire [31 : 0] rdat__h23896,
		rdat__h23902,
		rdat__h23908,
		rdat__h23921,
		rdat__h23944,
		...
		x__h18791;
  wire [23 : 0] b__h17902,
		mesgMetaF_length__h22484,
		residue__h17765,
		x__h18022;
  wire [15 : 0] wsiBurstLength__h18650, x__h23948, x_length__h22884;
  wire [13 : 0] b__h18275, mlB__h22317, mlInc__h22316;
  wire [11 : 0] b__h15090, sendData_burstLength__h18732, x__h16444;
  wire [7 : 0] mesgMetaF_opcode__h22483;
  wire [3 : 0] sendData_byteEn__h18734;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18446 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (WILL_FIRE_RL_wmrd_mesgBodyRequest ? b__h15090 : 12'd0) +
	     (WILL_FIRE_RL_wmrd_mesgResptoWsi ? 12'd1 : 12'd0) ;
  assign MUX_fabWordsRemain$write_1__VAL_1 =
	     (wmi_sFlagReg[23:0] == 24'd0) ? 14'd1 : b__h17902[13:0] ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h23853 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h22483, mesgMetaF_length__h22484 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18446, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h15090 ;
  ...
  assign respF_wDataIn$wget =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       sendData_burstLength__h18732,
	       wmi_respF$D_OUT[31:0],
	       sendData_byteEn__h18734,
	       thisMesg[23:16] } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18275) ? fabWordsRemain : b__h18275 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       ...
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d877 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16444 ;
  ...
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d877 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_75_76_AND_wmi_operate_ETC___d524 =
	     ...
	     (!x__h18446 || wmi_mFlagF_c_r != 2'd2) ;
  assign b__h15090 = -fabWordsCurReq[11:0] ;
  assign b__h17902 = x__h18022 + residue__h17765 ;
  assign b__h18275 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign mesgMetaF_length__h22484 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h22317 } ;
  assign mesgMetaF_opcode__h22483 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h22317 = MUX_mesgLengthSoFar$write_1__VAL_1 ;
  assign mlInc__h22316 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h22523 + y__h22524 } :
	       14'd4 ;
  assign rdat__h23896 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h23902 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h23908 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h23921 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h23944 = hasDebugLogic ? { 16'd0, x__h23948 } : 32'd0 ;
  assign rdat__h24044 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24058 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24066 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24072 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24086 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24094 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24100 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24106 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24112 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24118 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign residue__h17765 =
	     ({ 4'd0, wmi_sFlagReg[1:0] } == 6'd0) ? 24'd0 : 24'd1 ;
  assign sendData_burstLength__h18732 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18650[11:0]) ;
  assign sendData_byteEn__h18734 =
	     (thisMesg[15:0] == 16'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h18791[3:0] : 4'd15) ;
  assign value__h6580 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign x__h16444 = respF_rRdPtr + 12'd1 ;
  assign x__h18022 = { 2'd0, wmi_sFlagReg[23:2] } ;
  assign x__h18446 = fabWordsRemain == fabWordsCurReq ;
  assign x__h18791 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h22523 = x__h22535 + y__h22536 ;
  assign x__h22535 = x__h22547 + y__h22548 ;
  assign x__h22547 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h23948 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h22884 = { 2'd0, mlB__h22317 } ;
  assign y__h22524 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22536 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22548 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24086 or
	  rdat__h24094 or
	  rdat__h24100 or rdat__h24106 or rdat__h24112 or rdat__h24118)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h23853 = smaCtrl;
      8'h04: g_data__h23853 = rdat__h23896;
      8'h08: g_data__h23853 = rdat__h23902;
      8'h10: g_data__h23853 = rdat__h23908;
      8'h14: g_data__h23853 = rdat__h23921;
      8'h18: g_data__h23853 = rdat__h23944;
      8'h20: g_data__h23853 = rdat__h24044;
      8'h24: g_data__h23853 = rdat__h24058;
      8'h28: g_data__h23853 = rdat__h24066;
      8'h2C: g_data__h23853 = rdat__h24072;
      8'h30: g_data__h23853 = rdat__h24086;
      8'h34: g_data__h23853 = rdat__h24094;
      8'h38: g_data__h23853 = rdat__h24100;
      8'h3C: g_data__h23853 = rdat__h24106;
      8'h40: g_data__h23853 = rdat__h24112;
      8'h44: g_data__h23853 = rdat__h24118;
      default: g_data__h23853 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23304);
    if (wciS0_MReset_n)
