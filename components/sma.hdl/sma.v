...
//
// On Wed Oct 24 10:25:47 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h18699,
	       ...
	       v__h3904,
	       v__h4048;
  reg [31 : 0] g_data__h24376;
  wire [55 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d879;
  wire [31 : 0] rdat__h24419,
		rdat__h24425,
		rdat__h24431,
		rdat__h24444,
		rdat__h24467,
		...
		x__h19302;
  wire [23 : 0] b__h18410,
		mesgMetaF_length__h22999,
		residue__h18273,
		x__h18530;
  wire [15 : 0] wsiBurstLength__h19161, x__h24471, x_length__h23399;
  wire [13 : 0] b__h18783, mlB__h22832, mlInc__h22831;
  wire [11 : 0] b__h15473, sendData_burstLength__h19243, x__h16878;
  wire [7 : 0] mesgMetaF_opcode__h22998;
  wire [3 : 0] sendData_byteEn__h19245;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d878,
	       x__h23038,
	       x__h23050,
	       x__h23062,
	       y__h23039,
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22998, x_length__h23399 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24376 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h22998, mesgMetaF_length__h22999 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       ...
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d879 } ;
  ...
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d879 =
  ...
  assign mesgMetaF_length__h22999 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h22832 } ;
  assign mesgMetaF_opcode__h22998 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h22832 = MUX_mesgLengthSoFar$write_1__VAL_1 ;
  assign mlInc__h22831 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23038 + y__h23039 } :
	       14'd4 ;
  assign rdat__h24419 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24425 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24431 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24444 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24467 = hasDebugLogic ? { 16'd0, x__h24471 } : 32'd0 ;
  assign rdat__h24567 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24581 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24589 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24595 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24609 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24617 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24623 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24629 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24635 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24641 = hasDebugLogic ? { 31'd0, x__h24645 } : 32'd0 ;
  assign rdat__h24651 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h23038 = x__h23050 + y__h23051 ;
  assign x__h23050 = x__h23062 + y__h23063 ;
  assign x__h23062 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h24471 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24645 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23399 = { 2'd0, mlB__h22832 } ;
  assign y__h23039 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23051 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23063 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24617 or
	  rdat__h24623 or
	  rdat__h24629 or rdat__h24635 or rdat__h24641 or rdat__h24651)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24376 = smaCtrl;
      8'h04: g_data__h24376 = rdat__h24419;
      8'h08: g_data__h24376 = rdat__h24425;
      8'h10: g_data__h24376 = rdat__h24431;
      8'h14: g_data__h24376 = rdat__h24444;
      8'h18: g_data__h24376 = rdat__h24467;
      8'h20: g_data__h24376 = rdat__h24567;
      8'h24: g_data__h24376 = rdat__h24581;
      8'h28: g_data__h24376 = rdat__h24589;
      8'h2C: g_data__h24376 = rdat__h24595;
      8'h30: g_data__h24376 = rdat__h24609;
      8'h34: g_data__h24376 = rdat__h24617;
      8'h38: g_data__h24376 = rdat__h24623;
      8'h3C: g_data__h24376 = rdat__h24629;
      8'h40: g_data__h24376 = rdat__h24635;
      8'h44: g_data__h24376 = rdat__h24641;
      8'h48: g_data__h24376 = rdat__h24651;
      default: g_data__h24376 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23825);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
