...
//
// On Fri Jul 30 15:10:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h15871,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6077, x_data__h16004;
  wire [31 : 0] rdat__h16041,
		rdat__h16048,
		rdat__h16055,
		rdat__h16078,
		rdat__h16101,
		...
		rdat__h16243,
		rdat__h16251;
  wire [23 : 0] mesgMetaF_length__h17560, mesgMetaF_length__h18602;
  wire [15 : 0] wsiBurstLength__h19330, x__h16105, x_length__h17837;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d793,
		addr__h17407,
		b__h19951,
		mlp1B__h17391,
		mlp1__h17390;
  wire [11 : 0] bl__h18459, x_burstLength__h19426;
  wire [7 : 0] mesgMetaF_opcode__h17559;
  wire [3 : 0] b__h14493, x_byteEn__h19428;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d405,
       x__h19751;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306 &&
	     wci_cState == 3'd2 &&
  ...
  assign CAN_FIRE_RL_wmwt_mesgBegin =
	     ...
	     !wmi_sDataThreadBusy_d &&
	     !opcode[8] ;
  assign WILL_FIRE_RL_wmwt_mesgBegin = MUX_opcode$write_1__SEL_2 ;

  // rule RL_wmwt_doAbort
  assign CAN_FIRE_RL_wmwt_doAbort = MUX_opcode$write_1__SEL_1 ;
  assign WILL_FIRE_RL_wmwt_doAbort = MUX_opcode$write_1__SEL_1 ;
  ...
  // rule RL_wmi_dhF_deq
  assign CAN_FIRE_RL_wmi_dhF_deq =
  ...
  assign CAN_FIRE_RL_wmi_reqF_deq =
  ...
  assign CAN_FIRE_RL_wmi_dhF_both =
	     ((wmi_dhF_c_r == 2'd1) ?
		wmi_dhF_x_wire$whas :
		wmi_dhF_c_r != 2'd2 || wmi_dhF_x_wire$whas) &&
	     wmi_dhF_dequeueing$whas &&
	     MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_1 ;
  ...
  assign CAN_FIRE_RL_wmi_dhF_incCtr =
	     ((wmi_dhF_c_r == 2'd0) ?
		wmi_dhF_x_wire$whas :
		wmi_dhF_c_r != 2'd1 || wmi_dhF_x_wire$whas) &&
	     MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_1 &&
	     !wmi_dhF_dequeueing$whas ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19426,
	       wmi_respF$D_OUT[31:0],
	       x_byteEn__h19428,
	       thisMesg[23:16] } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h16004 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19751 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14493 : 4'd0) +
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17391 } ;
  assign MUX_mesgReqAddr$write_1__VAL_2 =
	     mesgReqAddr + { fabWordsCurReq[11:0], 2'd0 } ;
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17559, x_length__h17837 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17559, mesgMetaF_length__h17560 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17559, mesgMetaF_length__h18602 } ;
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6077 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6077 : 32'd0 ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19751, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18459 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17407, 12'd1 } ;
  ...
  assign wmi_mFlagF_x_wire$wget = value__h6077 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14493 ;
  ...
  assign abortCount$EN = MUX_opcode$write_1__SEL_1 ;

  // register doAbort
  assign doAbort$D_IN = 1'd0 ;
  assign doAbort$EN = MUX_opcode$write_1__SEL_1 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19951) ? fabWordsRemain : b__h19951 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17390 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6077 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6077;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6077 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6077;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d793 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19751 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17407 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14493 = -fabWordsCurReq[3:0] ;
  assign b__h19951 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18459 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d793[13:2] ;
  assign mesgMetaF_length__h17560 = { 10'd0, mlp1B__h17391 } ;
  assign mesgMetaF_length__h18602 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d793 } ;
  assign mesgMetaF_opcode__h17559 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17391 = { mlp1__h17390[11:0], 2'd0 } ;
  assign mlp1__h17390 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h16041 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h16048 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h16055 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h16078 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h16101 = hasDebugLogic ? { 16'd0, x__h16105 } : 32'd0 ;
  assign rdat__h16201 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16215 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16223 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16229 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16243 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16251 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wsiBurstLength__h19330 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[57] || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d405 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h16105 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19751 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19426 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19330[11:0]) ;
  assign x_byteEn__h19428 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x_length__h17837 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d793 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16201 or
	  rdat__h16215 or
	  rdat__h16223 or rdat__h16229 or rdat__h16243 or rdat__h16251)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h16004 = smaCtrl;
      8'h04: x_data__h16004 = rdat__h16041;
      8'h08: x_data__h16004 = rdat__h16048;
      8'h10: x_data__h16004 = rdat__h16055;
      8'h14: x_data__h16004 = rdat__h16078;
      8'h18: x_data__h16004 = rdat__h16101;
      8'h20: x_data__h16004 = rdat__h16201;
      8'h24: x_data__h16004 = rdat__h16215;
      8'h28: x_data__h16004 = rdat__h16223;
      8'h2C: x_data__h16004 = rdat__h16229;
      8'h30: x_data__h16004 = rdat__h16243;
      8'h34: x_data__h16004 = rdat__h16251;
      default: x_data__h16004 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6077 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_1;
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_2:
	  value__h6077 = 32'hAAAAAAAA /* unspecified value */ ;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6077 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6077 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17052);
    if (wciS0_MReset_n)
