...
//
// On Tue Mar 22 13:32:11 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  // register wmwtPImpCount
  reg [31 : 0] wmwtPImpCount;
  wire [31 : 0] wmwtPImpCount$D_IN;
  wire wmwtPImpCount$EN;
  ...
  wire MUX_endOfMessage$write_1__SEL_1,
       ...
       MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_2,
  ...
  reg [63 : 0] v__h18505,
	       ...
	       v__h3824,
	       v__h3968;
  reg [31 : 0] g_data__h22692, value__h6626;
  wire [55 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d850;
  wire [31 : 0] rdat__h22735,
		rdat__h22741,
		rdat__h22747,
		rdat__h22760,
		rdat__h22783,
		...
		rdat__h22951,
		rdat__h22957;
  wire [23 : 0] mesgMetaF_length__h20463, mesgMetaF_length__h21223;
  wire [15 : 0] wsiBurstLength__h18967, x__h22787, x_length__h20218;
  wire [13 : 0] addr__h21093,
		b__h18589,
		mlp1B__h21053,
		mlp1__h21052,
		x__h20236;
  wire [11 : 0] b__h15200,
		bl__h20325,
		sendData_burstLength__h19049,
		x__h16554;
  wire [7 : 0] x__h20222;
  wire [3 : 0] sendData_byteEn__h19051;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d848;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d701,
       wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d628,
       wmi_respF_i_notEmpty__41_AND_smaCtrl_77_BIT_4__ETC___d546,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d647,
       wsiS_reqFifo_notFull__79_AND_wsiS_burstKind_94_ETC___d401,
       x__h18760;
  ...
  assign WILL_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529 &&
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) &&
	     mesgPreRequest ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18760 ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_2 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ||
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__SEL_2 =
	     MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_2 && smaCtrl[3:0] == 4'h3 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (WILL_FIRE_RL_wmrd_mesgBodyRequest ? b__h15200 : 12'd0) +
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h21053 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h20222, x_length__h20218 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22692 } ;
  ...
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6626 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6626 : 32'd0 ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h20222, mesgMetaF_length__h21223 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h20222, mesgMetaF_length__h20463 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18760, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h20325 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h21093, 12'd1 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h15200 ;
  ...
  assign wmi_mFlagF_dequeueing$whas =
	     ...
	     wmi_mFlagF_c_r != 2'd0 ;
  assign wmi_dhF_enqueueing$whas = MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_2 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18589) ? fabWordsRemain : b__h18589 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d848,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d850 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16554 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6626 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6626;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6626 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6626;
  ...
  // register wmwtPImpCount
  assign wmwtPImpCount$D_IN = wmwtPImpCount + 32'd1 ;
  assign wmwtPImpCount$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d848 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d850 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[55:0] : 56'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h18760 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h21093 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h15200 = -fabWordsCurReq[11:0] ;
  assign b__h18589 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20325 = zeroLengthMesg ? 12'd1 : x__h20236[13:2] ;
  assign mesgMetaF_length__h20463 = { 10'd0, x__h20236 } ;
  assign mesgMetaF_length__h21223 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h21053 } ;
  assign mlp1B__h21053 = { mlp1__h21052[11:0], 2'd0 } ;
  assign mlp1__h21052 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h22735 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22741 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22747 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22760 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22783 = hasDebugLogic ? { 16'd0, x__h22787 } : 32'd0 ;
  assign rdat__h22883 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22897 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22905 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22911 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22925 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22933 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22939 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22945 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22951 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22957 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign sendData_burstLength__h19049 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18967[11:0]) ;
  assign sendData_byteEn__h19051 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d701 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d628 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wmi_respF_i_notEmpty__41_AND_smaCtrl_77_BIT_4__ETC___d546 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h18967 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d647 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[57] || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__79_AND_wsiS_burstKind_94_ETC___d401 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h16554 = respF_rRdPtr + 12'd1 ;
  assign x__h18760 = fabWordsRemain == fabWordsCurReq ;
  assign x__h20222 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h20236 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22787 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h20218 = { 2'd0, x__h20236 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22925 or
	  rdat__h22933 or
	  rdat__h22939 or rdat__h22945 or rdat__h22951 or rdat__h22957)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22692 = smaCtrl;
      8'h04: g_data__h22692 = rdat__h22735;
      8'h08: g_data__h22692 = rdat__h22741;
      8'h10: g_data__h22692 = rdat__h22747;
      8'h14: g_data__h22692 = rdat__h22760;
      8'h18: g_data__h22692 = rdat__h22783;
      8'h20: g_data__h22692 = rdat__h22883;
      8'h24: g_data__h22692 = rdat__h22897;
      8'h28: g_data__h22692 = rdat__h22905;
      8'h2C: g_data__h22692 = rdat__h22911;
      8'h30: g_data__h22692 = rdat__h22925;
      8'h34: g_data__h22692 = rdat__h22933;
      8'h38: g_data__h22692 = rdat__h22939;
      8'h3C: g_data__h22692 = rdat__h22945;
      8'h40: g_data__h22692 = rdat__h22951;
      8'h44: g_data__h22692 = rdat__h22957;
      default: g_data__h22692 = 32'd0;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_1:
	  value__h6626 = 32'hAAAAAAAA /* unspecified value */ ;
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6626 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_2;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6626 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6626 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
	...
	wmwtPImpCount <= `BSV_ASSIGNMENT_DELAY 32'd0;
	...
	if (wmwtPImpCount$EN)
	  wmwtPImpCount <= `BSV_ASSIGNMENT_DELAY wmwtPImpCount$D_IN;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h21991);
    if (wciS0_MReset_n)
