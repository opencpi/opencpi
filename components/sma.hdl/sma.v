...
//
// On Tue Aug 17 11:58:41 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire [31 : 0] rdat__h16041,
		...
		rdat__h16251,
		x_byteEn__h19430;
  wire [23 : 0] mesgMetaF_length__h17560, mesgMetaF_length__h18603;
  wire [15 : 0] wsiBurstLength__h19332, x__h16105, x_length__h17837;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788,
		addr__h17407,
		b__h19953,
		mlp1B__h17391,
		mlp1__h17390;
  wire [11 : 0] bl__h18459, x_burstLength__h19428;
  wire [7 : 0] mesgMetaF_opcode__h17559;
  wire [3 : 0] b__h14493;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d408,
       x__h19753;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 &&
	     wci_cState == 3'd2 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16004 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17407, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19753, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19428,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19753 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17559, mesgMetaF_length__h18603 } ;
  ...
  assign wmi_operateD_1$whas = wci_cState == 3'd2 ;
  ...
  assign abortCount$EN = CAN_FIRE_RL_wmwt_doAbort ;
  ...
  assign errCount$EN =
	     ...
	     (!wsiS_reqFifo$D_OUT[309] || wsiS_reqFifo$D_OUT[39:8] != 32'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19953) ? fabWordsRemain : b__h19953 ;
  ...
  // register wmi_operateD
  assign wmi_operateD$D_IN = wci_cState == 3'd2 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19753 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17407 = { mesgLengthSoFar[8:0], 5'd0 } ;
  assign b__h14493 = -fabWordsCurReq[3:0] ;
  assign b__h19953 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18459 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788[13:5] } ;
  assign mesgMetaF_length__h17560 = { 10'd0, mlp1B__h17391 } ;
  assign mesgMetaF_length__h18603 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788 } ;
  assign mesgMetaF_opcode__h17559 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17391 = { mlp1__h17390[8:0], 5'd0 } ;
  ...
  assign wsiBurstLength__h19332 =
	     smaCtrl[5] ? 16'd2 : { 5'd0, thisMesg[15:5] } ;
  assign wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[309] || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d408 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[309]) ;
  assign x__h16105 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19753 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19428 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19332[11:0]) ;
  assign x_byteEn__h19430 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
