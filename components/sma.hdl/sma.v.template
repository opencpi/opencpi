...
//
// On Sun Jun 27 11:43:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h15304,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6066, x_data__h15437;
  wire [31 : 0] rdat__h15474,
		rdat__h15481,
		rdat__h15488,
		rdat__h15511,
		rdat__h15534,
		...
		rdat__h15676,
		rdat__h15684;
  wire [23 : 0] mesgMetaF_length__h16962, mesgMetaF_length__h17985;
  wire [15 : 0] wsiBurstLength__h18713, x__h15538, x_length__h17239;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d764,
		addr__h16809,
		b__h19334,
		mlp1B__h16793,
		mlp1__h16792;
  wire [11 : 0] bl__h17842, x_burstLength__h18809;
  wire [7 : 0] mesgMetaF_opcode__h16961;
  wire [3 : 0] b__h13926, x_byteEn__h18811;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306,
       NOT_wsiS_reqFifo_countReg_68_ULE_1_69___d370,
       wmi_operateD_64_AND_wmi_peerIsReady_65_66_AND__ETC___d180,
       wsiS_reqFifo_i_notEmpty__63_AND_wmi_operateD_6_ETC___d221,
       x__h19134;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h16793 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15437 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19134 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h13926 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h16961, x_length__h17239 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h16961, mesgMetaF_length__h16962 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16961, mesgMetaF_length__h17985 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h17842 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19134, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h16809, 12'd1 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h13926 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19334) ? fabWordsRemain : b__h19334 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d764 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306 =
	     ...
	     (!x__h19134 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_68_ULE_1_69___d370 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16809 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h13926 = -fabWordsCurReq[3:0] ;
  assign b__h19334 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17842 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d764[13:2] ;
  assign mesgMetaF_length__h16962 = { 10'd0, mlp1B__h16793 } ;
  assign mesgMetaF_length__h17985 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d764 } ;
  assign mesgMetaF_opcode__h16961 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16793 = { mlp1__h16792[11:0], 2'd0 } ;
  assign mlp1__h16792 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h15474 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h15481 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h15488 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h15511 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h15534 = hasDebugLogic ? { 16'd0, x__h15538 } : 32'd0 ;
  assign rdat__h15634 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15648 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15656 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15662 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15676 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15684 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wmi_operateD_64_AND_wmi_peerIsReady_65_66_AND__ETC___d180 =
	     wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[57] || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiBurstLength__h18713 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign wsiS_reqFifo_i_notEmpty__63_AND_wmi_operateD_6_ETC___d221 =
	     wsiS_reqFifo$EMPTY_N && wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign x__h15538 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19134 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18809 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18713[11:0]) ;
  assign x_byteEn__h18811 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x_length__h17239 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d764 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h15634 or
	  rdat__h15648 or
	  rdat__h15656 or rdat__h15662 or rdat__h15676 or rdat__h15684)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15437 = smaCtrl;
      8'h04: x_data__h15437 = rdat__h15474;
      8'h08: x_data__h15437 = rdat__h15481;
      8'h10: x_data__h15437 = rdat__h15488;
      8'h14: x_data__h15437 = rdat__h15511;
      8'h18: x_data__h15437 = rdat__h15534;
      8'h20: x_data__h15437 = rdat__h15634;
      8'h24: x_data__h15437 = rdat__h15648;
      8'h28: x_data__h15437 = rdat__h15656;
      8'h2C: x_data__h15437 = rdat__h15662;
      8'h30: x_data__h15437 = rdat__h15676;
      8'h34: x_data__h15437 = rdat__h15684;
      default: x_data__h15437 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16485);
    if (wciS0_MReset_n)
