...
//
// On Fri Dec 17 10:00:06 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h10808, v__h3562, v__h3747, v__h3902;
  reg [31 : 0] x_data__h10516;
  wire [31 : 0] frameGateStatus__h10126,
		rdat__h10556,
		rdat__h10656,
		rdat__h10670,
		rdat__h10678,
		...
		x__h9904;
  wire [15 : 0] x__h10560;
  wire NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d508,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h10516 } ;
  ...
  assign wsiS_reqFifo_doResetEnq$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign wsiS_reqFifo_doResetDeq$whas = CAN_FIRE_RL_wsipass_doMessagePush ;
  ...
  assign byteCount$D_IN =
	     NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d508 ?
	       32'd4 :
	       x__h9904 ;
  ...
  // remaining internal signals
  assign NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d508 =
	     !gated && byteCount == frameSize ||
	     gated && byteCount == gateSize ;
  assign frameGateStatus__h10126 = { 31'd0, hasDebugLogic } ;
  assign rdat__h10556 = hasDebugLogic ? { 16'd0, x__h10560 } : 32'd0 ;
  assign rdat__h10656 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10670 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10678 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10684 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10698 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10706 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10712 = hasDebugLogic ? op0MesgCnt : 32'd0 ;
  assign rdat__h10723 = hasDebugLogic ? otherMesgCnt : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__69_AND_wsiS_burstKind_84_ETC___d191 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h10560 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h9904 = byteCount + 32'd4 ;
  always@(wci_reqF$D_OUT or
	  frameGateStatus__h10126 or
	  frameGateCtrl or
	  frameSize or
	  gateSize or
	  rdat__h10556 or
	  ...
	  rdat__h10678 or
	  rdat__h10684 or
	  rdat__h10698 or rdat__h10706 or rdat__h10712 or rdat__h10723)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h10516 = frameGateStatus__h10126;
      20'h00004: x_data__h10516 = frameGateCtrl;
      20'h00008: x_data__h10516 = frameSize;
      20'h0000C: x_data__h10516 = gateSize;
      20'h00010: x_data__h10516 = rdat__h10556;
      20'h00014: x_data__h10516 = rdat__h10656;
      20'h00018: x_data__h10516 = rdat__h10670;
      20'h0001C: x_data__h10516 = rdat__h10678;
      20'h00020: x_data__h10516 = rdat__h10684;
      20'h00024: x_data__h10516 = rdat__h10698;
      20'h00028: x_data__h10516 = rdat__h10706;
      20'h0002C: x_data__h10516 = rdat__h10712;
      20'h00030: x_data__h10516 = rdat__h10723;
      default: x_data__h10516 = 32'd0;
    endcase
  end
