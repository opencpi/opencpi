...
//
// On Sun Jun 27 07:13:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire [31 : 0] frameGateStatus__h9658,
		...
		x__h9407;
  wire [15 : 0] x__h9940;
  wire NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d430,
  ...
  assign byteCount$D_IN =
	     NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d430 ?
	       32'd4 :
	       x__h9407 ;
  ...
  // remaining internal signals
  assign NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d430 =
  ...
  assign wsiS_reqFifo_i_notEmpty__22_AND_NOT_frameGateC_ETC___d135 =
	     ...
	     (frameGateCtrl[3:0] != 4'h0 &&
	      (frameGateCtrl[3:0] != 4'h1 || gated) ||
	      wsiM_reqFifo_c_r != 2'd2) ;
  assign x__h9407 = byteCount + 32'd4 ;
