...
//
// On Sat Jan 15 12:08:59 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h10764, v__h3560, v__h3734, v__h3878;
  reg [31 : 0] g_data__h10478;
  wire [31 : 0] frameGateStatus__h10102,
		rdat__h10512,
		rdat__h10612,
		rdat__h10626,
		rdat__h10634,
		...
		x__h9880;
  wire [15 : 0] x__h10516;
  wire NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d455,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h10478 } ;
  ...
  assign byteCount$D_IN =
	     NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d455 ?
	       32'd4 :
	       x__h9880 ;
  ...
  // remaining internal signals
  assign NOT_gated_05_11_AND_byteCount_12_EQ_frameSize__ETC___d455 =
	     !gated && byteCount == frameSize ||
	     gated && byteCount == gateSize ;
  assign frameGateStatus__h10102 = { 31'd0, hasDebugLogic } ;
  assign rdat__h10512 = hasDebugLogic ? { 16'd0, x__h10516 } : 32'd0 ;
  assign rdat__h10612 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10626 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10634 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10640 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10654 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10662 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10668 = hasDebugLogic ? op0MesgCnt : 32'd0 ;
  assign rdat__h10679 = hasDebugLogic ? otherMesgCnt : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__69_AND_wsiS_burstKind_84_ETC___d191 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h10516 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h9880 = byteCount + 32'd4 ;
  always@(wci_reqF$D_OUT or
	  frameGateStatus__h10102 or
	  frameGateCtrl or
	  frameSize or
	  gateSize or
	  rdat__h10512 or
	  ...
	  rdat__h10634 or
	  rdat__h10640 or
	  rdat__h10654 or rdat__h10662 or rdat__h10668 or rdat__h10679)
  begin
    case (wci_reqF$D_OUT[63:32])
      32'h0: g_data__h10478 = frameGateStatus__h10102;
      32'h00000004: g_data__h10478 = frameGateCtrl;
      32'h00000008: g_data__h10478 = frameSize;
      32'h0000000C: g_data__h10478 = gateSize;
      32'h00000010: g_data__h10478 = rdat__h10512;
      32'h00000014: g_data__h10478 = rdat__h10612;
      32'h00000018: g_data__h10478 = rdat__h10626;
      32'h0000001C: g_data__h10478 = rdat__h10634;
      32'h00000020: g_data__h10478 = rdat__h10640;
      32'h00000024: g_data__h10478 = rdat__h10654;
      32'h00000028: g_data__h10478 = rdat__h10662;
      32'h0000002C: g_data__h10478 = rdat__h10668;
      32'h00000030: g_data__h10478 = rdat__h10679;
      default: g_data__h10478 = 32'd0;
    endcase
  end
