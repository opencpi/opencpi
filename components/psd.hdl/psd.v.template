...
//
// On Sun Jun 27 18:31:10 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h13697, v__h2625, v__h2772, v__h3671;
  reg [31 : 0] x_data__h13829;
  wire [31 : 0] psdStatus__h13574,
		rdat__h13853,
		rdat__h13953,
		rdat__h13967,
		rdat__h13975,
		...
		x_data__h12641,
		x_data__h7453;
  wire [15 : 0] IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139,
		IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d613,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d134,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d136,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d610,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d611,
		dReal__h12772,
		fft_xkFD_OUT_BITS_15_TO_0__q2,
		fft_xkFD_OUT_BITS_31_TO_16__q1,
		result__h12840,
		w2p_wordsExact_17_MINUS_1___d612,
		x__h12811,
		x__h13857;
  wire [12 : 0] x__h6923;
  wire NOT_w2p_dataF_rRdPtr_00_PLUS_2048_28_EQ_w2p_da_ETC___d338,
       NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d377,
       w2p_wordsDequed_16_EQ_w2p_wordsExact_17_MINUS__ETC___d573,
       w2p_wordsEnqued_32_EQ_w2p_wordsExact_17_MINUS__ETC___d647;
  ...
  // submodule fft_xkF
  FIFO2 #(.width(32'd33), .guarded(32'd1)) fft_xkF(.RST_N(wciS0_MReset_n),
						   .CLK(wciS0_Clk),
						   .D_IN(fft_xkF$D_IN),
						   .ENQ(fft_xkF$ENQ),
						   .DEQ(fft_xkF$DEQ),
  ...
  // submodule fft_xnF
  FIFO2 #(.width(32'd33), .guarded(32'd1)) fft_xnF(.RST_N(wciS0_MReset_n),
						   .CLK(wciS0_Clk),
						   .D_IN(fft_xnF$D_IN),
						   .ENQ(fft_xnF$ENQ),
						   .DEQ(fft_xnF$DEQ),
  ...
  assign CAN_FIRE_RL_psdFFT_doEgress =
	     fft_xkF$EMPTY_N &&
	     (!fft_xkF$D_OUT[32] || sendEven || wsiM_reqFifo_c_r != 2'd2) &&
	     wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h2 ;
  ...
  assign CAN_FIRE_RL_fft_fft_stream_ingress =
	     fft_xnF$EMPTY_N && fft_fft$rfd && fft_xnF$D_OUT[32] ;
  ...
  assign CAN_FIRE_RL_w2p_imprecise_enq =
	     NOT_w2p_dataF_rRdPtr_00_PLUS_2048_28_EQ_w2p_da_ETC___d338 &&
	     wci_cState == 3'd2 ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_psdFFT_doEgress && fft_xkF$D_OUT[32] && !sendEven ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13829 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h7453 ;
  ...
  assign fft_start_w$whas = CAN_FIRE_RL_fft_fft_stream_ingress ;
  ...
  assign evenMag$D_IN =
	     IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d613 -
	     IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139 ;
  ...
  // register w2p_dataF_rCache
  assign w2p_dataF_rCache$D_IN = { 1'd1, w2p_dataF_rWrPtr, x__h7031 } ;
  assign w2p_dataF_rCache$EN = CAN_FIRE_RL_w2p_imprecise_enq ;

  // register w2p_dataF_rRdPtr
  assign w2p_dataF_rRdPtr$D_IN = x__h6923 ;
  ...
  assign fft_fft$start = CAN_FIRE_RL_fft_fft_stream_ingress ;
  ...
  // submodule fft_xkF
  assign fft_xkF$D_IN = { 1'd1, fft_fft$xk_re, fft_fft$xk_im } ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { 1'd1, x__h12811, 16'd0 } ;
  ...
  assign w2p_dataF_memory$DIA = x__h7031 ;
  ...
  // remaining internal signals
  assign IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139 =
	     IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d613 /
	     16'd16 ;
  assign IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d613 =
	     (IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d610 <=
	      IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d611) ?
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d134 +
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d611 :
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d610 +
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d136 ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d134 =
	     IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d610 /
	     16'd2 ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d136 =
	     IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d611 /
	     16'd2 ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d610 =
	     fft_xkFD_OUT_BITS_31_TO_16__q1[15] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d611 =
	     fft_xkFD_OUT_BITS_15_TO_0__q2[15] ?
	       -fft_xkF$D_OUT[15:0] :
	       fft_xkF$D_OUT[15:0] ;
  assign NOT_w2p_dataF_rRdPtr_00_PLUS_2048_28_EQ_w2p_da_ETC___d338 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (!w2p_wordsEnqued_32_EQ_w2p_wordsExact_17_MINUS__ETC___d647 ||
	      w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d377 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign dReal__h12772 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign fft_xkFD_OUT_BITS_15_TO_0__q2 = fft_xkF$D_OUT[15:0] ;
  assign fft_xkFD_OUT_BITS_31_TO_16__q1 = fft_xkF$D_OUT[31:16] ;
  assign psdStatus__h13574 = { 31'd0, hasDebugLogic } ;
  assign rdat__h13853 = hasDebugLogic ? { 16'd0, x__h13857 } : 32'd0 ;
  assign rdat__h13953 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13967 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13975 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h13981 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13995 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h14003 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign result__h12840 = { ~dReal__h12772[15], dReal__h12772[14:0] } ;
  assign w2p_wordsDequed_16_EQ_w2p_wordsExact_17_MINUS__ETC___d573 =
	     w2p_wordsDequed == w2p_wordsExact_17_MINUS_1___d612 ;
  assign w2p_wordsEnqued_32_EQ_w2p_wordsExact_17_MINUS__ETC___d647 =
	     w2p_wordsEnqued == w2p_wordsExact_17_MINUS_1___d612 ;
  assign w2p_wordsExact_17_MINUS_1___d612 = w2p_wordsExact - 16'd1 ;
  assign x__h12811 = psdCtrl[4] ? result__h12840 : dReal__h12772 ;
  assign x__h13857 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h6923 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7031 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h12641 =
	     { IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d613 -
	       IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139,
	       evenMag } ;
  assign x_data__h7453 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h13574 or
	  psdCtrl or
	  rdat__h13853 or
	  rdat__h13953 or
	  rdat__h13967 or
	  rdat__h13975 or rdat__h13981 or rdat__h13995 or rdat__h14003)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h13829 = psdStatus__h13574;
      20'h00004: x_data__h13829 = psdCtrl;
      20'h00010: x_data__h13829 = rdat__h13853;
      20'h00014: x_data__h13829 = rdat__h13953;
      20'h00018: x_data__h13829 = rdat__h13967;
      20'h0001C: x_data__h13829 = rdat__h13975;
      20'h00020: x_data__h13829 = rdat__h13981;
      20'h00024: x_data__h13829 = rdat__h13995;
      20'h00028: x_data__h13829 = rdat__h14003;
      default: x_data__h13829 = 32'd0;
    endcase
  end
