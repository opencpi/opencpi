...
//
// On Sat Jan 15 12:09:43 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h15294, v__h3554, v__h3728, v__h3872;
  reg [31 : 0] g_data__h15032;
  wire [31 : 0] psdStatus__h14730,
		rdat__h15056,
		rdat__h15156,
		rdat__h15170,
		rdat__h15178,
		...
		x_data__h14601,
		x_data__h8545,
		x_fftFrameCounts__h13130;
  wire [15 : 0] IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648,
		IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d645,
		IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d646,
		dReal__h14120,
		result__h14187,
		w2p_wordsExact_66_MINUS_1___d647,
		x__h14152,
		x__h15060;
  wire [12 : 0] x__h7850;
  wire NOT_w2p_dataF_rRdPtr_48_EQ_w2p_dataF_rWrPtr_39_ETC___d290,
       NOT_w2p_dataF_rRdPtr_48_PLUS_2048_61_EQ_w2p_da_ETC___d273,
       w2p_wordsDequed_94_EQ_w2p_wordsExact_66_MINUS__ETC___d604,
       w2p_wordsEnqued_65_EQ_w2p_wordsExact_66_MINUS__ETC___d683,
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15032 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h8545 ;
  ...
  assign w2p_dataF_pwDequeue$whas =
	     NOT_w2p_dataF_rRdPtr_48_EQ_w2p_dataF_rWrPtr_39_ETC___d290 &&
	     wci_wslv_cState == 3'd2 &&
	     w2p_reqF$EMPTY_N ;
  ...
  // register evenMag
  assign evenMag$D_IN =
	     IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648 -
	     (IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648 >>
	      4) ;
  ...
  // register w2p_dataF_rCache
  assign w2p_dataF_rCache$D_IN = { 1'd1, w2p_dataF_rWrPtr, x__h7749 } ;
  assign w2p_dataF_rCache$EN = w2p_dataF_pwEnqueue$whas ;

  // register w2p_dataF_rRdPtr
  assign w2p_dataF_rRdPtr$D_IN = x__h7850 ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { x__h14152, 16'd0 } ;
  assign fft_xnF$ENQ =
	     fft_xnF$FULL_N && xnF$EMPTY_N && wci_wslv_cState == 3'd2 &&
	     psdCtrl[1:0] == 2'd2 ;
  ...
  assign w2p_dataF_memory$DIA = x__h7749 ;
  ...
  // remaining internal signals
  assign IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648 =
	     (IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d646 <=
	      IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d645) ?
	       (IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d646 >>
		1) +
	       ...
	       (IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d645 >>
		1) ;
  assign IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d645 =
	     fft_xkF$D_OUT[15] ? -fft_xkF$D_OUT[15:0] : fft_xkF$D_OUT[15:0] ;
  assign IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d646 =
	     fft_xkF$D_OUT[31] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  assign NOT_w2p_dataF_rRdPtr_48_EQ_w2p_dataF_rWrPtr_39_ETC___d290 =
	     w2p_dataF_rRdPtr != w2p_dataF_rWrPtr && w2p_outF$FULL_N &&
	     w2p_reqF$EMPTY_N ;
  assign NOT_w2p_dataF_rRdPtr_48_PLUS_2048_61_EQ_w2p_da_ETC___d273 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (!w2p_wordsEnqued_65_EQ_w2p_wordsExact_66_MINUS__ETC___d683 ||
	      w2p_reqF$FULL_N) ;
  assign dReal__h14120 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign psdStatus__h14730 = { 31'd0, hasDebugLogic } ;
  assign rdat__h15056 = hasDebugLogic ? { 16'd0, x__h15060 } : 32'd0 ;
  assign rdat__h15156 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15170 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15178 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15184 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15198 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15206 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15212 = hasDebugLogic ? x_fftFrameCounts__h13130 : 32'd0 ;
  assign result__h14187 = { ~dReal__h14120[15], dReal__h14120[14:0] } ;
  assign w2p_wordsDequed_94_EQ_w2p_wordsExact_66_MINUS__ETC___d604 =
	     w2p_wordsDequed == w2p_wordsExact_66_MINUS_1___d647 ;
  assign w2p_wordsEnqued_65_EQ_w2p_wordsExact_66_MINUS__ETC___d683 =
	     w2p_wordsEnqued == w2p_wordsExact_66_MINUS_1___d647 ;
  assign w2p_wordsExact_66_MINUS_1___d647 = w2p_wordsExact - 16'd1 ;
  assign wsiS_reqFifo_notFull__86_AND_wsiS_burstKind_01_ETC___d208 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h14152 = psdCtrl[4] ? result__h14187 : dReal__h14120 ;
  assign x__h15060 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h7749 = w2p_dataF_pwEnqueue$whas ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x__h7850 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x_data__h14601 =
	     { IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648 -
	       (IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d648 >>
		4),
	       evenMag } ;
  assign x_data__h8545 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  assign x_fftFrameCounts__h13130 = { fft_loadFrames, fft_unloadFrames } ;
  always@(wci_wslv_reqF$D_OUT or
	  psdStatus__h14730 or
	  psdCtrl or
	  rdat__h15056 or
	  rdat__h15156 or
	  rdat__h15170 or
	  rdat__h15178 or
	  rdat__h15184 or rdat__h15198 or rdat__h15206 or rdat__h15212)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h15032 = psdStatus__h14730;
      32'h00000004: g_data__h15032 = psdCtrl;
      32'h00000010: g_data__h15032 = rdat__h15056;
      32'h00000014: g_data__h15032 = rdat__h15156;
      32'h00000018: g_data__h15032 = rdat__h15170;
      32'h0000001C: g_data__h15032 = rdat__h15178;
      32'h00000020: g_data__h15032 = rdat__h15184;
      32'h00000024: g_data__h15032 = rdat__h15198;
      32'h00000028: g_data__h15032 = rdat__h15206;
      32'h0000002C: g_data__h15032 = rdat__h15212;
      default: g_data__h15032 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h15294, psdCtrl);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/PSD.bsv\", line 202, column 6: (R0001)\n  Mutually exclusive rules RL_wci_ctrl_EiI and RL_wci_ctrl_IsO fired in the\n  same clock cycle.\n");
    if (wciS0_MReset_n)
