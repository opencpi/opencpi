...
//
// On Thu Jul  1 08:56:24 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h13901, v__h2625, v__h2772, v__h3671;
  reg [31 : 0] x_data__h14033;
  wire [31 : 0] psdStatus__h13778,
		rdat__h14057,
		rdat__h14157,
		rdat__h14171,
		rdat__h14179,
		...
		x_data__h12841,
		x_data__h7453,
		x_fftFrameCounts__h12256;
  wire [15 : 0] IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d140,
		IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d643,
		IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d137,
		IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d641,
		IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d135,
		IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d640,
		dReal__h12973,
		result__h13034,
		w2p_wordsExact_28_MINUS_1___d642,
		x__h13005,
		x__h14061;
  wire [12 : 0] x__h6923;
  wire NOT_w2p_dataF_rRdPtr_11_PLUS_2048_39_EQ_w2p_da_ETC___d349,
       NOT_wsiS_reqFifo_countReg_86_ULE_1_87___d388,
       w2p_wordsDequed_27_EQ_w2p_wordsExact_28_MINUS__ETC___d606,
       w2p_wordsEnqued_43_EQ_w2p_wordsExact_28_MINUS__ETC___d596;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h14033 } ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { x__h13005, 16'd0 } ;
  ...
  assign IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d140 =
	     IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d643 /
	     16'd16 ;
  assign IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d643 =
	     (IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d640 <=
	      IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d641) ?
	       IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d135 +
	       IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d641 :
  ...
  assign IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d137 =
	     IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d641 /
	     16'd2 ;
  assign IF_fft_xkF_first__25_BIT_15_30_THEN_NEG_fft_xk_ETC___d641 =
	     fft_xkF$D_OUT[15] ? -fft_xkF$D_OUT[15:0] : fft_xkF$D_OUT[15:0] ;
  assign IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d135 =
	     IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d640 /
	     16'd2 ;
  assign IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_xk_ETC___d640 =
	     fft_xkF$D_OUT[31] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  assign NOT_w2p_dataF_rRdPtr_11_PLUS_2048_39_EQ_w2p_da_ETC___d349 =
	     ...
	     (!w2p_wordsEnqued_43_EQ_w2p_wordsExact_28_MINUS__ETC___d596 ||
	      w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_86_ULE_1_87___d388 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign dReal__h12973 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign psdStatus__h13778 = { 31'd0, hasDebugLogic } ;
  assign rdat__h14057 = hasDebugLogic ? { 16'd0, x__h14061 } : 32'd0 ;
  assign rdat__h14157 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h14171 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h14179 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h14185 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h14199 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h14207 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h14213 = hasDebugLogic ? x_fftFrameCounts__h12256 : 32'd0 ;
  assign result__h13034 = { ~dReal__h12973[15], dReal__h12973[14:0] } ;
  assign w2p_wordsDequed_27_EQ_w2p_wordsExact_28_MINUS__ETC___d606 =
	     w2p_wordsDequed == w2p_wordsExact_28_MINUS_1___d642 ;
  assign w2p_wordsEnqued_43_EQ_w2p_wordsExact_28_MINUS__ETC___d596 =
	     w2p_wordsEnqued == w2p_wordsExact_28_MINUS_1___d642 ;
  assign w2p_wordsExact_28_MINUS_1___d642 = w2p_wordsExact - 16'd1 ;
  assign x__h13005 = psdCtrl[4] ? result__h13034 : dReal__h12973 ;
  assign x__h14061 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h6923 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7031 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h12841 =
	     { IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d643 -
	       IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d140,
	       evenMag } ;
  assign x_data__h7453 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       ...
	       w2p_dataF_memory$DOB ;
  assign x_fftFrameCounts__h12256 = { fft_loadFrames, fft_unloadFrames } ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h13778 or
	  psdCtrl or
	  rdat__h14057 or
	  rdat__h14157 or
	  rdat__h14171 or
	  rdat__h14179 or
	  rdat__h14185 or rdat__h14199 or rdat__h14207 or rdat__h14213)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h14033 = psdStatus__h13778;
      20'h00004: x_data__h14033 = psdCtrl;
      20'h00010: x_data__h14033 = rdat__h14057;
      20'h00014: x_data__h14033 = rdat__h14157;
      20'h00018: x_data__h14033 = rdat__h14171;
      20'h0001C: x_data__h14033 = rdat__h14179;
      20'h00020: x_data__h14033 = rdat__h14185;
      20'h00024: x_data__h14033 = rdat__h14199;
      20'h00028: x_data__h14033 = rdat__h14207;
      20'h0002C: x_data__h14033 = rdat__h14213;
      default: x_data__h14033 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h13901, psdCtrl);
    if (wciS0_MReset_n)
