...
//
// On Thu Jan 19 16:32:31 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h15470, v__h3617, v__h3791, v__h3935;
  reg [31 : 0] g_data__h15208;
  wire [31 : 0] psdStatus__h14906,
		rdat__h15232,
		rdat__h15332,
		rdat__h15346,
		rdat__h15354,
		...
		x_data__h14777,
		x_data__h8658,
		x_fftFrameCounts__h13304;
  wire [15 : 0] IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653,
		IF_fft_xkF_first__72_BIT_15_77_THEN_NEG_fft_xk_ETC___d650,
		IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_xk_ETC___d651,
		dReal__h14294,
		result__h14361,
		w2p_wordsExact_60_MINUS_1___d652,
		x__h14326,
		x__h15236;
  wire [12 : 0] x__h7963;
  wire NOT_w2p_dataF_rRdPtr_42_EQ_w2p_dataF_rWrPtr_33_ETC___d284,
       NOT_w2p_dataF_rRdPtr_42_PLUS_2048_55_EQ_w2p_da_ETC___d267,
       w2p_wordsDequed_88_EQ_w2p_wordsExact_60_MINUS__ETC___d612,
       w2p_wordsEnqued_59_EQ_w2p_wordsExact_60_MINUS__ETC___d603;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15208 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h8658 ;
  ...
  // register evenMag
  assign evenMag$D_IN =
	     IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653 -
	     (IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653 >>
	      4) ;
  ...
  // register w2p_dataF_rCache
  assign w2p_dataF_rCache$D_IN = { 1'd1, w2p_dataF_rWrPtr, x__h7862 } ;
  assign w2p_dataF_rCache$EN = w2p_dataF_pwEnqueue$whas ;

  // register w2p_dataF_rRdPtr
  assign w2p_dataF_rRdPtr$D_IN = x__h7963 ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { x__h14326, 16'd0 } ;
  assign fft_xnF$ENQ =
	     fft_xnF$FULL_N && xnF$EMPTY_N && wci_wslv_cState == 3'd2 &&
	     psdCtrl[1:0] == 2'd2 ;
  ...
  assign w2p_dataF_memory$DIA = x__h7862 ;
  ...
  assign w2p_inF$ENQ = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  // remaining internal signals
  assign IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653 =
	     (IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_xk_ETC___d651 <=
	      IF_fft_xkF_first__72_BIT_15_77_THEN_NEG_fft_xk_ETC___d650) ?
	       (IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_xk_ETC___d651 >>
		1) +
	       ...
	       (IF_fft_xkF_first__72_BIT_15_77_THEN_NEG_fft_xk_ETC___d650 >>
		1) ;
  assign IF_fft_xkF_first__72_BIT_15_77_THEN_NEG_fft_xk_ETC___d650 =
	     fft_xkF$D_OUT[15] ? -fft_xkF$D_OUT[15:0] : fft_xkF$D_OUT[15:0] ;
  assign IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_xk_ETC___d651 =
	     fft_xkF$D_OUT[31] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  ...
  assign NOT_w2p_dataF_rRdPtr_42_PLUS_2048_55_EQ_w2p_da_ETC___d267 =
	     ...
	     (!w2p_wordsEnqued_59_EQ_w2p_wordsExact_60_MINUS__ETC___d603 ||
	      w2p_reqF$FULL_N) ;
  assign dReal__h14294 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign psdStatus__h14906 = { 31'd0, hasDebugLogic } ;
  assign rdat__h15232 = hasDebugLogic ? { 16'd0, x__h15236 } : 32'd0 ;
  assign rdat__h15332 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15346 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15354 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15360 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15374 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15382 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15388 = hasDebugLogic ? x_fftFrameCounts__h13304 : 32'd0 ;
  assign result__h14361 = { ~dReal__h14294[15], dReal__h14294[14:0] } ;
  assign w2p_wordsDequed_88_EQ_w2p_wordsExact_60_MINUS__ETC___d612 =
	     w2p_wordsDequed == w2p_wordsExact_60_MINUS_1___d652 ;
  assign w2p_wordsEnqued_59_EQ_w2p_wordsExact_60_MINUS__ETC___d603 =
	     w2p_wordsEnqued == w2p_wordsExact_60_MINUS_1___d652 ;
  assign w2p_wordsExact_60_MINUS_1___d652 = w2p_wordsExact - 16'd1 ;
  assign x__h14326 = psdCtrl[4] ? result__h14361 : dReal__h14294 ;
  assign x__h15236 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h7862 = w2p_dataF_pwEnqueue$whas ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x__h7963 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x_data__h14777 =
	     { IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653 -
	       (IF_IF_fft_xkF_first__72_BIT_31_73_THEN_NEG_fft_ETC___d653 >>
		4),
	       evenMag } ;
  assign x_data__h8658 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  assign x_fftFrameCounts__h13304 = { fft_loadFrames, fft_unloadFrames } ;
  always@(wci_wslv_reqF$D_OUT or
	  psdStatus__h14906 or
	  psdCtrl or
	  rdat__h15232 or
	  rdat__h15332 or
	  rdat__h15346 or
	  rdat__h15354 or
	  rdat__h15360 or rdat__h15374 or rdat__h15382 or rdat__h15388)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h15208 = psdStatus__h14906;
      32'h00000004: g_data__h15208 = psdCtrl;
      32'h00000010: g_data__h15208 = rdat__h15232;
      32'h00000014: g_data__h15208 = rdat__h15332;
      32'h00000018: g_data__h15208 = rdat__h15346;
      32'h0000001C: g_data__h15208 = rdat__h15354;
      32'h00000020: g_data__h15208 = rdat__h15360;
      32'h00000024: g_data__h15208 = rdat__h15374;
      32'h00000028: g_data__h15208 = rdat__h15382;
      32'h0000002C: g_data__h15208 = rdat__h15388;
      default: g_data__h15208 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h15470, psdCtrl);
    if (wciS0_MReset_n)
