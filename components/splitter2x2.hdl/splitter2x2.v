...
//
// On Sat Jan 15 12:08:49 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire [60 : 0] MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1,
		...
		MUX_wsi_M0_reqFifo_q_1$write_1__VAL_2,
  ...
  wire MUX_wci_illegalEdge$write_1__SEL_1,
       ...
       MUX_wsi_M0_reqFifo_q_0$write_1__SEL_1,
       MUX_wsi_M0_reqFifo_q_1$write_1__SEL_1,
  ...
  assign MUX_wsi_M0_reqFifo_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_wsi_M0_reqFifo_incCtr &&
	     wsi_M0_reqFifo_c_r == 2'd0 ;
  assign MUX_wsi_M0_reqFifo_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_wsi_M0_reqFifo_incCtr &&
	     wsi_M0_reqFifo_c_r == 2'd1 ;
  ...
  assign MUX_wsi_M0_reqFifo_q_0$write_1__VAL_2 =
	     (wsi_M0_reqFifo_c_r == 2'd1) ?
	       MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1 :
	       wsi_M0_reqFifo_q_1 ;
  assign MUX_wsi_M0_reqFifo_q_1$write_1__VAL_2 =
	     (wsi_M0_reqFifo_c_r == 2'd2) ?
	       MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1 :
  ...
  assign wsi_S1_sThreadBusy_dw$whas =
	     ...
	     wsi_S1_peerIsReady ;
  assign wsi_M0_reqFifo_x_wire$wget = MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1 ;
  ...
  // register wsi_M0_reqFifo_q_0
  always@(MUX_wsi_M0_reqFifo_q_0$write_1__SEL_1 or
	  MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wsi_M0_reqFifo_both or
  ...
  // register wsi_M0_reqFifo_q_1
  always@(MUX_wsi_M0_reqFifo_q_1$write_1__SEL_1 or
	  MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wsi_M0_reqFifo_both or
	  MUX_wsi_M0_reqFifo_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_wsi_M0_reqFifo_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wsi_M0_reqFifo_q_1$write_1__SEL_1:
	  wsi_M0_reqFifo_q_1$D_IN = MUX_wsi_M0_reqFifo_q_0$write_1__VAL_1;
      WILL_FIRE_RL_wsi_M0_reqFifo_both:
	  wsi_M0_reqFifo_q_1$D_IN = MUX_wsi_M0_reqFifo_q_1$write_1__VAL_2;
      WILL_FIRE_RL_wsi_M0_reqFifo_decCtr:
