...
//
// On Sun Jun 27 11:43:55 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  wire [31 : 0] rdat__h13812,
		...
		rdat__h14067,
		rdat__h14081;
  wire NOT_wsi_S0_reqFifo_countReg_83_ULE_1_84___d385,
       NOT_wsi_S1_reqFifo_countReg_19_ULE_1_20___d321;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsi_S0_reqFifo_countReg_83_ULE_1_84___d385 ||
	     wsi_S0_isReset$VAL ||
	     !wsi_S0_operateD ||
	     !wsi_S0_peerIsReady ;
  ...
  assign CAN_FIRE_RL_doMessageConsume_S1 =
	     wsi_S1_reqFifo$EMPTY_N &&
	     (!splitCtrl[0] || wsi_M0_reqFifo_c_r != 2'd2) &&
	     (!splitCtrl[8] || wsi_M1_reqFifo_c_r != 2'd2) &&
	     wci_cState == 3'd2 ;
  ...
  // remaining internal signals
  assign NOT_wsi_S0_reqFifo_countReg_83_ULE_1_84___d385 =
	     wsi_S0_reqFifo_countReg > 2'd1 ;
  assign NOT_wsi_S1_reqFifo_countReg_19_ULE_1_20___d321 =
	     wsi_S1_reqFifo_countReg > 2'd1 ;
  assign rdat__h13812 =
	     hasDebugLogic ?
	       { wsi_S0_statusR,
