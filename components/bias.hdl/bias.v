...
//
// On Mon Jan 10 17:18:55 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h10222, v__h10375, v__h3565, v__h3739, v__h3883;
  reg [31 : 0] _theResult____h10359;
  wire [31 : 0] rdat__h10449,
		rdat__h10549,
		rdat__h10563,
		rdat__h10571,
		rdat__h10577,
		...
		x_data__h9956;
  wire [15 : 0] x__h10453;
  wire wsiS_reqFifo_notFull__86_AND_wsiS_burstKind_01_ETC___d208;
  ...
  // remaining internal signals
  assign rdat__h10449 = hasDebugLogic ? { 16'd0, x__h10453 } : 32'd0 ;
  assign rdat__h10549 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10563 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10571 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10577 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10591 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10599 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wsiS_reqFifo_notFull__86_AND_wsiS_burstKind_01_ETC___d208 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h10453 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h9956 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h10549 or
	  rdat__h10563 or
	  rdat__h10571 or rdat__h10577 or rdat__h10591 or rdat__h10599)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h10359 = biasValue;
      8'h04: _theResult____h10359 = controlReg;
      8'h20: _theResult____h10359 = rdat__h10449;
      8'h24: _theResult____h10359 = rdat__h10549;
      8'h28: _theResult____h10359 = rdat__h10563;
      8'h2C: _theResult____h10359 = rdat__h10571;
      8'h30: _theResult____h10359 = rdat__h10577;
      8'h34: _theResult____h10359 = rdat__h10591;
      8'h38: _theResult____h10359 = rdat__h10599;
      default: _theResult____h10359 = 32'd0;
    endcase
  end
