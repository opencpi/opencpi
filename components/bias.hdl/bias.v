...
//
// On Fri Aug 19 11:38:11 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h10396, v__h10549, v__h3628, v__h3802, v__h3946;
  reg [31 : 0] _theResult____h10533;
  wire [31 : 0] rdat__h10623,
		rdat__h10723,
		rdat__h10737,
		rdat__h10745,
		rdat__h10751,
  ...
  // remaining internal signals
  assign rdat__h10623 = hasDebugLogic ? { 16'd0, x__h10627 } : 32'd0 ;
  assign rdat__h10723 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10737 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10745 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10751 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10765 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10773 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h10627 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10130 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h10723 or
	  rdat__h10737 or
	  rdat__h10745 or rdat__h10751 or rdat__h10765 or rdat__h10773)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h10533 = biasValue;
      8'h04: _theResult____h10533 = controlReg;
      8'h20: _theResult____h10533 = rdat__h10623;
      8'h24: _theResult____h10533 = rdat__h10723;
      8'h28: _theResult____h10533 = rdat__h10737;
      8'h2C: _theResult____h10533 = rdat__h10745;
      8'h30: _theResult____h10533 = rdat__h10751;
      8'h34: _theResult____h10533 = rdat__h10765;
      8'h38: _theResult____h10533 = rdat__h10773;
      default: _theResult____h10533 = 32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 47, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (MUX_biasValue$write_1__SEL_2 && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 47, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 47, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("[%0d]: %m: WCI CONFIG READ Addr:%0x BE:%0x Data:%0x",
		 ...
		 wci_wslv_reqF$D_OUT[63:32],
		 wci_wslv_reqF$D_OUT[67:64],
		 _theResult____h10533);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 47, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 47, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
