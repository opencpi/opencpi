...
//
// On Wed Mar  9 11:28:18 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
`endif
  ...
  reg [63 : 0] v__h10407, v__h10560, v__h3628, v__h3802, v__h3946;
  reg [31 : 0] _theResult____h10544;
  wire [31 : 0] rdat__h10634,
		rdat__h10734,
		rdat__h10748,
		rdat__h10756,
		rdat__h10762,
  ...
  // remaining internal signals
  assign rdat__h10634 = hasDebugLogic ? { 16'd0, x__h10638 } : 32'd0 ;
  assign rdat__h10734 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10748 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10756 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10762 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10776 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10784 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_03_ETC___d210 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h10638 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10141 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h10734 or
	  rdat__h10748 or
	  rdat__h10756 or rdat__h10762 or rdat__h10776 or rdat__h10784)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h10544 = biasValue;
      8'h04: _theResult____h10544 = controlReg;
      8'h20: _theResult____h10544 = rdat__h10634;
      8'h24: _theResult____h10544 = rdat__h10734;
      8'h28: _theResult____h10544 = rdat__h10748;
      8'h2C: _theResult____h10544 = rdat__h10756;
      8'h30: _theResult____h10544 = rdat__h10762;
      8'h34: _theResult____h10544 = rdat__h10776;
      8'h38: _theResult____h10544 = rdat__h10784;
      default: _theResult____h10544 = 32'd0;
    endcase
  end
