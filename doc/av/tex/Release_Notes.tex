...
\item \ref{bug:3783}: PCI Platforms Can Only Transmit Using One Channel
\end{itemize}

The following previously-documented deficiencies have been fixed in this release:
\begin{itemize}
\setlength\itemsep{0em} %tighten
\item \ref{bug:1385}: XML Parser Mixed-Case Issue\footnote{The opening and closing tags must still match, \textit{e.g.} \texttt{<Element>} pairs with \texttt{</Element>} but not \texttt{</element>}.}
