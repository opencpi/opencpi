...
\input{\importpath snippets/CIC_Dec_Header.tex}
%----------------------------------------------------------------------------------------
...
\input{\importpath snippets/CIC_Dec_Functionality.tex}
\section*{Worker Implementation Details}
\input{\importpath snippets/CIC_HDL_Implementation.tex}
\input{\importpath snippets/CIC_Theory.tex}
...
\input{\importpath snippets/CIC_References.tex}
