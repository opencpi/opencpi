...
##########################################################################################
# This file defines the xilinx18_3 software platform.
...
tooldir:=$(OcpiXilinxEdkDir)/tools/linux-i386/gcc-arm-linux-gnueabi/bin
OcpiCrossCompile=$(tooldir)/arm-linux-gnueabihf-
OcpiCFlags+=-mfpu=neon-fp16 -march=armv7-a -mtune=cortex-a9
OcpiCXXFlags+=-mfpu=neon-fp16 -march=armv7-a -mtune=cortex-a9 -Wimplicit-fallthrough
OcpiStaticProgramFlags=-rdynamic
OcpiKernelDir=release/kernel-headers
OcpiPlatformOs=linux
OcpiPlatformOsVersion=x18_3
