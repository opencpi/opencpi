...
%\item Case 0 - Tests the component with crafted ZLMs and SWMs, backpressure on, timeout set to 100 seconds
%\begin{enumerate}
...
%\end{enumerate}
%\item Case 1 - Tests the component with crafted ZLMs and SWMs, backpressure off, timeout set to 100 seconds
%\begin{enumerate}
%	\item mode = data: only vary data
%	\item mode = metadata: only vary metadata
%	\item mode = full: vary data and metadata
