...
\noindent
\begin{itemize}
  \item The \textit{rx} mode suffers from limited carrier recovery ability. When using \textit{rx} mode, the center frequency may need to be adjusted to a value other than the expected nominal value.
