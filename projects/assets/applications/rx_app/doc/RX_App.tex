...
\newpage
	...
	\textit{\textbf{Revision History}}
		...
		\label{table:revisions} % Add "[H]" to force placement of table
			...
			\hline
			v1.5 & Deprecated Zipper; See Appendix C & 3/2019 \\
			\hline
			\end{tabularx}
		\end{table}
	\end{center}
...
\section{Description}
A block diagram of the RX app (for Stratix IV GX230 / Zipper on HSMC B specifically) can be seen in Figures \ref{fig:rx_app_left} and \ref{fig:rx_app_right}. Complex samples from the ADC are ingested into the FPGA, processed, potentially timestamped, and written to file. Note: See Appendix C regarding deprecated support for Zipper.
\pagebreak
\begin{landscape}
	\begin{figure}[H]
	 	\centering
