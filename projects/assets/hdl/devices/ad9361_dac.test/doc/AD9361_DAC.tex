...
The ML605 test is executed by running the following commands. Note that for this particular unit test, the ocpidev call occurs from the projects/assets/hdl/devices/ directory.
\begin{lstlisting}
cd projects/assets/hdl/devices/
ocpidev run test ad9361_dac.test
\end{lstlisting}
