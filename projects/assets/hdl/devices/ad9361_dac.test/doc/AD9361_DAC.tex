...
\begin{center}
	\begin{tikzpicture}[% List of styles applied to all, to override specify on a case-by-case
		...
		\node[rectangle,draw=white,fill=white](R3)[below= of R2]{``dev\_dac" devsignal port\\ DAC data bus (see AD9361\_DAC\_Sub.pdf)};
...
\bibitem{dac_sub_comp_datasheet} AD9361 DAC Sub Component Data Sheet \\AD9361\_DAC\_Sub.pdf
