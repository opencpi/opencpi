...
\begin{scriptsize}
    ...
    Platform/Cards which & AD9361 Data Port Mode & AD9361 Channel Mode & Max AD9361- & Max \\
		\rowcolor{blue}
    Support AD9361 Mode                      & &                       & Supported Sampling    & \comp.hdl{}- \\
		\rowcolor{blue}
                            & &                       & Rate per RX channel        & Supported Sampling \\
		\rowcolor{blue}
                            & &                       &                            & Rate per RX channel \\
    \hline
...
\noindent\begin{scriptsize}
    ...
    \rowcolor{blue}
		                                       &           &      & control plane clock & dev\_data\_clk clock &           &          \\
		\hline
		\multirow{1}{*}{Zynq XC7Z020-1-CLG484} & 175       & 87   & 315 MHz \textsuperscript{\ref{abc}} & ? & 1 BUFR, 7 IDDR             & Vivado 2017.1      \\
		\hline
	\end{longtable}
\end{scriptsize}
