...
\begin{center}
  \begin{tikzpicture}[% List of styles applied to all, to override specify on a case-by-case
    ...
    \myclient.apply(-\rx + 150,\ry,C1, ``dev\_data\_ch1\_in'' \\ dev signal port \\ DAC channel's data bus sent from \\ instance of ad9361\_dac.hdl);
    \path[<->]($(R1.north) + (150 pt,0)$) edge [] node [] {} (C1);
...
\begin{scriptsize}
	\begin{longtable}{|M{4.5cm}|M{2cm}|M{2cm}|M{2cm}|M{2.5cm}|M{2cm}|}
		...
		Device                       & Registers (typical) & LUTs (typical) & Fmax (typical) (dev\_data\_clk) & Memory/Special Functions   & Design Suite       \\
		\hline
		\multirow{1}{*}{Zynq XC7Z020-1-CLG484} & 91  & 88            & 286 MHz \textsuperscript{\ref{abc}} & 2 BUFR, 8 ODDR             & Vivado 2017.1      \\
		\hline
	\end{longtable}
\end{scriptsize}
