...
class DefaultAD9361Config
{
  public :  AD9361_InitParam m_AD9361InitParam;
  public :  DefaultAD9361Config(void)
            {
              // start copy from no-OS main.c
              ...
              // end copy from no-OS main.c
              m_AD9361InitParam = default_init_param;
            }
  public : ~DefaultAD9361Config(void) {}
};
