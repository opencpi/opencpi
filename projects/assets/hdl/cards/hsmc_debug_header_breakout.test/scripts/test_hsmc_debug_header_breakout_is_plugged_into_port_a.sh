...
HSMC_LOOPBACK_WORKER_INSTANCE_NUM=c/HSMC_ALST4_A_hsmc_debug_header_breakout

echo "loading and initializing FPGA bitfile..."

ocpihdl -d $PCIE_DEV_NUM load assemblies/hsmc_debug_header_breakout_test_assembly/container-hsmc_debug_header_breakout_test_assembly_alst4_base_alst4_hsmc_alst4_a_debug_header_breakout_container/target-stratix4/hsmc_debug_header_breakout_test_assembly_alst4_base_alst4_hsmc_alst4_a_debug_header_breakout_container.sof > /dev/null 2>&1
