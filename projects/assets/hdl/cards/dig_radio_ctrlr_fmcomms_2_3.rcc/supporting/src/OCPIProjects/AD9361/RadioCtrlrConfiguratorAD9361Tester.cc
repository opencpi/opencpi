...
ConfiguratorAD9361Tester::ConfiguratorAD9361Tester(ConfiguratorAD9361<>& UUT) :
    ConfiguratorTester(UUT) {
}

bool ConfiguratorAD9361Tester::run_tests() {
  try {
...
void ConfiguratorAD9361Tester::test_constraint_RX_tuning_freqs_equal_Rx_RFPLL_LO_freq() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
...
void ConfiguratorAD9361Tester::test_constraint_TX_tuning_freqs_equal_Tx_RFPLL_LO_freq() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("TX1");
  data_stream_keys.push_back("TX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
    m_UUT.unlock_all();
    test_config_lock(*it, config_key_tuning_freq_MHz, 70.,   true );
    m_UUT.unlock_all();
...
void ConfiguratorAD9361Tester::test_constraint_RX_bandwidths_equal_rx_rf_bandwidth() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constraint_TX_bandwidths_equal_tx_rf_bandwidth() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("TX1");
  data_stream_keys.push_back("TX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constraint_RX_sampling_rates_equal_RX_SAMPL_FREQ() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constraint_TX_sampling_rates_equal_TX_SAMPL_FREQ() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("TX1");
  data_stream_keys.push_back("TX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constrain_RX_SAMPL_FREQ_to_TX_SAMPL_FREQ_multiplied_by_DAC_Clk_divider() {
...
void ConfiguratorAD9361Tester::test_constrain_TX_SAMPL_FREQ_to_RX_SAMPL_FREQ_divided_by_DAC_Clk_divider() {
  test_constrain_RX_SAMPL_FREQ_to_TX_SAMPL_FREQ_multiplied_by_DAC_Clk_divider();
}

void ConfiguratorAD9361Tester::test_constrain_DAC_Clk_divider_to_RX_SAMPL_FREQ_divided_by_TX_SAMPL_FREQ() {
  m_UUT.unlock_all();
  test_config_lock("DAC_Clk_divider", 1., true );;
  m_UUT.unlock_all();
  test_config_lock("DAC_Clk_divider", 2., true );;
...
void ConfiguratorAD9361Tester::test_constraint_RX_gain_abs_range() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constrain_RX_gain_limits() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constraint_RX_gain_mode_abs_range() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("RX1");
  data_stream_keys.push_back("RX2");
...
void ConfiguratorAD9361Tester::test_constraint_TX_gain_abs_range() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("TX1");
  data_stream_keys.push_back("TX2");
  for(auto it=data_stream_keys.begin(); it!=data_stream_keys.end(); it++) {
...
void ConfiguratorAD9361Tester::test_constraint_TX_gain_mode_abs_range() {
  std::vector<data_stream_ID_t> data_stream_keys;
  data_stream_keys.push_back("TX1");
  data_stream_keys.push_back("TX2");
  const config_value_t _auto = 0;
...
void ConfiguratorAD9361Tester::test_constrain_Nyquist_criteria(
