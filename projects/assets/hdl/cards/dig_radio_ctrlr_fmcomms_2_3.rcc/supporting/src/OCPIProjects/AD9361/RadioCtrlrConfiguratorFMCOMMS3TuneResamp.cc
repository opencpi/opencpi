...
ConfiguratorFMCOMMS3TuneResamp<LC>::ConfiguratorFMCOMMS3TuneResamp() :
    ConfiguratorFMCOMMS3<LC>() {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::add_stream_config_RX_tuning_freq_complex_mixer(
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::add_stream_config_TX_tuning_freq_complex_mixer(
    const data_stream_ID_t data_stream) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::add_stream_config_CIC_dec_decimation_factor(
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::add_stream_config_CIC_int_interpolation_factor(
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_FE_samp_rate_equals_func_of_DS_complex_mixer_freq(
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_FE_samp_rate_to_func_of_DS_complex_mixer_freq(
    const data_stream_ID_t data_stream, const config_key_t samp_rate) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_DS_complex_mixer_freq_to_func_of_FE_samp_rate(
    const data_stream_ID_t data_stream, const config_key_t samp_rate) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_tuning_freq_equals_Rx_RFPLL_LO_freq_plus_complex_mixer_NCO_freq(
    const data_stream_ID_t data_stream) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_tuning_freq_equals_Tx_RFPLL_LO_freq_plus_complex_mixer_NCO_freq(
    const data_stream_ID_t data_stream) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_DS_bandwidth_equals_FE_bandwidth_divided_by_CIC_dec(
    const data_stream_ID_t data_stream,
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_DS_bandwidth_equals_FE_bandwidth_divided_by_CIC_int(
    const data_stream_ID_t data_stream,
    const config_key_t    frontend_bandwidth) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_sampling_rate_equals_FE_samp_rate_divided_by_CIC_dec(
    const data_stream_ID_t data_stream,
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::constrain_sampling_rate_equals_FE_samp_rate_divided_by_CIC_int(
    const data_stream_ID_t data_stream,
    const config_key_t    frontend_samp_rate) {
...
template<class LC>
void ConfiguratorFMCOMMS3TuneResamp<LC>::impose_constraints_single_pass() {

  // unfortunately, order in which these are called matters...

  // constrain absolute ranges
