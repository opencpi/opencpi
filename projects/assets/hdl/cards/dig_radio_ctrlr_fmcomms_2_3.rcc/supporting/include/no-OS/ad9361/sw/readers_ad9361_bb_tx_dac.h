...
/*! @file
 *  @brief Provides functions for reading Transmitter (TX) BaseBand
 *         (BB) Digital-to-Analog Converter (DAC) values from an AD9361 IC.
 ******************************************************************************/
 ...
 ******************************************************************************/
template<typename T>
const char* get_AD9361_TX_SAMPL_FREQ_Hz(
    double& val,
    T& AD9361_interfacer,
  ...
  regs.general_tx_enable_filter_ctrl = ifc.get_general_tx_enable_filter_ctrl();
