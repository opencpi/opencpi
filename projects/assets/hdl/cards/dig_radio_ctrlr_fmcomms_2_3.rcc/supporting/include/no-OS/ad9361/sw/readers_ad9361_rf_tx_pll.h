...
/*! @file readers_ad9361_rf_tx_rfpll.h
 *  @brief Provides functions for reading Receiver (TX) Radio
 ...
 *                                    get_tx_synth_integer_byte_0(),
 *                                    get_tx_synth_integer_byte_1(),
 *                                    get_tx_synth_fract_byte_0(),
 *                                    get_tx_synth_fract_byte_1(),
 *                                    get_tx_synth_fract_byte_2().
...
const char* get_AD9361_Tx_RFPLL_LO_freq_Hz(
  ...
  regs.tx_synth_integer_byte_0 = ifc.get_tx_synth_integer_byte_0();
  regs.tx_synth_integer_byte_1 = ifc.get_tx_synth_integer_byte_1();
  regs.tx_synth_fract_byte_0   = ifc.get_tx_synth_fract_byte_0();
  regs.tx_synth_fract_byte_1   = ifc.get_tx_synth_fract_byte_1();
  regs.tx_synth_fract_byte_2   = ifc.get_tx_synth_fract_byte_2();

  return calc_AD9361_Tx_RFPLL_LO_freq_Hz(
