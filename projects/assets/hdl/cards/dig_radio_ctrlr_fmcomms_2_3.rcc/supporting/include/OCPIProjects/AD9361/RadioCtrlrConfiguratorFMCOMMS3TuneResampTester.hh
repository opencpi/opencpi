...
#ifndef _OCPI_PROJECT_RADIO_CTRLR_CONFIGURATOR_FMCOMMS3_TUNE_RESAMP_TESTER_HH
#define _OCPI_PROJECT_RADIO_CTRLR_CONFIGURATOR_FMCOMMS3_TUNE_RESAMP_TESTER_HH

#include "RadioCtrlrConfiguratorTester.hh"             // ConfiguratorTester
#include "RadioCtrlrConfiguratorFMCOMMS3TuneResamp.hh" // ConfiguratorFMCOMMS3TuneResamp

namespace OCPIProjects {

namespace RadioCtrlr {

class ConfiguratorFMCOMMS3TuneResampTester :
    public ConfiguratorTester<ConfiguratorFMCOMMS3TuneResamp<> > {

public    : ConfiguratorFMCOMMS3TuneResampTester(
                ConfiguratorFMCOMMS3TuneResamp<>& UUT);
...
#include "RadioCtrlrConfiguratorFMCOMMS3TuneResampTester.cc"

#endif // _OCPI_PROJECT_RADIO_CTRLR_CONFIGURATOR_FMCOMMS3_TUNE_RESAMP_TESTER_HH
