  ...
  For a detailed property description, see \ref{sec:detailed_property_description}. \\ \\
	...
	\begin{scriptsize}
		\begin{longtable}{|p{5.16cm}|c|p{3.5cm}|p{3.4cm}|c|p{2.1cm}|p{3.75cm}|}
			...
			\hline
			\verb+IS_SUPPORTED_RX_SAMPLES_COMPLEX_p+           & Double & -        & - & Parameter           & true \textsuperscript{\ref{nonspec}}  & True if supported by any RX \textit{data streams}. \\
			\hline
			\verb+IS_SUPPORTED_RX_SAMPLES_REAL_p+              & Double & -        & - & Parameter           & false \textsuperscript{\ref{nonspec}}  & True if supported by any RX \textit{data streams}. \\
			\hline
			\verb+IS_SUPPORTED_RX_GAIN_MODE_AUTO_p+            & Double & -        & - & Parameter           & true \textsuperscript{\ref{nonspec}} & True if supported by any RX \textit{data streams}. \\
			\hline
			\verb+IS_SUPPORTED_RX_GAIN_MODE_MANUAL_p+          & Double & -        & - & Parameter           & true \textsuperscript{\ref{nonspec}} & True if supported by any RX \textit{data streams}. \\
			\hline
			...
			\hline
			\verb+IS_SUPPORTED_TX_SAMPLES_COMPLEX_p+           & Double & -        & - & Parameter           & true \textsuperscript{\ref{nonspec}} & True if supported by any TX \textit{data streams}. \\
			\hline
			\verb+IS_SUPPORTED_TX_SAMPLES_REAL_p+              & Double & -        & - & Parameter           & false \textsuperscript{\ref{nonspec}} & True if supported by any TX \textit{data streams}. \\
			\hline
			...
			\hline
			\verb+data_stream_type_readback+       & Struct & \verb+MAX_NUM_DATA_STREAMS_RX_p+ & - &Volatile, & -       & Used to read current config \\
...
\footnotetext[1]{\label{nonspec}indicates a non-spec property, i.e. one declared in the OWD, or a value specified in the OWD or build XML which overrides the spec value}
	...
	\begin{scriptsize}
		\noindent\begin{longtable}{|p{1.8cm}|p{3.6cm}|c|c|c|p{2cm}|p{1.7cm}|p{1.0cm}|p{7.37cm}|}
			...
			\hline
			Member       & \verb+gain_mode+                      & String & -       & -          & -              & Standard     & -       & Set to "auto", "manual", or possibly something worker-specific. \\
			\hline
	...
	\begin{scriptsize}
		\noindent\begin{longtable}{|p{1.8cm}|p{3.6cm}|c|p{2cm}|c|p{2cm}|p{1.7cm}|p{0.8cm}|p{6.8cm}|}
			...
			Member       & \verb+data_stream_ID+               & String& -       & -          & -              & Standard     & -       & - \\
			\hline
			Member       & \verb+data_stream_type_gain_mode+   & Enum  & -       & -          & -              & RX,TX        & -       & - \\
			\hline
	...
	\begin{scriptsize}
		\noindent\begin{longtable}{|p{1.8cm}|p{3.6cm}|c|p{2cm}|c|p{2cm}|p{1.7cm}|p{0.8cm}|p{4.97cm}|}
			...
			Member       & \verb+data_stream_ID+               & String& -       & -          & -              & Standard     & -       & - \\
			\hline
			Member       & \verb+data_stream_type_gain+        & Enum  & -       & -          & -              & RX,TX        & -       & - \\
			\hline
			Member       & \verb+valid_values+                 & Struct (see \hyperlink{tab17}{Table 17}) & 32      & -          & -              & Standard & -       & - \\
			\hline
		\end{longtable}
