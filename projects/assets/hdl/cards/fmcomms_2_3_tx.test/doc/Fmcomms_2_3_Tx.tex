...
\begin{itemize}
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/fmcomms\_2\_3\_tx.cc
	...
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/readers\_ad9361\_bb\_tx\_dac.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/readers\_ad9361\_bb\_tx\_filters\_analog.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/readers\_ad9361\_bb\_tx\_filters\_digital.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/readers\_ad9361\_bb\_tx\_gain.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_rx.rcc/include/ad9361/readers\_ad9361\_cfg.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/readers\_ad9361\_rf\_tx\_pll.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/writers\_ad9361\_bb\_tx\_dac.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/writers\_ad9361\_bb\_tx\_filters\_analog.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/writers\_ad9361\_rf\_tx\_pll.h
	\item ocpi.assets/hdl/cards/fmcomms\_2\_3\_tx.rcc/include/ad9361/writers\_ad9361\_tx\_gain.h
\end{itemize}
...
This test verifies the hardware command/control operation of the TX radio parameters represented by the \comp{} spec. Data fidelity is not verified within this test.
\subsection*{Hardware Configuration}
The \Comp{} unit test requires one of the following hardware combinations. Note that the ML605 FMC-HPC slot is not currently supported with FMCOMMS2/FMCOMMS3.
\begin{itemize}
\item Zedboard with and FMCOMMS2 card
\item Zedboard with and FMCOMMS3 card
\item ML605 with and FMCOMMS2 card in the FMC-LPC slot
\item ML605 with and FMCOMMS3 card in the FMC-LPC slot
\end{itemize}

\subsection*{Build Instructions}
The fmcomms\_2\_3\_tx.test directory contains the fmcomms\_2\_3\_tx.rcc unit test. The test can be built on a development machine from within this directory by running the following command to build for ML605 deployment:
...
The ML605 test is executed by running the following commands. Note that for this particular unit test, the ocpidev call occurs from the projects/assets/hdl/cards/ directory.
\begin{lstlisting}
cd projects/assets/hdl/cards/
ocpidev run test fmcomms_2_3_rx.test
\end{lstlisting}
To run on the Zedboard, the built fmcomms\_2\_3\_tx.test directory must either be mounted from the development machine to the Zedboard, or copied to the Zedboard. From within the fmcomms\_2\_3\_tx.test directory, the follow command executes the test natively on the Zedboard:
\begin{lstlisting}
./run/runtest.sh verify
\end{lstlisting}
