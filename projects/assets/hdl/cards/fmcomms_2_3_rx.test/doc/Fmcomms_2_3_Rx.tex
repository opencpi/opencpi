...
This test verifies the command/control operation of the RX radio parameters represented by the \comp{} spec. Data fidelity is not verified within this test.
