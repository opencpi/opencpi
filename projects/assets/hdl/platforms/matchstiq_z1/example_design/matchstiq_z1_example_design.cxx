 ...
 * Matchstiq-Z1 I2C component. This file works with both HDL implementations only.
 */
...
int main(int argc, char **argv) {
  ...
  printf("MATCHSTIQ_Z1_PCA9535: Set Lime RX input to 2\n");
  ...
  app.stop();
    ...
    if(pass){
      ...
      std::ofstream outfile ("i2c_hw_testbench.forJenkins");
