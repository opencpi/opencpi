...
#define QMASK 0xefff
#define Uscale(x)  (double)((double)(x) / (pow(2,15) -1))
#define Scale(x)   (int16_t)((double)(x) * (pow(2,15) -1))
...
#define PI 3.1416//9265358979

//#define DisplayShort(h) (((h & 0x00ff) << 8) + ((h &0xff00) >> 8))

#define DisplayShort(h) (h & 0xffff)
