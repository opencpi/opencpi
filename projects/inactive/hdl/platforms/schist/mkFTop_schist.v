...
//
// On Sun Apr  3 10:21:27 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_schist(sys0_clkp,
		     sys0_clkn,
		     sys1_clkp,
		     sys1_clkn,
		     pci0_clkp,
  ...
  wire [11 : 0] ctop$wmemiM0_MBurstLength,
  ...
  wire [127 : 0] wOut_data__h3161, x_data__h3082;
  wire [15 : 0] wOut_be__h3160, x_be__h3081;
  ...
  // submodule adcW10
  adcx adcW10(.CLK_sys0_clk(sys0_clk$O),
  ...
  // submodule dacW11
  dac dacW11(.CLK_dac_clk(dac_clk$O),
...
`ifdef NEED_DRAM
  // submodule dram0
  dram_v5 dram0(.CLK_sys0_clk(sys0_clk$O),
			.RST_N_sys0_rst(sys0_rst$OUT_RST_N),
...
`endif
  ...
  assign MUX_pciw_uP2IF$enq_1__VAL_1 =
	     { pciw_inFifo$D_OUT[80:72], x_be__h3081, x_data__h3082 } ;
  ...
  // remaining internal signals
  assign wOut_be__h3160 = { pciw_rg[71:64], pciw_inFifo$D_OUT[71:64] } ;
  assign wOut_data__h3161 = { pciw_rg[63:0], pciw_inFifo$D_OUT[63:0] } ;
  assign x_be__h3081 = { pciw_inFifo$D_OUT[71:64], 8'd0 } ;
  assign x_data__h3082 = { pciw_inFifo$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
