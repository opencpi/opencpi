...
int main ( int argc, char* argv [ ] )
{
  ...
  try
    ...
    char *appString;
    asprintf(&appString,
	     "<application package='ocpi.unsupported'>\n"
	...
	rcc_application->createWorker("features", "ocpi.unsupported.good_features_to_track", features_pvlist);
	...
	rcc_application->createWorker("min", "ocpi.unsupported.min_eigen_val", min_pvlist);
      OA::Port
	...
	rcc_application->createWorker("corner", "ocpi.unsupported.corner_eigen_vals_vecs", corner_pvlist);
